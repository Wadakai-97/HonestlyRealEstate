...
<form action="{{ route('mansion.search') }}" method="post" class="form">
    ...
    <table class="single_table">
        <tbody>
            ...
            <tr>
                <td>
                    <div class="multiple_answers">
                        <label for="city32"><input type="checkbox" id="city32" value="藤沢市" name="city[]"> 藤沢市（{{ $fujisawa }}）</label>
                        <label for="city33"><input type="checkbox" id="city33" value="小田原市" name="city[]"> 小田原市（{{ $odawara }}）</label>
                        <label for="city34"><input type="checkbox" id="city34" value="茅ヶ崎市" name="city[]"> 茅ヶ崎市（{{ $chigasaki }}）</label>
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="multiple_answers">
                        <label for="city35"><input type="checkbox" id="city35" value="逗子市" name="city[]"> 逗子市（{{ $zushi }}）</label>
                        <label for="city36"><input type="checkbox" id="city36" value="三浦市" name="city[]"> 三浦市（{{ $miura }}）</label>
                        <label for="city37"><input type="checkbox" id="city37" value="秦野市" name="city[]"> 秦野市（{{ $hadano }}）</label>
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="multiple_answers">
                        <label for="city38"><input type="checkbox" id="city38" value="厚木市" name="city[]"> 厚木市（{{ $atsugi }}）</label>
                        <label for="city39"><input type="checkbox" id="city39" value="大和市" name="city[]"> 大和市（{{ $yamato }}）</label>
                        <label for="city40"><input type="checkbox" id="city40" value="伊勢原市" name="city[]"> 伊勢原市（{{ $isehara }}）</label>
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="multiple_answers">
                        <label for="city41"><input type="checkbox" id="city41" value="海老名市" name="city[]"> 海老名市（{{ $ebina }}）</label>
                        <label for="city42"><input type="checkbox" id="city42" value="座間市" name="city[]"> 座間市（{{ $zama }}）</label>
                        <label for="city43"><input type="checkbox" id="city43" value="南足柄市" name="city[]"> 南足柄市（{{ $minami_ashigara }}）</label>
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="multiple_answers">
                        <label for="city44"><input type="checkbox" id="city44" value="綾瀬市" name="city[]"> 綾瀬市（{{ $ayase }}）</label>
                        <label for="city45"><input type="checkbox" id="city45" value="三浦郡葉山町" name="city[]"> 三浦郡葉山町（{{ $hayama }}）</label>
                        <label for="city46"><input type="checkbox" id="city46" value="高座郡" name="city[]"> 高座郡（{{ $kouza }}）</label>
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="multiple_answers">
                        <label for="city47"><input type="checkbox" id="city47" value="中郡" name="city[]"> 中郡（{{ $naka }}）</label>
                        <label for="city48"><input type="checkbox" id="city48" value="足柄上郡" name="city[]"> 足柄上郡（{{ $ashigara_kami }}）</label>
                        <label for="city49"><input type="checkbox" id="city49" value="愛甲郡" name="city[]"> 愛甲郡（{{ $aikou }}）</label>
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="multiple_answers">
                        <label for="city50"><input type="checkbox" id="city50" value="足柄下郡" name="city[]"> 足柄下郡（{{ $ashigara_shimo }}）</label>
                    </div>
                </td>
            </tr>
        </tbody>
    ...
    <input type="hidden" name="pref" value="神奈川県">
