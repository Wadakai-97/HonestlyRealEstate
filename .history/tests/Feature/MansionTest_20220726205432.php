    ...
    public function dataMansionSignUp()
    {
        ...
        return [
            'Pass' => [
                ...
                ['ライオンズマンション代官山', '1005', '9800', '税込', '神奈川県', '横浜市中区本牧三之谷', '9-3', '1500', '1000', '4', 'LDK', '壁芯', '75', 'あり', '15', 'あり', '4', '12', '1997', '3', '15', '南東', '横浜', '5', '鉄骨鉄筋コンクリート造', '85', '所有権', '商業地域', '大和ライフネクスト', '常勤', '15000', '12500', 'なし', '空室', '未定', '専任媒介', '間門小学校', '15', '大鳥中学校', '8', '室内フルリフォーム予定', '室内状態良好', 'ぜひご見学ください。', $test_image, '' 'リビング', '広いリビングマジおすすめ。'],
                true
            ],
        ];
    }
