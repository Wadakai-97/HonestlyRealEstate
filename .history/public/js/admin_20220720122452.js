...
function  resetPropertyImage() {
    ...
    document.getElementById('propertyImagePreview').closest('img').src = ''
}
...
function previewPropertyImage(event, target) {
    ...
    var previewPropertyImage = document.getElementById("previewPropertyImage-"+target);

    if(previewPropertyImage != null) {
        preview.removeChild(previewPropertyImage);
    }

    reader.onload = function(event) {
        var img = document.createElement("img");
        img.setAttribute("src", reader.result);
        img.setAttribute("id", "previewPropertyImage-"+target);
    ...
    var no_image = document.getElementById
    $(this).closest('td').children('#noImage img').remove();
}
