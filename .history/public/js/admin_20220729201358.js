...
function deletePropertyImage(target) {
    ...
    sign_up_form.innerText().empty();
    sign_up_form.innerText()append('<img src="{{ asset("/storage/mansion_images/no_image.jpeg") }}" id="noImage{{ $image_counter }}" class="no_image" alt="物件画像{{ $image_counter }}">',
