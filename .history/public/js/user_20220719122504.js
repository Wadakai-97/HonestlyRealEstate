...
function calculation() {
    ...
    var chose_annual_interest = document.querySelector('[name="annual_interest"]:checked');
    var annual_interest = chose_annual_interest.value;
    
    if (chose_annual_interest == "その他") {
        var chose_annual_interest = document.getElementById('otherAnnualInterest').value;
    }
