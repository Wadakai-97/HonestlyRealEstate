...
// バルコニー（あるorない）
function balconykClick() {
    let noSetback = document.getElementById("noBalcony");
    let setbackLength = document.getElementById("balconyArea");
    let setbackLengthForm = document.getElementById("balconyAreaForm");
