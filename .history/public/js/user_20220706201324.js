...
function calculation() {
    $price = document.getElementByName('price');
    $down_payment = document.getElementByName('down_payment');
    $annual_interest = document.getElmentByName('annual_interest');
    ...
    document.getElementByName('result').innerText = $monthly_payment;
}
