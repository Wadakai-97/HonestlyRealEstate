...
function interestText() {
    let interestText = documents.getElementsByClassName("interest_text");
    let otherInterest = doucments.getElementsByClassName("other_interest");

    if(otherInterest.checked) {
        for(var i = 0; i < interestText.length; i++) {
            interestText[i].style.visibility = "visible";
        }
    } else {
        for(var i = 0; i < interestText.length; i++) {
            interestText[i].style.visibility = "hidden";
        }
    }
}
