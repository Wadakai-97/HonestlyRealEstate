...
// バルコニー（あるorない）
function balconyHide() {
    document.getElementById("balconyArea").value = "";
    document.getElementById("balconyAreaForm").style.visibility = "hidden";
}
function balconyShow() {
    let haveBalcony = document.getElementById("haveBalcony");
    let balconyArea = document.getElementById("balconyArea");
    let balconyAreaForm = document.getElementById("balconyAreaForm");
    document.getElementById("balconyAreaForm").style.visibility = "visible";
}
