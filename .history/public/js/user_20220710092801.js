...
function interestText() {
    var other_interest = document.getElementsByClassName("other_interest");
    var interest_text = document.getElementsByClassName("interest_text");
    if (other_interest.checked) {
        interest_text.style.visibility = "hidden";
    } else {
        interest_text.style.visibility = "visible";
    }
}
