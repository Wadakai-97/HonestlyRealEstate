...
$(function() {
    $('#countSalesComment').keyup(function() {
        ...
        $('#countSalesComment').text(remain);
            if (remain === 0) {
                $('#countSalesComment').css('color', 'red');
            } else if (remain < 200) {
                $('#countSalesComment').css('color', 'green');
            }
    });
});
// 物件紹介コメント：入力文字数制限
$(function() {
    $('#countIntroComment').keyup(function() {
        ...
        $('#countIntroComment').text(remain);
            if (remain === 0) {
                $('#countIntroComment').css('color', 'red');
            } else if (remain < 200) {
                $('#countIntroComment').css('color', 'green');
            }
    });
});
// 設備条件：入力文字数制限
$(function() {
    $('#countTerms').keyup(function() {
        ...
        $('#countTerms').text(remain);
            if (remain === 0) {
                $('#countTerms').css('color', 'red');
            } else if (remain < 200) {
                $('#countTerms').css('color', 'green');
            }
    });
});
