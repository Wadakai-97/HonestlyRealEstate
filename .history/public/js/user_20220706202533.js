...
function calculation() {
    ...
    var annual_interest = document.getElementById('annual_interest');
    ...
    // 調整金額
    var adjacent_number = pow(1 + nmontly_interest, number_of_payments);

    // 月々のお支払金額
    var monthly_payment = borrowings * montly_interest * adjacent_number / (adjacent_number - 1 );
