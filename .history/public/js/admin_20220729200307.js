...
function deletePropertyImage(target) {
    document.getElementById("signUpForm" + target).innerText('<img src="{{ asset("/storage/mansion_images/no_image.jpeg") }}" id="noImage{{ $image_counter }}" class="no_image" alt="物件画像{{ $image_counter }}">',
