...
// セットバック（あるorない）（新築分譲住宅）新規登録
function multiSetbackSignUp() {
    let noSetback = document.getElementById("noSetback");
...
// セットバック（あるorない）（新築分譲住宅）編集時
function multiSetbackEdit() {
    let noSetback = document.getElementById("noSetback");
    let setbackLengthForm = document.getElementById("setbackLengthForm");
...
// 駐車場（あるorない）新規登録
function parkingSignUp() {
    let noParking = document.getElementById("noParking");
