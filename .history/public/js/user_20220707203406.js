...
function interestText() {
    if (document.getElementById(otherInterest).checked == true) {
    document.getElementById(interestText).disabled = false;
    } else {
    document.getElementById(interestText).disabled = true;
