                ...
                success: function( result ){
                    if( result.response.station ){
                        ...
                        $.each(result.response.station, function(index, value){
                            station += '<option value="' + value.name + '" + "@if(old('station', $->type_of_room) === 'K') selected @endif" + data-line="' + value.line + '" data-next="' + value.next + '" data-postal="' + value.postal + '" data-prefecture="' + value.prefecture + '" data-prev="' + value.prev + '" data-x="' + value.x + '" data-y="' + value.y + '">' + value.name + '</option>';
