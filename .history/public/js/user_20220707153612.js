...
function calculation() {
    var ex_price = document.getElementById('price').value + "0000";
    ...
    var borrowing_period = document.getElementById('borrowing_period').value;
    ...
    document.getElementById('result').innerText = Math.trunc(monthly_payment);
