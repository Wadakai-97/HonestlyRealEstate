...
function interestText() {
    if (document.getElementsByName('other_interest').checked == true) {
        document.getElementsByName('interest_text').disabled = false;
    } else {
        document.getElementsByName(interest_text).disabled = true;
    }
}
