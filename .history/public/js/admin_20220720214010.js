...
function resetPropertyImage(target) {
    var reset_image = document.getElementById(target);
    console.log(reset_image);
    var reset_target = document.getElementById(target).children();
    console.log(reset_target);
    reset_target.src = "";
    // .src = "{{ asset('/storage/mansion_images/no_image.jpeg') }}";
    // パターン②
    // reset_image.setAttribute("src", "{{ asset('/storage/mansion_images/no_image.jpeg') }}");
    // パターン③
