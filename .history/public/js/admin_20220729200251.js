...
function deletePropertyImage(target) {
    var sign_up_form = document.getElementById("signUpForm" + target)./('<img src="{{ asset("/storage/mansion_images/no_image.jpeg") }}" id="noImage{{ $image_counter }}" class="no_image" alt="物件画像{{ $image_counter }}">',
