...
function calculation() {
    ...
    $down_payment = document.getElementsByName('down_payment');
    $annual_interest = document.getElmentsByName('annual_interest');
    ...
    document.getElementsByName('result').innerText = $monthly_payment;
}
