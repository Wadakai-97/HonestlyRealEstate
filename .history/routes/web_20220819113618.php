    ...
    Route::prefix('/buy')->group(function() {
        Route::get('/', 'InformationController@buy')->name('buy');
            ...
            Route::prefix('new_detached_house')->group(function() {
                ...
                Route::get('result', 'NewDetachedHouseController@search');
                Route::post('result', 'NewDetachedHouseController@search')->name('newDetachedHouse.search');
            ...
            Route::prefix('old_detached_house')->group(function() {
                ...
                Route::prefix('result')->group(function() {
                    Route::get('result', 'OldDetachedHouseController@search');
                    Route::post('result', 'OldDetachedHouseController@search')->name('oldDetachedHouse.search');
                });
            ...
            Route::prefix('land')->group(function() {
                ...
                Route::get('result', 'LandController@search');
                Route::post('result', 'LandController@search')->name('land.search');
