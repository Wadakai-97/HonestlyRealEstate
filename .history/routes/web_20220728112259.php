...
Route::prefix('mansion')->group(function() {
    ...
    Route::post('sign_up', 'MansionController@mansionSignUp')->name('admin.mansion.signUp');
    ...
    Route::get('edit/image/{id}', 'MansionController@editImage')->name('admin.mansionImage.edit');
    Route::ppost('edit/image/{id}', 'MansionController@mansionImageUpdate')->name('admin.mansionImage.update');
    Route::post('sign_up/image/{id}', 'MansionController@mansionImageSignUp')->name('admin.mansionImage.signUp');
    Route::delete('delete/image/{id}', 'MansionController@deleteImage')->name('admin.mansionImage.delete');
