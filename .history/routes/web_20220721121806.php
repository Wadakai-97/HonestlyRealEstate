...
Route::prefix('mansion')->group(function() {
    ...
    Route::get('sign_up/image', 'MansionController@showImageForm')->name('admin.mansion.imageForm');
    Route::post('sign_up/image', 'MansionController@signUpImage')->name('admin.mansion.signUp');
