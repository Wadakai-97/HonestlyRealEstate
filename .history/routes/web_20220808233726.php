...
Route::prefix('new_detached_house')->group(function() {
    ...
    Route::delete('recommend/delete/{id}', 'NewDetachedHouseController@recommendDelete')->name('admin.oldDetachedHouseRecommend.delete');
...
Route::prefix('new_detached_house_group')->group(function() {
    ...
    Route::delete('recommend/delete/{id}', 'NewDetachedHouseGroupController@recommendDelete')->name('admin.newDetachedHouseGroupRecommend.delete');
