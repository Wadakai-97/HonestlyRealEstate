...
Route::prefix('mansion')->group(function() {
    ...
    Route::get('csv', 'MansionController@csvDownload')->name('admin.mansion.allCsv');
    Route::get('csv/{query}', 'MansionController@narrowDownCsvDownload')->name('admin.mansion.narrowDownCsv');
});
// 土地
