...
Route::prefix('admin')->group(function() {
    ...
    Route::post('login', 'Admin\LoginController@authenticate')->name('admin.');
});

// 管理画面（ログイン必要）
Route::group(['prefix' => 'admin', 'middleware' => 'auth:admin'],function() {
    Route::post('logout', 'Admin\LoginController@logout')->name('admin.logout');
    Route::get('home', 'Admin\LoginController@index')->name('admin.home');
});

// 管理画面トップページ
Route::get('admin/top', 'Admin\LoginController@top')->name('admin.top');
