    ...
    Route::prefix('/buy')->group(function() {
        Route::get('/', 'InformationController@buy')->name('buy');
            ...
            Route::prefix('mansion')->group(function() {
                ...
                Route::prefix('result')->group(function() {
                    Route::get('/', 'MansionController@search');
                    Route::post('/', 'MansionController@search')->name('mansion.search');
                    Route::get('sort', 'MansionController@sort');
                    Route::post('sort', 'MansionController@sort')->name('mansion.sort');
                });
            });
            // 土地
...
Route::prefix('new_detached_house')->group(function() {
    ...
    Route::post('sign_up', 'NewDetachedHouseController@signUp')->name('admin.newDetachedHouse.signUp')->middleware('throttle:3, 1');;
...
Route::prefix('new_detached_house_group')->group(function() {
    ...
    Route::post('sign_up', 'NewDetachedHouseController@signUpGroup')->name('admin.newDetachedHouseGroup.signUp')->middleware('throttle:3, 1');;
    ...
    Route::prefix('csv')->group(function() {
        Route::get('all', 'NewDetachedHouseController@csvDownload')->name('admin.newDetachedHouseGroup.csv');
        Route::get('filtering', 'NewDetachedHouseController@FilteringCsvDownload')->name('admin.newDetachedHouseGroup.filteringCsv');
    });
    Route::prefix('image')->group(function() {
...
Route::prefix('old_detached_house')->group(function() {
    ...
    Route::post('sign_up', 'OldDetachedHouseController@signUp')->name('admin.oldDetachedHouse.signUp')->middleware('throttle:3, 1');;
...
Route::prefix('mansion')->group(function() {
    ...
    Route::post('sign_up', 'MansionController@signUp')->name('admin.mansion.signUp')->middleware('throttle:3, 1');;
...
Route::prefix('land')->group(function() {
    ...
    Route::post('sign_up', 'LandController@signUp')->name('admin.land.signUp')->middleware('throttle:3, 1');;
...
Route::prefix('staff')->group(function() {
    ...
    Route::post('sign_up', 'StaffController@signUp')->name('admin.staff.signUp')->middleware('throttle:3, 1');;
...
Route::prefix('blog')->group(function() {
    ...
    Route::post('sign_up', 'BlogController@signUp')->name('admin.blog.signUp')->middleware('throttle:3, 1');;
...
Route::prefix('news')->group(function() {
    ...
    Route::post('sign_up', 'InformationController@signUp')->name('admin.news.signUp')->middleware('throttle:3, 1');;
...
Route::prefix('customer')->group(function() {
    ...
    Route::post('sign_up', 'ContactController@signUp')->name('admin.customer.signUp')->middleware('throttle:3, 1');;
