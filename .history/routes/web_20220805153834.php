...
Route::prefix('land')->group(function() {
    ...
    Route::post('recommend/{id}', 'Controller@recommendSignUp')->name('admin.Recommend.signUp');
    Route::get('recommend/{id}', 'Controller@recommendSignUp')->name('admin.Recommend.signUp');
