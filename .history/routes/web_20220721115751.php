...
Route::prefix('mansion')->group(function() {
    ...
    Route::get('edit/image/{id}', 'MansionController@editImage')->name('admin.mansion.editPhoto');
    Route::delete('delete/iumage/{id}', 'MansionController@deleteImage')->name('admin.mansion.deletePhoto');
    Route::patch('edit/{id}', 'MansionController@update')->name('admin.mansion.update');
    Route::patch('edit/photo/{id}', 'MansionController@updatePhoto')->name('admin.mansion.updatePhoto');
