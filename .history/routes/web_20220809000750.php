...
Route::prefix('new_detached_house')->group(function() {
    ...
    Route::post('recommend/{id}', 'NewDetachedHouseController@recommendSignUp')->name('admin.newDetachedHouseRecommend.signUp');
    Route::get('recommend/{id}', 'NewDetachedHouseController@recommendSignUp')->name('admin.newDetachedHouseRecommend.signUp');
    Route::delete('recommend/delete/{id}', 'NewDetachedHouseController@recommendDelete')->name('admin.newDetachedHouseRecommend.delete');
    Route::get('recommend/delete/{id}', 'NewDetachedHouseController@recommendDelete')->name('admin.newDetachedHouseRecommend.delete');
...
Route::prefix('new_detached_house_group')->group(function() {
    ...
    Route::post('recommend/{id}', 'NewDetachedHouseController@recommendGroupSignUp')->name('admin.newDetachedHouseGroupRecommend.signUp');
    Route::get('recommend/{id}', 'NewDetachedHouseController@recommendGroupSignUp')->name('admin.newDetachedHouseGroupRecommend.signUp');
    Route::delete('recommend/delete/{id}', 'NewDetachedHouseController@recommendGroupDelete')->name('admin.newDetachedHouseGroupRecommend.delete');
...
Route::prefix('old_detached_house')->group(function() {
    ...
    Route::post('recommend/{id}', 'OldDetachedHouseController@recommendSignUp')->name('admin.oldDetachedHouseRecommend.signUp');
    Route::get('recommend/{id}', 'OldDetachedHouseController@recommendSignUp')->name('admin.oldDetachedHouseRecommend.signUp');
    Route::delete('recommend/delete/{id}', 'OldDetachedHouseController@recommendDelete')->name('admin.oldDetachedHouseRecommend.delete');
...
Route::prefix('mansion')->group(function() {
    ...
    Route::post('edit/image/sign_up/{id}', 'MansionController@imageSignUp')->name('admin.mansionImage.signUp');
    Route::get('delete/image/{id}', 'MansionController@imageDelete')->name('admin.mansionImage.delete');
    Route::delete('delete/image/{id}', 'MansionController@imageDelete')->name('admin.mansionImage.delete');
    Route::post('recommend/{id}', 'MansionController@recommendSignUp')->name('admin.mansionRecommend.signUp');
    Route::get('recommend/{id}', 'MansionController@recommendSignUp')->name('admin.mansionRecommend.signUp');
    Route::delete('recommend/delete/{id}', 'MansionController@recommendDelete')->name('admin.mansionRecommend.delete');
...
Route::prefix('land')->group(function() {
    ...
    Route::post('recommend/{id}', 'LandController@recommendSignUp')->name('admin.landRecommend.signUp');
    Route::get('recommend/{id}', 'LandController@recommendSignUp')->name('admin.landRecommend.signUp');
    Route::delete('recommend/delete/{id}', 'LandController@recommendDelete')->name('admin.landRecommend.delete');
