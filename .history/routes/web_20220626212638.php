...
Route::prefix('new_detached_house_group')->group(function() {
    Route::get('sign_up', 'NewDetachedHouseController@showFormGroup')->name('admin.newDetachedHouseGroup.groupForm');
    Route::post('sign_up', 'NewDetachedHouseController@signUpGroup')->name('admin.newDetachedHouseGroup.signUpGroup');
    Route::get('list', 'NewDetachedHouseController@groupList')->name('admin.newDetachedHouseGroup.groupList');
    Route::delete('delete/{id}', 'NewDetachedHouseController@groupDelete')->name('admin.newDetachedHouseGroup.groupDelete');
    Route::get('detail/{id}', 'NewDetachedHouseController@showDetailGroup')->name('admin.newDetachedHouseGroup.groupDetail');
    Route::get('edit/{id}', 'NewDetachedHouseController@groupEdit')->name('admin.newDetachedHouseGroup.groupEdit');
    Route::patch('edit/{id}', 'NewDetachedHouseController@groupSave')->name('admin.newDetachedHouseGroup.groupSave');
});
