...
Route::prefix('hre')->group(function() {
    ...
    Route::prefix('contact')->group(function() {
        Route::post('', 'InformationController@contact')->name('contact.confirm');
        Route::post('send', 'InformationController@send')->name('contact.send');
    });
});
...
Route::prefix('customer')->group(function() {
    Route::get('sign_up', 'InformationController@showForm')->name('admin.customer.form');
    Route::post('sign_up', 'InformationController@signUp')->name('admin.customer.signUp');
    Route::get('list', 'InformationController@list')->name('admin.customer.list');
    Route::delete('delete/{id}', 'InformationController@delete')->name('admin.customer.delete');
    Route::get('detail/{id}', 'InformationController@showDetail')->name('admin.customer.detail');
    Route::delete('image_delete/{id}', 'InformationController@imageDelete')->name('admin.information.imageDelete');
    Route::get('edit/{id}', 'InformationController@edit')->name('admin.customer.edit');
    Route::patch('edit/{id}', 'InformationController@update')->name('admin.customer.update');
});
