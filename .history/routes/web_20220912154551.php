...
Route::prefix('hre')->group(function() {
    Route::get('/', 'InformationController@show')->name('';
    Route::get('/', 'InformationController@guestFavorite')->name('guest.favorite');
    Route::get('/', 'InformationController@memberFavorite')->name('member.favorite');
    // 買いたい
