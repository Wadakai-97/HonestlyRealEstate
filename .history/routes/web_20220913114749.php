...
Route::prefix('hre')->group(function() {
    ...
    Route::prefix('favorite')->group(function() {
        ...
        Route::get('/{type}/{id}', 'InformationController@favoriteSignUp')->name('favorite.signUp');
        Route::post('/{type}/{id}', 'InformationController@favoriteSignUp')->name('favorite.signUp');
