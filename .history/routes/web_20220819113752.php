        ...
        Route::get('/', 'InformationController@buy')->name('buy');
            ...
            Route::prefix('new_detached_house')->group(function() {
                ...
                Route::prefix('result')->group(function() {
                    ...
                    Route::get('sort', 'NewDetachedHousenController@sort');
                    Route::post('sort', 'NewDetachedHousenController@sort')->name('newDetachedHousen.sort');
                });
            ...
            Route::prefix('old_detached_house')->group(function() {
                ...
                Route::prefix('result')->group(function() {
                    ...
                    Route::get('sort', 'OldDetachedHousenController@sort');
                    Route::post('sort', 'OldDetachedHousenController@sort')->name('oldDetachedHousen.sort');
                });
            ...
            Route::prefix('land')->group(function() {
                ...
                Route::prefix('result')->group(function() {
                    ...
                    Route::get('sort', 'nController@sort');
                    Route::post('sort', 'nController@sort')->name('n.sort');
                });
