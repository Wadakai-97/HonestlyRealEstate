...
Route::prefix('old_detached_house')->group(function() {
    ...
    Route::prefix('image')->group(function() {
        Route::get('edit/{id}', 'Controller@imageEdit')->name('admin.Image.edit');
        Route::post('edit/{id}', 'Controller@imageUpdate')->name('admin.Image.update');
        Route::post('sign_up/{id}', 'Controller@imageSignUp')->name('admin.Image.signUp');
        Route::get('delete/{id}', 'Controller@imageDelete')->name('admin.Image.delete');
        Route::delete('delete/{id}', 'Controller@imageDelete')->name('admin.Image.delete');
    });
    Route::prefix('recommend')->group(function() {
