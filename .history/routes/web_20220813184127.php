...
Route::prefix('news')->group(function() {
    ...
    Route::get('search/result', 'InformationController@search')->name('admin.Information.search');
    Route::post('search/result', 'InformationController@search')->name('admin.Information.search');
