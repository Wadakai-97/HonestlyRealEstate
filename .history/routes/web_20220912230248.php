...
Route::prefix('hre')->group(function() {
    ...
    Route::prefix('favorite')->group(function() {
        ...
        Route::get('signoff/{type}/{id}', 'InformationController@favoriteSignOff')->name('favorite.signOff');
        Route::delete('signoff/{type}/{id}', 'InformationController@favoriteSignOff')->name('favorite.signOff');
    });
    // 買いたい
