...
Route::prefix('staff')->group(function() {
    ...
    Route::get('search/result', 'StaffController@adminSearch')->name('admin.staff.search');
    Route::post('search/result', 'StaffController@adminSearch')->name('admin.staff.search');
