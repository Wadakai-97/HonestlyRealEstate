...
Route::prefix('mansion')->group(function() {
    ...
    Route::get('edit/photo/{id}', 'MansionController@editPhoto')->name('admin.mansion.editPhoto');
    Route::delete('delete/photo/{id}', 'MansionController@deletePhoto')->name('admin.mansion.deletePhoto');
