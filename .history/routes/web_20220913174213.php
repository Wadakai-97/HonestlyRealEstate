...
Route::prefix('hre')->group(function() {
    ...
    Route::get('keyword', 'InformationController@keywordSearch')->name('keyword');
    Route::post('keyword', 'InformationController@keywordSearch')->name('keyword');
    Route::prefix('favorite')->group(function() {
        Route::post('/list', 'InformationController@favoriteList')->name('favorite');
        Route::get('/{id}', 'InformationController@favoriteSignUp')->name('favorite.signUp');
        Route::post('/{id}', 'InformationController@favoriteSignUp')->name('favorite.signUp');
        Route::get('signoff/{id}', 'InformationController@favoriteSignOff')->name('favorite.signOff');
        Route::post('signoff/{id}', 'InformationController@favoriteSignOff')->name('favorite.signOff');
    });
    // 買いたい
    Route::prefix('/buy')->group(function() {
        Route::get('/', 'InformationController@buy')->name('buy');
            ...
            Route::prefix('new_detached_house')->group(function() {
                ...
                Route::get('/group/detail/{id}', 'NewDetachedHouseController@groupDetail')->name('newDetachedHouseGroup.detail');
            });
            // 中古戸建
            ...
            Route::prefix('mansion')->group(function() {
                ...
                Route::get('result', 'MansionController@search')->name('mansion.result');
