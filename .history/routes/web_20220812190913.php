...
Route::prefix('new_detached_house_group')->group(function() {
    ...
    Route::get('search/result', 'NewDetachedHouseController@adminFroupSearch')->name('admin.newDetachedHouseGroup.search');
    Route::post('search/result', 'NewDetachedHouseController@adminSearch')->name('admin.newDetachedHouseGroup.search');
    ...
    Route::prefix('image')->group(function() {
        Route::get('edit/{id}', 'NewDetachedHouseController@imageEdit')->name('admin.newDetachedHouseGroupImage.edit');
