        ...
        Route::get('/', 'InformationController@buy')->name('buy');
            ...
            Route::prefix('mansion')->group(function() {
                ...
                Route::prefix('kanagawa')->group(function() {
                    Route::get('result', 'MansionController@k');
                    Route::post('result', 'MansionController@k')->name('mansion.kanagawa.search');
                    Route::get('sort', 'MansionController@sort');
                    Route::post('sort', 'MansionController@sort')->name('mansion.kanagawa.sort');
                });
                Route::prefix('tokyo')->group(function() {
                    Route::get('result', 'MansionController@search');
                    Route::post('result', 'MansionController@search')->name('mansion.tokyo.search');
                    Route::get('sort', 'MansionController@sort');
                    Route::post('sort', 'MansionController@sort')->name('mansion.tokyo.sort');
                });
            });
            // Route::prefix('mansion')->group(function() {
            //     Route::get('/', 'MansionController@top')->name('mansion');
            ...
            //         Route::post('/', 'MansionController@search')->name('mansion.kanagawa.search');
            //         Route::get('sort', 'MansionController@sort');
