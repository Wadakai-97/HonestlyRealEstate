...
Route::prefix('mansion')->group(function() {
    ...
    Route::post('edit/image/{id}', 'MansionController@mansionImageUpdate')->name('admin.mansionImage.signUp');
    Route::post('sign_up/image/{id}', 'MansionController@mansionImageSignUpe')->name('admin.mansionImage.signUp');
