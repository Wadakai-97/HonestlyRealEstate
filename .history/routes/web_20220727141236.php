...
Route::prefix('mansion')->group(function() {
    ...
    Route::delete('delete/image/{id}', 'MansionController@deleteImage')->name('admin.mansion.deleteImage');
    Route::patch('edit/{id}', 'MansionController@update')->name('admin.mansion.update');
    Route::patch('edit/image/{id}', 'MansionController@updateImage')->name('admin.mansion.updateImage');
