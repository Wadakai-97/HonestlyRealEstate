...
Route::prefix('new_detached_house_group')->group(function() {
    Route::get('sign_up', 'NewDetachedHouseController@showFormGroup')->name('admin.newDetachedHouse.form');
    Route::post('sign_up', 'NewDetachedHouseController@signUpGroup')->name('admin.newDetachedHouse.signUp');
    Route::get('list', 'NewDetachedHouseController@groupList')->name('admin.newDetachedHouse.list');
    Route::delete('delete/{id}', 'NewDetachedHouseController@groupDelete')->name('admin.newDetachedHouse.delete');
    Route::get('detail/{id}', 'NewDetachedHouseController@showDetailGroup')->name('admin.newDetachedHouse.detail');
    Route::get('edit/{id}', 'NewDetachedHouseController@groupEdit')->name('admin.newDetachedHouse.edit');
    Route::patch('edit/{id}', 'NewDetachedHouseController@groupSave')->name('admin.newDetachedHouse.save');
});
