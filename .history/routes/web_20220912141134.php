        ...
        Route::get('/', 'InformationController@buy')->name('buy');
            ...
            Route::prefix('mansion')->group(function() {
                ...
                Route::prefix('kanagawa')->group(function() {
                    ...
                    Route::get('favorite/{id}', 'MansionController@favorite')->name('mansion.kanagawafavorite');
                    Route::get('unfavorite/{idt}', 'MansionController@unfavorite')->name('mansion.unfavorite');
                });
            });
            // 土地
