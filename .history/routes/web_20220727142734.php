...
Route::prefix('mansion')->group(function() {
    ...
    Route::get('edit/image/{id}', 'MansionController@editImage')->name('admin.mansionImage.editImage');
    Route::post('dit/image/{id}', 'MansionController@mansionImageSignUp')->name('admin.mansionImage.signUp');
    ...
    Route::patch('edit/image/{id}', 'MansionController@updateImage')->name('admin.mansionImage.update');
