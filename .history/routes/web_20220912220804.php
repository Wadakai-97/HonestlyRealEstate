...
Route::prefix('hre')->group(function() {
    ...
    Route::prefix('favorite')->group(function() {
        Route::get('guest', 'InformationController@guestFavoriteList')->name('guest.favorite');
        Route::post('guest', 'InformationController@guestFavoriteList')->name('guest.favorite');
        Route::get('member', 'InformationController@memberFavoriteList')->name('member.favorite');
        ...
        Route::get('signoff/{id}', 'InformationController@favoriteSignOff');
        Route::delete('signoff/{id}', 'InformationController@favoriteSignOff')->name('favorite.signOff');
    });
    // 買いたい
