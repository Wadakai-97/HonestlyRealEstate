...
Route::prefix('hre')->group(function() {
    ...
    Route::prefix('/buy')->group(function() {
        Route::get('/', 'InformationController@buy')->name('buy');
            ...
            // マンション
            Route::prefix('mansion')->group('')
            Route::get('mansion', 'MansionController@top')->name('mansion');
            Route::get('mansion/result', 'MansionController@search');
            Route::post('mansion/result', 'MansionController@search')->name('mansion.search');
            Route::get('mansion/detail/{id}', 'MansionController@detail')->name('mansion.detail');
            // 土地
