...
Route::prefix('hre')->group(function() {
    ...
    Route::prefix('contact')->group(function() {
        Route::post('buy', 'InformationController@buyContact')->name('contact.buyContact');
        Route::post('buy/send', 'InformationController@buySend')->name('contact.buySend');
        Route::post('sell', 'InformationController@sellContact')->name('contact.sellContact');
        Route::post('sell/send', 'InformationController@sellSend')->name('contact.sellSend');
    });
});
