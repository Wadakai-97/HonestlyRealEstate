...
Route::prefix('hre')->group(function() {
    ...
    Route::prefix('favorite')->group(function() {
        Route::post('/guest', 'InformationController@guestFavorite')->name('guest.favorite');
        Route::post('/member', 'InformationController@memberFavorite')->name('member.favorite');
        Route::post('favorite/{id}', 'InformationController@favorite')->name('mansion.favorite');
        Route::post('unfavorite/{idt}', 'InformationController@unfavorite')->name('mansion.unfavorite');
    });
    // 買いたい
