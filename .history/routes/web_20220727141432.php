...
Route::prefix('mansion')->group(function() {
    ...
    Route::get('edit/image/{id}', 'MansionController@editImage')->name('admin.mansion.editImage');
    ...
    Route::patch('edit/image/{id}', 'MansionController@updateImage')->name('admin.mansionImage.updateImage');
