...
Route::prefix('recommend')->group(function() {
    ...
    Route::get('delete/{id}', 'InformationController@recommendDelete')->name('admin.recommend.delete');
...
Route::prefix('mansion')->group(function() {
    ...
    Route::post('recommend/{id}', 'MansionController@recommendSignUp')->name('admin.mansion.recommend');
