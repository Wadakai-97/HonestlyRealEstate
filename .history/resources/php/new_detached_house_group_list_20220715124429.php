...
$sql = 'SELECT id, name, lowest_price, highest_price, lowest_number_of_rooms, highest_number_of_rooms, lowest_type_of_room, highest_type_of_room, pref, municipalities FROM new_detached_house_groups';
