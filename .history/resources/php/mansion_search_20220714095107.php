...
if (!empty($apartment_keyword)) {
    $stmt->bindValue(':apartmentt_name', "%".$apartment_keyword."%", PDO::PARAM_STR);
}
if (!empty($number_of_rooms)) {
    $stmt->bindValue(':number_of_rooms', $number_of_rooms, PDO::PARAM_INT);
}
if (!empty($type_of_room)) {
    $stmt->bindValue(':type_of_room', $type_of_room, PDO::PARAM_INT);
}
...
if (!empty($municipalities)) {
    $stmt->bindValue(':apartmentt_name', "%".$municipalities."%", PDO::PARAM_STR);
}
