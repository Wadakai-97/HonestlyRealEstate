...
$sql = 'SELECT id, name, lowest_price, highest_price, lowest_number_of_rooms, lowest_number_of_rooms, lowest_type_of_room, highest_ municipalities FROM new_detached_houses';
