...
<div class="faq">
    <ul class="faq_list">
        ...
        <li><div class="faq_list_menu">Q.よくある質問２<span class="icon"></span></div>
        <ul class="subMenu">
            <li>A.よくある回答２</li>
        </ul>
        </li>
        <li><div class="faq_list_menu">Q.よくある質問３<span class="icon"></span></div>
        <ul class="subMenu">
            <li>A.よくある回答３</li>
        </ul>
        </li>
        <li><div class="faq_list_menu">Q.よくある質問４<span class="icon"></span></div>
        <ul class="subMenu">
            <li>A.よくある回答４</li>
        </ul>
        </li>
