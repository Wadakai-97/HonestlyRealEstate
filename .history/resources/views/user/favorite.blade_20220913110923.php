        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form method="post" action="{{ route('favorite.signOff', ['id' => $land->mansion->id]) }}">
                            @csrf
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form method="post" action="{{ route('favorite.signOff', ['id' => $new_detached_house_group->new_detached_house->id]) }}">
                            @csrf
                            <input type="hidden" name="type" value="new_detached_house">
                            <input type="submit" value="登録削除">
                        </form>
