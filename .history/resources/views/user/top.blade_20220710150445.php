    ...
    <form method="POST" action="{{ route('contact.confirm') }}"` class="contact_form">
        ...
        <table class="single_table">
            ...
            <tr>
                ...
                <td>
                    <div class="contents_list">
                        <label class ="contents_item" name="contents"><input type="checkbox" value="購入相談したい" name="contents[]">購入相談したい</label>
                        <label class ="contents_item" name="contents"><input type="checkbox" value="売却相談したい" name="contents[]">売却相談したい</label>
                        <label class ="contents_item" name="contents"><input type="checkbox" value="賃貸相談したい" name="contents[]">賃貸相談したい</label>
                        <label class ="contents_item" name="contents"><input type="checkbox" value="その他の相談をしたい" name="contents[]">その他の相談をしたい</label>
                    </div>
                </td>
            </tr>
            <tr class="small_textarea">
                ...
                <td>
                    <textarea placeholder="今週の土曜日１０時に５名で購入相談と物件見学を希望します。"></textarea>
                </td>
            </tr>
        </table>
