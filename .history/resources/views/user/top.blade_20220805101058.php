            ...
            <tr>
                ...
                <td>
                    <div class="multiple_answers">
                        <label name="contents"><input type="checkbox" value="購入相談" name="contents[]"> 購入相談</label>
                        <label name="contents"><input type="checkbox" value="売却相談" name="contents[]"> 売却相談</label>
                        <label name="contents"><input type="checkbox" value="賃貸相談" name="contents[]"> 賃貸相談</label>
                        <label name="contents"><input type="checkbox" value="その他の相談を" name="contents[]"> その他の相談を</label>
                    </div>
                </td>
            </tr>
