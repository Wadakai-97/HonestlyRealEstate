    ...
    <form method="POST" action="{{ route('contact.confirm') }}"` class="contact_form">
        ...
        <table>
            ...
            <tr>
                ...
                <label name="contents"><input type="checkbox" value="売却相談したい" name="contents[]">売却相談したい</label></td>
                <label name="contents"><input type="checkbox" value="賃貸相談したい" name="contents[]">賃貸相談したい</label></td>
                <label name="contentz"><input type="checkbox" value="その他の相談をしたい" name="contents[]">その他の相談をしたい</label></td>
            </tr>
            <tr>
