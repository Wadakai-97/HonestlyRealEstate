        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" onclick="location.href='{{ route('mansion.detail', ['id' => $mansion->mansion->id]) }}'">詳細</button>
                    </td>
                    <td>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button onclick="location.href='{{ route('newDetachedHouse.detail', ['id' => $new_detached_house->new_detached_house->id]) }}'">詳細</button>
                    </td>
                    <td>
                        <form method="POST" action="{{route('favorite.signOff', ['id' => $new_detached_house->new_detached_house->id])}}">
                            @csrf
                            @method('delete')
                            <input type="hidden" name="type" value="new_detahced_house">
                            <input type="submit" value="お気に入り削除">
                        </form>
                    </td>
                </tr>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button onclick="location.href='{{ route('newDetachedHouseGroup.detail', ['id' => $new_detached_house_group->new_detached_house_group->id]) }}'">詳細</button>
                    </td>
                    <td>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button onclick="location.href='{{ route('oldDetachedHouse.detail', ['id' => $old_detached_house->old_detached_house->id]) }}'">詳細</button>
                    </td>
                    <td>
