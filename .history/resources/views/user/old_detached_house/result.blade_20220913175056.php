...
<form action="{{ route('oldDetachedHouse.sort') }}" method="post">
    @csrf
...
<table class="result_table">
    ...
    @forelse ($old_detached_houses as $old_detached_house)
        <tbody>
            <tr>
                <td><a href="{{ route('oldDetachedHouse.detail', ['id' => $old_detached_house->id]) }}" class="font_link">{{ $old_detached_house->name }}</a></td>
                <td>{{ $old_detached_house->pref }}{{ $old_detached_house->municipalities }}</td>
                ...
                <td>{{ $today - $old_detached_house->year }}年</td>
...
<div class="d-flex justify-content-center">
    {{ $old_detached_houses->appends(request()->input())->links('pagination::default') }}
</div>
@endsection
