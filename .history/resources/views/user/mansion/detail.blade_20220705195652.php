...
<h3>この物件のお支払いをシミュレーションしてみる</h3>
    <table>
        <tbody>
            <tr><th><label>金利</label></th><td colspan="2"><input type="radio" value="0.475" name="annual_interest" id="interest"><label for="interest">0.475%</label></td><td colspan="2"><input type="radio" name="interest" id="interest"><input name="interest" type="text" value=""> %</td></tr>
