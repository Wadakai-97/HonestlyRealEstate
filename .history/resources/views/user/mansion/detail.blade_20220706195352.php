    ...
    <table>
        <tbody>
            ...
            <tr>
                ...
                <td colspan="2"><input type="radio" value="0.475" name="down_payment">なし</td><td colspan="2"><input type="radio" name="down_payment"><input name="down_payment" type="text" value=""> 万円</td></tr>
        </tbody>
    </table>
</form>
