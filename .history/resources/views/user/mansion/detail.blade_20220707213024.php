    ...
    <form method="POST" action="{{ route('contact.confirm') }}" class="contact_form">
        ...
        <table>
            ...
            <tr>
                ...
                <td colspan=2><label name="type"><input type="checkbox" value="初回購入" name="type">初回購入</label></td>
                <td><label name="type"><input type="checkbox" value="住み替え(売却あり)" name="type">住み替え(売却あり)</label></td>
                <td><label name="type"><input type="checkbox" value="住み替え(売却なし)" name="type">住み替え(売却なし)</label></td>
            </tr>
            <tr>
