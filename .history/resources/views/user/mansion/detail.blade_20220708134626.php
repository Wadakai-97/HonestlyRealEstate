...
<h1 class="mansion_name">【{{ $mansion->apartment_name }}】販売価格:{{ $mansion->price }}万円</h1>
    <table>
        <tbody>
            <tr>
                <th>所在地</th><td>{{ $mansion->pref }}{{ $mansion->city }}{{ $mansion->ward }}{{ $mansion->town }}{{ $mansion->chome }}</td><th>専有面積</th><td>{{ $mansion->measuring_method }}{{ $mansion->occupation_area }}㎡</td><th>間取り</th><td>{{ $mansion->number_of_rooms }}{{ $mansion->type_of_room }}</td></tr>
