            ...
            <tr>
                ...
                <td>
                    <div class="multiple_answers">
                        ...
                        <label><input type="radio" name="borrowing_period" id="borrowing_period" value="class="other_interest" onclick="interestText()"><input type="text" id="otherBorrowingPeriod" value="" ></label>
                    </div>
                </td>
            </tr>
            <tr>
