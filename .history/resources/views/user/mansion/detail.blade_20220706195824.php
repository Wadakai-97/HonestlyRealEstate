    ...
    <table>
        <tbody>
            ...
            <tr>
                ...
                <td colspan="2"><input type="radio" name="annual_interest"><input type="radio" name="annual_interest"><input name="annual_interest" type="text" value="">%</td>
            </tr>
            <tr>
                ...
                <td><input type="text" value="" name="borrowing_period">年</td>
            </tr>
            <tr>
