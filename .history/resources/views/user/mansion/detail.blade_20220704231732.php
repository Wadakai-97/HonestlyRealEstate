...
<div class="contact_form">
    <form method="POST" action="{{ route('contact.confirm') }}" class="contact_form">
        @csrf
        <table>
            <tr><th><labelclass="required">お名前</label></th><td colspan="4"><input name="name" type="text" placeholder="正直 太郎"></td></tr>
            <tr><th><label >お名前</label></th><td colspan="4"><input name="name" type="text" placeholder="正直 太郎"></td></tr>
            <tr><th><label>メールアドレス</label></th><td colspan="4"><input name="email" type="text" placeholder="HRE@gmail.com"></td></tr>
