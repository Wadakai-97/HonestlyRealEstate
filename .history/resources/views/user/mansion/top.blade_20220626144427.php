...
<form action="" type="get" class="form">
    @csrf
    <table>
        <tbody>
            <tr>
                <th>希望エリア</th>
                <td colspan=3>
                    <input type="checkbox" id="pref1" value="東京都" name="pref[]"><label for="pref1">東京都</label>
                    <input type="checkbox" id="pref2" value="神奈川県" name="pref[]"><label for="pref2">神奈川県</label>
                </td>
            </tr>
            <tr>
                <th>販売価格</th>
