                ...
                <td>
                        <label for="lowest_price">
                            ...
                            <select name="lowest_price">
                                ...
                                @foreach (PropertyInformationConsts::lowest_price_LIST as $key => $lowest_price)
                                <option value="{{ $key }}" @if(old('lowest_price') === $lowest_price) selected @endif>{{ $lowest_price }}</option>
                                @endforeach
                            </select>
                            <select name="lowest_price">
