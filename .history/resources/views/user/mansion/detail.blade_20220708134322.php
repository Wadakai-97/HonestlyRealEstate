    ...
    <table>
        <tbody>
            ...
            <tr>
                ...
                <label><input type="radio" value="30" id="borrowing_period" onclick="interestText()">30年</label></td>
                <label><input type="radio" value="25" id="borrowing_period" onclick="interestText()">25年</label></td>
                <input type="radio" id="borrowing_period" class="other_interest" onclick="interestText()"><div class="interest_text"><input type="text" value="" id="borrowing_period">年</div></td>
            </tr>
            <tr>
                <th>頭金</th>
