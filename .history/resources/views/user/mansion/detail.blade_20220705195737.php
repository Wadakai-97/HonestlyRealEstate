...
<h3>この物件のお支払いをシミュレーションしてみる</h3>
    <table>
        <tbody>
            ...
            <tr><th><label>借入期間</label></th><td><input type="radio" value="35" name="borrowing_period">35年</td><td><input type="radio" value="30" name="loan_terms">30年</td><td><input type="radio" value="25" name="loan_terms">25年</td><td><input type="radio" value="20" name="loan_terms">20年</td></tr>
