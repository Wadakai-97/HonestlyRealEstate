    ...
    <table class="single_table">
        <tbody>
            ...
            <tr>
                <td>
                    <div class="multiple_answers">
                        <label for="city13"><input type="checkbox" id="city13" value="横浜市緑区" name="city[]"> 緑区（{{ $yokohama_totsuka }}）</label>
                        <label for="city14"><input type="checkbox" id="city14" value="横浜市瀬谷区" name="city[]"> 瀬谷区（{{ $yokohama_kounan }}）</label>
                        <label for="city15"><input type="checkbox" id="city15" value="横浜市栄区" name="city[]"> 栄区（{{ $yokohama_asahi }}）</label>
                    </div>
                </td>
            </tr>
        </tbody>
