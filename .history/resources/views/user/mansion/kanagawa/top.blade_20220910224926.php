    ...
    <table class="single_table">
        <tbody>
            ...
            <tr>
                <td>
                    <div class="multiple_answers">
                        <label for="city7"><input type="checkbox" id="city7" value="横浜市磯子区" name="city[]"> 磯子区（{{ $yokohama_naka }}）</label>
                        <label for="city8"><input type="checkbox" id="city8" value="横浜市金沢区" name="city[]"> 金沢区（{{ $yokohama_minami }}）</label>
                        <label for="city9"><input type="checkbox" id="city9" value="横浜市保土ケ谷区" name="city[]"> 保土ケ谷区（{{ $yokohama_hodogayaku }}）</label>
                    </div>
                </td>
            </tr>
        </tbody>
