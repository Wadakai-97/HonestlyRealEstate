            ...
            <tr>
                ...
                <td>
                    <div class="multiple_answers">
                        ...
                        <label for="city20"><input type="checkbox" id="city20" value="川崎市幸区" name="city[]"> 幸区（{{ $yoko020 }}）</label>
                        <label for="city21"><input type="checkbox" id="city21" value="川崎市中原区" name="city[]"> 中原区（{{ $yoko021 }}）</label>
                    </div>
                </td>
            </tr>
        </tbody>
