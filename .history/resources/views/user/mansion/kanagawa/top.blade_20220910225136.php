    ...
    <table class="single_table">
        <tbody>
            ...
            <tr>
                <td>
                    <div class="multiple_answers">
                        <label for="city10"><input type="checkbox" id="city10" value="横浜市磯子区" name="city[]"> 磯子区（{{ $yokohama_isogo }}）</label>
                        <label for="city11"><input type="checkbox" id="city11" value="横浜市金沢区" name="city[]"> 金沢区（{{ $yokohama_kanazawa }}）</label>
                        <label for="city12"><input type="checkbox" id="city12" value="横浜市港北区" name="city[]"> 港北区（{{ $yokohama_kouhoku }}）</label>
                    </div>
                </td>
            </tr>
        </tbody>
