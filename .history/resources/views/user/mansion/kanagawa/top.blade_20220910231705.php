    ...
    <table class="single_table">
        <tbody>
            ...
            <tr>
                <td>
                    <div class="multiple_answers">
                        <label for="city32"><input type="checkbox" id="city32" value="緑区" name="city[]"> 緑区（{{ $ }}）</label>
                        <label for="city33"><input type="checkbox" id="city33" value="中央区" name="city[]"> 中央区（{{ $ }}）</label>
                        <label for="city34"><input type="checkbox" id="city34" value="南区" name="city[]"> 南区（{{ $ }}）</label>
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="multiple_answers">
                        <label for="city35"><input type="checkbox" id="city35" value="緑区" name="city[]"> 緑区（{{ $ }}）</label>
                        <label for="city36"><input type="checkbox" id="city36" value="中央区" name="city[]"> 中央区（{{ $ }}）</label>
            ...
            <tr>
                <td>
                    <div class="multiple_answers">
                        ...
                        <label for="city52"><input type="checkbox" id="city34" value="南区" name="city[]"> 南区（{{ $ }}）</label>
                    </div>
                </td>
            </tr>
        </tbody>
