    ...
    <table class="single_table">
        <tbody>
            ...
            <tr>
                <td>
                    <div class="multiple_answers">
                        <label for="city16"><input type="checkbox" id="city16" value="横浜市緑区" name="city[]"> 緑区（{{ $yoko13 }}）</label>
                        <label for="city17"><input type="checkbox" id="city17" value="横浜市瀬谷区" name="city[]"> 瀬谷区（{{ $yoko14 }}）</label>
                        <label for="city18"><input type="checkbox" id="city18" value="横浜市栄区" name="city[]"> 栄区（{{ $yoko15 }}）</label>
                    </div>
                </td>
            </tr>
        </tbody>
