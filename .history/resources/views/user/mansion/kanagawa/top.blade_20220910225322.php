            ...
            <tr>
                <td>
                    <div class="multiple_answers">
                        ...
                        <label for="city14"><input type="checkbox" id="city14" value="横浜市瀬谷区" name="city[]"> 瀬谷区（{{ $yokohama_seya }}）</label>
                        <label for="city15"><input type="checkbox" id="city15" value="横浜市栄区" name="city[]"> 栄区（{{ $yokohama_sakae }}）</label>
                    </div>
                </td>
            </tr>
        </tbody>
