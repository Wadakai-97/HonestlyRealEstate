            ...
            <tr>
                ...
                <td>
                    <div class="multiple_answers">
                        <label for="city1"><input type="checkbox" id="city1" value="西区" name="city[]"> 西区（{{ $yokohama_nishi }}）</label>
                        <label for="city2"><input type="checkbox" id="city2" value="中区" name="plan[]"> 中区（{{ $yokohama_naka }}）</label>
                        <label for="city3"><input type="checkbox" id="city3" value="神奈川区" name="plan[]"> 神奈川区（{{ $yokohama_kanagawa }}）</label>
                    </div>
                </td>
            </tr>
        </tbody>
