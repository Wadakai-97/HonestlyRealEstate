    ...
    <table class="single_table">
        <tbody>
            ...
            <tr>
                <td>
                    <div class="multiple_answers">
                        <label for="city25"><input type="checkbox" id="city25" value="川崎市高津区" name="city[]"> 高津区（{{ $kawa04 }}）</label>
                        <label for="city26"><input type="checkbox" id="city26" value="川崎市多摩区" name="city[]"> 多摩区（{{ $kawa05 }}）</label>
                        <label for="city27"><input type="checkbox" id="city27" value="川崎市宮前区" name="city[]"> 宮前区（{{ $kawa06 }}）</label>
                    </div>
                </td>
            </tr>
        </tbody>
