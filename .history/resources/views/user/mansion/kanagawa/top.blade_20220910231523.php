    ...
    <table class="single_table">
        <tbody>
            ...
            <tr>
                <td>
                    <div class="multiple_answers">
                        <label for="city32"><input type="checkbox" id="city32" value="相模原市緑区" name="city[]"> 緑区（{{ $saga01 }}）</label>
                        <label for="city33"><input type="checkbox" id="city33" value="相模原市中央区" name="city[]"> 中央区（{{ $saga02 }}）</label>
                        <label for="city34"><input type="checkbox" id="city34" value="相模原市南区" name="city[]"> 南区（{{ $saga03 }}）</label>
                    </div>
                </td>
            </tr>
        </tbody>
