            ...
            <tr>
                ...
                <td>
                    <div class="multiple_answers">
                        <label for="city1"><input type="checkbox" id="city1" value="横浜市鶴見区" name="city[]"> 鶴見区（{{ $yokohama_nishi }}）</label>
                        <label for="city2"><input type="checkbox" id="city2" value="横浜市神奈川区" name="city[]"> 神奈川区（{{ $yokohama_naka }}）</label>
                        <label for="city3"><input type="checkbox" id="city3" value="横浜市神奈川区" name="city[]"> 神奈川区（{{ $yokohama_kanagawa }}）</label>
                    </div>
                </td>
                <td>
                    <div class="multiple_answers">
                        <label for="city4"><input type="checkbox" id="city4" value="横浜市西区" name="city[]"> 西区（{{ $yokohama_nishi }}）</label>
                        <label for="city5"><input type="checkbox" id="city5" value="横浜市中区" name="city[]"> 中区（{{ $yokohama_naka }}）</label>
                        <label for="city6"><input type="checkbox" id="city6" value="横浜市神奈川区" name="city[]"> 神奈川区（{{ $yokohama_kanagawa }}）</label>
                    </div>
                </td>
            </tr>
        </tbody>
