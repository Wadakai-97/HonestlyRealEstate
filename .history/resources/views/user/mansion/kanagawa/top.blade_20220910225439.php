            ...
            <tr>
                ...
                <td>
                    <div class="multiple_answers">
                        <label for="city1"><input type="checkbox" id="city1" value="横浜市鶴見区" name="city[]"> 鶴見区（{{ $yokomi }}）</label>
                        <label for="city2"><input type="checkbox" id="city2" value="横浜市神奈川区" name="city[]"> 神奈川区（{{ $yokoawa }}）</label>
                        <label for="city3"><input type="checkbox" id="city3" value="横浜市西区" name="city[]"> 西区（{{ $yoko }}）</label>
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="multiple_answers">
                        <label for="city4"><input type="checkbox" id="city4" value="横浜市中区" name="city[]"> 中区（{{ $yoko}}）</label>
                        <label for="city5"><input type="checkbox" id="city5" value="横浜市南区" name="city[]"> 南区（{{ $yokoi }}）</label>
                        <label for="city6"><input type="checkbox" id="city6" value="横浜市保土ケ谷区" name="city[]"> 保土ケ谷区（{{ $yokoayaku }}）</label>
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="multiple_answers">
                        <label for="city7"><input type="checkbox" id="city7" value="横浜市磯子区" name="city[]"> 磯子区（{{ $yoko }}）</label>
                        <label for="city8"><input type="checkbox" id="city8" value="横浜市金沢区" name="city[]"> 金沢区（{{ $yokoawa }}）</label>
                        <label for="city9"><input type="checkbox" id="city9" value="横浜市港北区" name="city[]"> 港北区（{{ $yokoku }}）</label>
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="multiple_answers">
                        <label for="city10"><input type="checkbox" id="city10" value="横浜市戸塚区" name="city[]"> 戸塚区（{{ $yokoka }}）</label>
                        <label for="city11"><input type="checkbox" id="city11" value="横浜市港南区" name="city[]"> 港南区（{{ $yokon }}）</label>
                        <label for="city12"><input type="checkbox" id="city12" value="横浜市旭区" name="city[]"> 旭区（{{ $yoko }}）</label>
                    </div>
                </td>
            </tr>
            <tr>
