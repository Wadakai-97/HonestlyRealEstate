    ...
    <table class="single_table">
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="multiple_answers">
                        <label for="city29"><input type="checkbox" id="city29" value="横須賀市" name="city[]"> 横須賀市（{{ $kawa01 }}）</label>
                        <label for="city30"><input type="checkbox" id="city30" value="平塚市" name="city[]"> 平塚市（{{ $kawa02 }}）</label>
                        <label for="city31"><input type="checkbox" id="city31" value="鎌倉市" name="city[]"> 鎌倉市（{{ $kawa03 }}）</label>
                    </div>
                </td>
            </tr>
        </tbody>
