    ...
    <table class="single_table">
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="multiple_answers">
                        <label for="city19"><input type="checkbox" id="city19" value="鶴見区" name="city[]"> 鶴見区（{{ $yoko019 }}）</label>
                        <label for="city20"><input type="checkbox" id="city20" value="神奈川区" name="city[]"> 神奈川区（{{ $yoko020 }}）</label>
                        <label for="city21"><input type="checkbox" id="city21" value="西区" name="city[]"> 西区（{{ $yoko021 }}）</label>
                    </div>
                </td>
            </tr>
        </tbody>
