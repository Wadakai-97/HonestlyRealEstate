    ...
    <table class="single_table">
        <tbody>
            ...
            <tr>
                <td>
                    <div class="multiple_answers">
                        <label for="city10"><input type="checkbox" id="city10" value="横浜市戸塚区" name="city[]"> 戸塚区（{{ $yokohama_isogo }}）</label>
                        <label for="city11"><input type="checkbox" id="city11" value="横浜市港南区" name="city[]"> 港南区（{{ $yokohama_kanazawa }}）</label>
