    ...
    <table class="single_table">
        <tbody>
            ...
            <tr>
                <td>
                    <div class="multiple_answers">
                        <label for="city22"><input type="checkbox" id="city22" value="横浜市緑区" name="city[]"> 緑区（{{ $kawa04 }}）</label>
                        <label for="city23"><input type="checkbox" id="city23" value="横浜市瀬谷区" name="city[]"> 瀬谷区（{{ $kawa05 }}）</label>
                        <label for="city24"><input type="checkbox" id="city24" value="横浜市栄区" name="city[]"> 栄区（{{ $kawa06 }}）</label>
                    </div>
                </td>
            </tr>
        </tbody>
