            ...
            <tr>
                ...
                <td>
                    <div class="multiple_answers">
                        ...
                        <label for="city3"><input type="checkbox" id="city3" value="横浜市西区" name="city[]"> 西区（{{ $yokohama_kanagawa }}）</label>
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div class="multiple_answers">
                        <label for="city4"><input type="checkbox" id="city4" value="横浜市中区" name="city[]"> 中区（{{ $yokohama_nishi }}）</label>
                        <label for="city5"><input type="checkbox" id="city5" value="横浜市南区" name="city[]"> 南区（{{ $yokohama_naka }}）</label>
                        <label for="city6"><input type="checkbox" id="city6" value="横浜市保土ケ谷区" name="city[]"> 保土ケ谷区（{{ $yokohama_kanagawa }}）</label>
                    </div>
                </td>
            </tr>
        </tbody>
