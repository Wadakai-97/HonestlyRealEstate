            ...
            <tr>
                ...
                <td>
                    <div class="multiple_answers">
                        ...
                        <label for="room2"><input type="checkbox" id="room2" value="2" name="plan[]"> 中区（{{ $yokohama_naka }}）</label>
                        <label for="room3"><input type="checkbox" id="room3" value="3" name="plan[]"> 神奈川区（{{ $yokohama_kanagawa }}）</label>
                    </div>
                </td>
            </tr>
        </tbody>
