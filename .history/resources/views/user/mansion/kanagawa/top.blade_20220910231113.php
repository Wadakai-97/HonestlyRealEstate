    ...
    <table class="single_table">
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="multiple_answers">
                        <label for="city26"><input type="checkbox" id="city26" value="相模原市緑区" name="city[]"> 緑区（{{ $kawa01 }}）</label>
                        <label for="city27"><input type="checkbox" id="city27" value="相模原市中央区" name="city[]"> 中央区（{{ $kawa02 }}）</label>
                        <label for="city28"><input type="checkbox" id="city28" value="相模原市中原区" name="city[]"> 中原区（{{ $kawa03 }}）</label>
                    </div>
                </td>
            </tr>
        </tbody>
