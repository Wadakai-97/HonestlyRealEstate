    ...
    <table class="single_table">
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="multiple_answers">
                        <label for="city26"><input type="checkbox" id="city26" value="川崎区" name="city[]"> 川崎区（{{ $kawa01 }}）</label>
                        <label for="city27"><input type="checkbox" id="city27" value="幸区" name="city[]"> 幸区（{{ $kawa02 }}）</label>
                        <label for="city28"><input type="checkbox" id="city28" value="中原区" name="city[]"> 中原区（{{ $kawa03 }}）</label>
                    </div>
                </td>
            </tr>
        </tbody>
