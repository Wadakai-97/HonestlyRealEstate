            ...
            <tr>
                ...
                <td>
                    <div class="multiple_answers">
                        <label for="room1"><input type="checkbox" id="room1" value="1" name="plan[]"> 横浜市西区（{{ $yokohama_nishi }}）</label>
                        <label for="room2"><input type="checkbox" id="room2" value="2" name="plan[]"> 横浜市中区（{{ $yokohama_naka }}）</label>
                        <label for="room2"><input type="checkbox" id="room2" value="2" name="plan[]"> 横浜市神奈川区（{{ $yokohama_naka }}）</label>
                    </div>
                </td>
            </tr>
        </tbody>
