            ...
            <tr>
                ...
                <td>
                    <div class="multiple_answers">
                        <label for="city1"><input type="checkbox" id="city1" value="横浜市西区" name="city[]"> 西区（{{ $yokohama_nishi }}）</label>
                ...
                <td>
                    <div class="multiple_answers">
                        <label for="city4"><input type="checkbox" id="city1" value="横浜市西区" name="city[]"> 西区（{{ $yokohama_nishi }}）</label>
                        <label for="city5"><input type="checkbox" id="city2" value="横浜市中区" name="city[]"> 中区（{{ $yokohama_naka }}）</label>
                        <label for="city6"><input type="checkbox" id="city3" value="横浜市神奈川区" name="city[]"> 神奈川区（{{ $yokohama_kanagawa }}）</label>
                    </div>
                </td>
            </tr>
        </tbody>
