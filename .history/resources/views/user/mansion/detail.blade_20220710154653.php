    ...
    <table class="single_table">
        <tbody>
            <tr>
                <th>物件価格</th>
                <td>
                    <input type="hidden" id="price" value="{{ $mansion->price }}">{{ $mansion->price }}万円（{{ $mansion->tax }}）</td>
            </tr>
            <tr>
                <th>金利</th>
                <td>
                    ...
                    <input type="radio" name="annual_interest" id="annual_interest"><input id="annual_interest" type="text" value="">%
                </td>
            </tr>
            <tr>
                <th>借入期間</th>
                <td>
                    ...
                    <label><input type="radio" name="borrowing_period" id="borrowing_period" class="other_interest" onclick="interestText()"></label>
                    <div class="interest_text_form"><input type="text" value="" id="borrowing_period"></div>
                </td>
            </tr>
            <tr>
                <th>頭金</th>
                <td>
                    <label><input type="radio" value="0" id="down_payment">なし</label>
...
<table>
    <tr>
        <th colspan=2>毎月のお支払い金額</th>
    </tr>
    <tr>
        <td id="result" colspan=2>万円 / 月々</td>
    </tr>
</table>
