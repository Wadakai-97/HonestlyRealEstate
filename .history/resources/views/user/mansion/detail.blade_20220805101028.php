    ...
    <table class="double_table">
        <tbody>
            ...
            <tr>
                ...
                <th>次回更新日</th>
                <td>{{ date('Y/m/d', strtotime($rollover_date)) }}</td>
            </tr>
            <tr>
                <th>取引態様</th>
                    <td>{{ $mansion->conditions_of_transactions }}</td>
    ...
    <form method="POST" action="{{ route('contact.confirm') }}"` class="contact_form">
        ...
        <table class="single_table">
            ...
            <tr>
                ...
                <td>
                    <div class="multiple_answers">
                        <label name="content"><input type="checkbox" value="購入相談したい" name="content[]"> 購入相談したい</label>
                        <label name="content"><input type="checkbox" value="売却相談したい" name="content[]"> 売却相談したい</label>
                        <label name="content"><input type="checkbox" value="賃貸相談したい" name="content[]"> 賃貸相談したい</label>
                        <label name="content"><input type="checkbox" value="その他の相談をしたい" name="content[]"> その他の相談をしたい</label>
                    </div>
                </td>
            </tr>
