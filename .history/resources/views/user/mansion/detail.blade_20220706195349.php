...
<form>
    <table>
        <tbody>
            <tr>
                <th>金利</th>
                <td colspan="2"><label><input type="radio" value="0.475" name="annual_interest" id="interest">0.475%</label></td>
            ...
            <tr>
                <th><label>頭金</label></th><td colspan="2"><input type="radio" value="0.475" name="down_payment">なし</td><td colspan="2"><input type="radio" name="down_payment"><input name="down_payment" type="text" value=""> 万円</td></tr>
        </tbody>
    </table>
</form>
