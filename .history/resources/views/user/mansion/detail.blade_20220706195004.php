...
<form method="post" oninput="result.value=>
    <table>
        <tbody>
            <tr><th><label>金利</label></th><td colspan="2"><input type="radio" value="0.475" name="annual_interest" id="interest"><label for="interest">0.475%</label></td><td colspan="2"><input type="radio" name="annual_interestinterest" id="interest"><input name="annual_interest" type="text" value="">%</td></tr>
