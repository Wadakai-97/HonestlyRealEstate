...
<form method="post" oninput="result.value=>
    <table>
        <tbody>
            ...
            <tr><th><label>借入期間</label></th><td><input type="radio" value="35" name="borrowing_period">35年</td><td><input type="radio" value="30" name="borrowing_period">30年</td><td><input type="radio" value="25" name="borrowing_period">25年</td><td><input type="text" value="20" name="borrowing_period"></td></tr>
