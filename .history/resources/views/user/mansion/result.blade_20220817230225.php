    ...
    <table class="single_table">
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="multiple_answers">
                        <label for="old1"><input type="radio" name="old" id="old1" value="5" name="old"> 5年以内</label>
                        <label for="old2"><input type="radio" name="old" id="old2" value="10" name="old"> 10年以内</label>
                        <label for="old3"><input type="radio" name="old" id="old3" value="15" name="old"> 15年以内</label>
                        <label for="old4"><input type="radio" name="old" id="old4" value="20" name="old"> 20年以内</label>
...
<form action="{{ route('mansion.sort') }}" method="post">
...
<table class="result_table">
    ...
    @forelse ($mansions as $mansion)
        <tbody>
            <tr>
                <td><a href="{{ route('mansion.detail', ['id' => $mansion->id]) }}" class="font_link">{{ $mansion->apartment_name }}</a></td>
