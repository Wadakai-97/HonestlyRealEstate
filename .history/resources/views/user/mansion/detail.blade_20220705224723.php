    ...
    <form method="POST" action="{{ route('contact.buySend') }}" class="contact_form">
        ...
        <table>
            ...
            <tr>
                ...
                <td colspan="4"><input name="email" type="text" placeholder="HRE@gmail.com"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="4"><input name="phone" type="text" placeholder=""></td>
            </tr>
            <tr>
                ...
                <tr><td colspan="4"><textarea name="detail" placeholder="今週の土曜日１０時に５名で購入相談と物件見学を希望します。希望条件は〇〇のため、事前にご用意いただけますと幸いです。"></textarea></td>
            </tr>
        </table>
