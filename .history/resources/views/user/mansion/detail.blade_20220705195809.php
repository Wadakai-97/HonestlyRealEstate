...
<h3>この物件のお支払いをシミュレーションしてみる</h3>
    <table>
        <tbody>
            ...
            <tr><th><label>頭金</label></th><td colspan="2"><input type="radio" value="0.475" name="down">なし</td><td colspan="2"><input type="radio" name="down"><input name="down" type="text" value=""> 万円</td></tr>
        </tbody>
    </table>
