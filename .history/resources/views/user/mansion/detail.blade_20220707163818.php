    ...
    <form method="POST" action="{{ route('contact.confirm') }}" class="contact_form">
        ...
        <table>
            ...
            <tr>
                ...
                <td><label name=""><input type="checkbox" value="実際に物件を見たい" name="[]">実際に物件を見たい</label></td>
                <td><label name=""><input type="checkbox" value="詳細な資料が欲しい" name="[]">詳細な資料がほしい</label></td>
                <td><label name=""><input type="checkbox" value="住宅購入に関して相談したい" name="[]">住宅購入に関して相談したい</label></td>
                <td><label name=""><input type="checkbox" value="希望条件に沿う物件を見学したい" name="[]">類似物件も見たい</label></td>
            </tr>
            <tr>
