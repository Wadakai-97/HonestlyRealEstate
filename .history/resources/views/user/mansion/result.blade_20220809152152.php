...
<div class="search_condition">
    ...
    @if(!empty(request()->lowest_occupation_area) && empty(request()->highest_occupation_area))
        <p>最低価格：{{ $request->lowest_occupation_area }}万円</p>
    @endif
    @if(empty(request()->lowest_occupation_area) && !empty(request()->highest_occupation_area))
        <p>最高価格：{{ $request->highest_occupation_area }}万円</p>
    @endif
    @if(!empty(request()->lowest_occupation_area) && !empty(request()->highest_occupation_area))
        <p>最低価格：{{ $request->lowest_occupation_area }}万円〜最高価格：{{ $request->highest_occupation_area }}万円</p>
    @endif
