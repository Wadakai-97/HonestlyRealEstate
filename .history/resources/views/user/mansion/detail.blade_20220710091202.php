        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <label><input type="radio" name="borrowing_period" id="borrowing_period" class="other_interest" onclick="interestText()"><input type="text" value="" class="intrest" id="borrowing_period">年</label>
                </td>
            </tr>
            <tr>
                <th>頭金</th>
