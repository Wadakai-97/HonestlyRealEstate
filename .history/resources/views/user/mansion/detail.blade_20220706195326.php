...
<form>
    <table>
        <tbody>
            <tr>
                <th>金利</th><td colspan="2"><label><input type="radio" value="0.475" name="annual_interest" id="interest">0.475%</label></td><td colspan="2"><input type="radio" name="annual_interest" id="interest"><input name="annual_interest" type="text" value="">%</td></tr>
