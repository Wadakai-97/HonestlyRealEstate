...
<form method="POST" action="{{ route('contact.confirm') }}">
    @csrf
    <label>お名前</label><input name="name" type="text" value="{{ old('name') }}">
    <label>メールアドレス</label><input name="email" type="text" value="{{ old('mail') }}">
    <label>電話番号</label><input name="phone" type="text" value="{{ old('phone') }}">
    <label>お問い合わせ内容</label>
    @foreach ($contents as $content)
        <input type="checkbox" checked="checked" value="{{ old('content') }}">
    <textarea name="content_detail" value={{ old('content_detail') }}></textarea>
