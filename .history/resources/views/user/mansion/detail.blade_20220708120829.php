...
<h1 class="mansion_name">【{{ $mansion->apartment_name }}】販売価格</th><td colspan="5">{{ $mansion->price }}万円</h1>
    <table>
        <tbody>
...
<form>
    <table>
        <tbody>
            ...
            <tr>
                <th>借入期間</th>
                <td><label><input type="radio" value="35" id="borrowing_period">35年</label></td>
                ...
                <td><label><input type="radio" id="borrowing_period"><input type="text" value="" id="borrowing_period"> 年</label></td>
            </tr>
            <tr>
                <th>頭金</th>
