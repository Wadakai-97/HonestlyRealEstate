    ...
    <table>
        <tbody>
            ...
            <tr>
                <th>借入期間</th>
                <td>
                    <label><input type="radio" value="35" id="borrowing_period" onclick="interestText()">35年</label>
                    <label><input type="radio" value="30" id="borrowing_period" onclick="interestText()">30年</label>
