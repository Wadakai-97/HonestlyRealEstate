...
<div class="search_condition">
    ...
    @if(!empty(request()->lowest_occupation_area) && empty(request()->highest_occupation_area))
        <p>最低専有面積：{{ $request->lowest_occupation_area }}万円</p>
    @endif
    @if(empty(request()->lowest_occupation_area) && !empty(request()->highest_occupation_area))
        <p>最高専有面積：{{ $request->highest_occupation_area }}万円</p>
    @endif
    @if(!empty(request()->lowest_occupation_area) && !empty(request()->highest_occupation_area))
        <p>最低専有面積：{{ $request->lowest_occupation_area }}万円〜最高専有面積：{{ $request->highest_occupation_area }}万円</p>
    @endif
    {{-- 間取り --}}
    ...
    @if(!empty(request()->station))
        <p>間取り：{{ $request->station }}</p>
    @endif
    {{-- 駅徒歩 --}}
    @if(!empty(request()->walking_distance_station))
        <p>駅徒歩：{{ $request->walking_distance_station }}</p>
    @endif
