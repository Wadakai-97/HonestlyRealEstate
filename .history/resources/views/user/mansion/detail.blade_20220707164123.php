    ...
    <table>
        <tbody>
            ...
            <tr>
                ...
                <td><label><input type="radio" value="0.475" id="annual_interest">固定金利：1.35%</label></td>
    ...
    <form method="POST" action="{{ route('contact.confirm') }}" class="contact_form">
        ...
        <table>
            ...
            <tr>
                ...
                <td><label name="type"><input type="checkbox" value="実際に物件を見たい" name="type[]">実際に物件を見たい</label></td>
                <td><label name="type"><input type="checkbox" value="詳細な資料が欲しい" name="type[]">詳細な資料がほしい</label></td>
                <td><label name="type"><input type="checkbox" value="住宅購入に関して相談したい" name="type[]">住宅購入に関して相談したい</label></td>
                <td><label name="type"><input type="checkbox" value="希望条件に沿う物件を見学したい" name="type[]">類似物件も見たい</label></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="4"><textarea name="message" placeholder="今週の土曜日１０時に５名で購入相談と物件見学を希望します。希望条件は〇〇のため、事前にご用意いただけますと幸いです。"></textarea></td>
            </tr>
        </table>
