    ...
    <form method="POST" action="{{ route('contact.confirm') }}" class="contact_form">
        ...
        <table>
            <tr>
                ...
                <div @if ($errors->has('name'))<p>{{$errors->first('name')}}</p>@endif><div>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="4"><input name="address" type="text"></td>
            </tr>
            <tr>
                <th><label class="required">お問い合わせ種類</label></th>
                <td colspan=2><label name="type"><input type="radio" value="初回購入" name="type">初回購入</label></td>
                <td><label name="type"><input type="radio" value="住み替え(売却あり)" name="type">住み替え(売却あり)</label></td>
                <td><label name="type"><input type="radio" value="住み替え(売却なし)" name="type">住み替え(売却なし)</label></td>
            </tr>
            <tr>
