...
<form class="load_payment_simulation">
    <table>
        <tbody>
            <tr>
                <th>物件価格</th>
            ...
            <tr>
                ...
                <td><label><input type="radio" id="borrowing_period" name="other_interest"><input type="text" value="" id="borrowing_period" name="interest_text"> 年</label></td>
            </tr>
            <tr>
                <th>頭金</th>
