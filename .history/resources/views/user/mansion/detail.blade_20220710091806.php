        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <label><input type="radio" name="borrowing_period" id="borrowing_period" class="other_interest" onclick="interestText()">
                            <div class="interest_text"></div><input type="text" value="" class="interest_text" id="borrowing_period"></label>
                </td>
            </tr>
            <tr>
                <th>頭金</th>
