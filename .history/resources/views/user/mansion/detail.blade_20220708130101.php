    ...
    <table>
        <tbody>
            ...
            <tr>
                ...
                <td><label><input type="radio" id="borrowing_period" name="other_interest" onclick="interestText()"><input type="text" value="" id="borrowing_period" name="interest_text"> 年</label></td>
            </tr>
            <tr>
                <th>頭金</th>
