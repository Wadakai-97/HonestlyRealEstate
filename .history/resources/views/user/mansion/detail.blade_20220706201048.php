...
<form>
    <table>
        <tbody>
            <tr>
                <th>物件価格</th>
                <td colspan=4><input type="hidden" class="price" value="{{ $mansion->price }}">{{ $mansion->price }}万円（{{ $mansion->tax }}）</td>
            </tr>
            <tr>
                <th>頭金</th>
                <td colspan=4><input type="text" value="" name="down_payment">万円</td>
            </tr>
            <tr>
                <th>金利</th>
                <td><label><input type="radio" value="0.475" name="annual_interest">変動金利：0.475%</label></td>
                <td><label><input type="radio" value="0.475" name="annual_interest">固定金利：1.35%</label></td>
                <td colspan="2"><input type="radio" name="annual_interest"><input name="annual_interest" type="text" value="">%</td>
            </tr>
            <tr>
                <th>借入期間</th>
                <td><label><input type="radio" value="35" name="borrowing_period">35年</label></td>
                <td><label><input type="radio" value="30" name="borrowing_period">30年</label></td>
                <td><label><input type="radio" value="25" name="borrowing_period">25年</label></td>
                <td><label><input type="radio" name="borrowing_period"><input type="text" value="" name="borrowing_period"> 年</label></td>
            </tr>
            <tr>
                <th>頭金</th>
                <td colspan="2"><label><input type="radio" value="0.475" name="down_payment">なし</label></td>
                <td colspan="2"><label><input type="radio" name="down_payment"><input name="down_payment" type="text" value=""> 万円</label></td>
            </tr>
            <tr>
                <input type="button" value="結果を見てみる" onclick="calculation()">
            </tr>
        </tbody>
    </table>
</form>
