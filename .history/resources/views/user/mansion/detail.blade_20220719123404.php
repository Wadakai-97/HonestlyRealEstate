            ...
            <tr>
                ...
                <td>
                    <div class="multiple_answers">
                        ...
                        <label><input type="radio" name="borrowing_period" id="borrowing_period" class="other_interest" onclick="interestText()"><input type="text" value="" id="otherBorrowingPeriod"></label>
                    </div>
                </td>
            </tr>
            <tr>
