...
<form class="loan_payment_simulation">
    <table>
        <tbody>
            ...
            <tr>
                <th>頭金</th>
                <td><label><input type="radio" value="0" id="down_payment">なし</label></td>
                <td><label><input type="radio" id="down_payment"><input id="down_payment" type="text" value=""> 万円</label></td>
            </tr>
            <tr>
                <td>
