    ...
    <table>
        <tbody>
            ...
            <tr>
                ...
                <td><input type="radio" id="borrowing_period" name="other_interest" onclick="interestText()"><div class="interest_text"><input type="text" value="" id="borrowing_period">年</div></td>
            </tr>
            <tr>
                <th>頭金</th>
