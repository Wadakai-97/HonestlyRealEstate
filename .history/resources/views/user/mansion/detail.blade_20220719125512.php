            ...
            <tr>
                ...
                <td>
                    <div class="multiple_answers">
                        <label><input type="radio" value="0.475" name="annual_interest" id="annual_interest">変動金利0.475%</label>
                        <label><input type="radio" value="1.35" name="annual_interest" id="annual_interest">固定金利1.35%</label>
                        <label><input type="radio" value="other" name="annual_interest" id="annual_interest"><input type="text" id="otherAnnualInterest" value="">%</label>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="multiple_answers">
                        ...
                        <label><input type="radio" name="borrowing_period" id="borrowing_period" value="other" class="other_interest" onclick="interestText()"><input type="text" id="otherBorrowingPeriod" value="" > 年</label>
                    </div>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <label><input name="down_payment" type="radio" value="other" id="down_payment"><input type="text" id="otherDownPayment" value=""> 万円</label>
                </td>
            </tr>
        </tbody>
    </table><br>
