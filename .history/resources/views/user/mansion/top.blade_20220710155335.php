...
<form action="{{ route('mansion.search') }}" method="post" class="form">
    ...
    <table class="single_table">
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="multiple_answers">
                        <label for="walk1"><input type="radio" id="walk1" value="" name="walk">指定なし</label>
                        <label for="walk2"><input type="radio" id="walk2" value="5" name="walk">5分以内</label>
                        <label for="walk3"><input type="radio" id="walk3" value="10" name="walk">10分以内</label>
                        <label for="walk4"><input type="radio" id="walk4" value="15" name="walk">15分以内</label>
                        <label for="walk5"><input type="radio" id="walk5" value="20" name="walk">20分以内</label>
                    </div>
                </td>
            </tr>
        </tbody>
    ...
    <button type="submit">
        <span class="shadow"></span><span class="edge"></span><span class="front text">この条件で検索する</span>
    </button>
