...
<form method="post" oninput="result.value=>
    <table>
        <tbody>
            <tr><th><label>金利</label></th><td colspan="2"><input type="radio" value="0.475" name="annual_interest" id="interest"><label for="interest">0.475%</label></td><td colspan="2"><input type="radio" name="annual_interest" id="interest"><input name="annual_interest" type="text" value="">%</td></tr>
            <tr><th><label>借入期間</label></th><td><input type="radio" value="35" name="borrowing_period">35年</td><td><input type="radio" value="30" name="borrowing_period">30年</td><td><input type="radio" value="25" name="borrowing_period">25年</td><td><input type="text" value="20" name="borrowing_period">20年</td></tr>
