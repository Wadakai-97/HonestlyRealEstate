    ...
    <table>
        <tbody>
            ...
            <tr>
                ...
                <td><label><input type="radio" id="borrowing_period" name="other_interest" onclick="interestText()"><div class="name="interest_text">"><input type="text" value="" id="borrowing_period">年</label></td>
            </tr>
            <tr>
                <th>頭金</th>
