    ...
    <table>
        <tbody>
            ...
            <tr>
                ...
                <td><input type="radio" value="35" name="borrowing_period">35年</td><td><input type="radio" value="30" name="borrowing_period">30年</td><td><input type="radio" value="25" name="borrowing_period">25年</td><td><input type="text" value="" name="borrowing_period">年</td></tr>
