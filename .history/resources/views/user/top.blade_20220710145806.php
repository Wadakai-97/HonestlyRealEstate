    ...
    <form method="POST" action="{{ route('contact.confirm') }}"` class="contact_form">
        ...
        <table class="single_table">
            ...
            <tr>
                ...
                <td>
                    <label name="contents" class="contents_item"><input type="checkbox" value="購入相談したい" name="contents[]">購入相談したい</label>
                    <label name="contents" class="contents_item"><input type="checkbox" value="売却相談したい" name="contents[]">売却相談したい</label>
                    <label name="contents" class="contents_item"><input type="checkbox" value="賃貸相談したい" name="contents[]">賃貸相談したい</label>
                    <label name="contents" class="contents_item"><input type="checkbox" value="その他の相談をしたい" name="contents[]">その他の相談をしたい</label>
                </td>
            </tr>
