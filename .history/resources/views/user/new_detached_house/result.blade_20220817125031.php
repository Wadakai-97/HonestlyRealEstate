    ...
    @forelse ($new_detached_houses as $new_detached_house)
        <tbody>
            <tr>
                ...
                <td>{{ $new_detached_house->lowest_number_of_rooms }}{{ $new_detached_house->highest_type_of_room }}{{ $new_detached_house->highest_number_of_rooms }}{{ $new_detached_house->highest_number_of_rooms</td>
