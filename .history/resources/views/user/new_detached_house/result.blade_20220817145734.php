    ...
    @forelse ($new_detached_house_groups as $new_detached_house_group)
        <tbody>
            <tr>
                ...
                <td>{{ $new_detached_house_group->lowest_number_of_rooms }}{{ $new_detached_house_group->lowest_type_of_room }}〜{{ $new_detached_house_group->lowest_number_of_rooms }}{{ $new_detached_house_group->lowest_type_of_room }}</td>
                <td>{{ $new_detached_house_group->lowest_price }}万円</td>
                <td>{{ $new_detached_house_group->lowest_land_area }}㎡</td>
                <td>{{ $new_detached_house_group->lowest_building_area }}㎡</td>
                <td>{{ $new_detached_house_group->landright }}</td>
