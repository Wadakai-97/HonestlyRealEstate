...
<form action="{{ route('newDetachedHouse.sort') }}" method="post">
    ...
    <input type="hidden" name="old" value="{{ $request->keyword }}">
    ...
    @forelse ($new_detached_houses as $new_detached_house)
        <tbody>
            <tr>
                ...
                <td>
                    <form action="{{ route('favorite.signUp',  ['id' => $new_detached_house->id]) }}" method="post">
                        @csrf
    ...
    @forelse ($new_detached_house_groups as $new_detached_house_group)
        <tbody>
            <tr>
                ...
                <td>
                    <form action="{{ route('favorite.signUp',  ['id' => $new_detached_house_group->id]) }}" method="post">
                        @csrf
