...
<form method="post" action="#">
    ...
    <input type="hidden" name="lowest_building_area_area" value="{{ $request->lowest_building_area_area }}">
    <input type="hidden" name="highest_building_area_area" value="{{ $request->highest_building_area_area }}">
