...
<div class="contact_form">
    <form method="POST" action="{{ route('contact.buyContact') }}"` class="contact_form">
        @csrf
        <table>
            ...
            <tr><th rowspan="3"><label>お問い合わせ内容</label></th>
                ...
                <td><label name="contentz"><input type="checkbox" value="その他の相談をしたい" name="contents[]">類似物件も見たい</label></td>
