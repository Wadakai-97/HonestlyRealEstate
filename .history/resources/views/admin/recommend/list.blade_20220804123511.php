        ...
        <table class="list">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button onclick="location.href='{{ route('admin..detail', ['id' => $->->id]) }}'">詳細</button>
                    </td>
                    <td>
                        <form method="POST" action="{{route('admin.Recommend.delete', ['id' => $->->id])}}">
                            @csrf
                            @method('delete')
                            <input type="hidden" id="propertyId" name="" value="{{ $->mansion->id }}">
                            <input type="submit" value="削除">
                        </form>
                    </td>
                </tr>
