        ...
        <table class="list">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $new_detached_house_group->new_detached_house_group->lowest_number_of_rooms }}{{ $new_detached_house_group->new_detached_house_group->lowest_type_of_room }}〜{{ $new_detached_house_group->new_detached_house_group->lowest_number_of_rooms }}{{ $new_detached_house_group->new_detached_house_group->lowest_type_of_room }}</td>
