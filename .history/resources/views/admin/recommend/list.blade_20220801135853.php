    ...
    <h3>新築戸建</h3>
        <table class="list">
            ...
            <tbody>
                ...
                <tr>
                    <td>{{ $new_detached_house->new_detached_house->apartment_name }}</td>
                    <td>{{ $new_detached_house->new_detached_house->room }}号室</td>
                    <td>{{ $new_detached_house->new_detached_house->number_of_rooms }}{{ $new_detached_house->new_detached_house->type_of_room }}</td>
                    <td>{{ $new_detached_house->new_detached_house->occupation_area }}㎡</td>
