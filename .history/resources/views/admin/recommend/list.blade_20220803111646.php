        ...
        <table class="list">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('admin.recommend.delete', ['id' => $land->id]) }}" method="POST">
                            @csrf
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('admin.recommend.delete', ['id' => $mansion->id]) }}" method="POST">
                            @csrf
                            <input type="hidden" name="mansion" value="{{ $mansion->id }}">
                            <input type="submit" value="削除">
                        </form>
                    </td>
                </tr>
        ...
        <table class="list">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type="button" value="詳細"></td>
                    <td>
                        <form action="{{ route('admin.recommend.delete', ['id' => $new_detached_house->id]) }}" method="POST">
                            @csrf
                            <input type="hidden" name="new_detached_house" value="{{ $new_detached_house->id }}">
                            <input type="submit" value="削除">
                        </form>
                    </td>
                </tr>
        ...
        <table class="list">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type="button" value="詳細"></td>
                    <td>
                        <form action="{{ route('admin.recommend.delete', ['id' => $new_detached_house_group->id]) }}" method="POST">
                            @csrf
                            <input type="hidden" name="new_detached_house_group" value="{{ $new_detached_house_group->id }}">
                            <input type="submit" value="削除">
                        </form>
                    </td>
                </tr>
        ...
        <table class="list">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type="button" value="詳細"></td>
                    <td>
                        <form action="{{ route('admin.recommend.delete', ['id' => $old_detached_house->id]) }}" method="POST">
                            @csrf
                            <input type="hidden" name="old_detached_house" value="{{ $old_detached_house->id }}">
                            <input type="submit" value="削除">
                        </form>
                    </td>
                </tr>
