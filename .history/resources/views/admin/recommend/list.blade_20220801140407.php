...
<h2>おすすめ物件一覧</h2><br>
    ...
    @if(!empty($nnew_detached_house_groups))
    <h3>新築戸建</h3>
        <table class="list">
            <colgroup>
                <col style="width: 20%;">
            ...
            <tbody>
                @forelse($nnew_detached_house_groups as $nnew_detached_house_group)
                <tr>
                    <td>{{ $nnew_detached_house_group->nnew_detached_house_group->name }}</td>
                    <td>{{ $nnew_detached_house_group->nnew_detached_house_group->number_of_rooms }}{{ $nnew_detached_house_group->nnew_detached_house_group->type_of_room }}</td>
                    <td>{{ $nnew_detached_house_group->nnew_detached_house_group->price }}万円</td>
                    <td>{{ $nnew_detached_house_group->nnew_detached_house_group->land_area }}</td>
                    <td>{{ $nnew_detached_house_group->nnew_detached_house_group->building_area }}㎡</td>
                    <td>{{ $nnew_detached_house_group->nnew_detached_house_group->pref }}{{ $nnew_detached_house_group->nnew_detached_house_group->municipalities }}</td>
                    <td><input type="button" value="詳細"></td>
                    <td><input type="submit" value="削除"></td>
                </tr>
                @endforeach
