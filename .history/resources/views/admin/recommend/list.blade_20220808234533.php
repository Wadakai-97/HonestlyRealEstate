        ...
        <table class="list">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <form method="POST" action="{{route('admin.newDetachedHouse.delete', ['id' => $new_detached_house->new_detached_house->id])}}">
                            @csrf
                            @method('delete')
        ...
        <table class="list">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $new_detached_house_group->new_detached_house_group->lowest_price }}万円〜{{ $new_detached_house_group->new_detached_house_group->highest_priceprice }}万円</td>
