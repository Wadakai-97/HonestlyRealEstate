        ...
        <table class="list">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button onclick="location.href='{{ route('admin.newDetachedHouseGroup.detail', ['id' => $new_detached_house->new_detached_house->id]) }}'">詳細</button>
                    </td>
                    <td>
                        <form method="POST" action="{{route('admin.newDetachedHouseGroup.delete', ['id' => $new_detached_house->new_detached_house->id])}}">
                            @csrf
                            @method('delete')
