        ...
        <table class="list">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button onclick="location.href='{{ route('admin.land.detail', ['id' => $land->land->id]) }}'">詳細</button>
                    </td>
                    <td>
                        <form method="POST" action="{{route('admin.landRecommend.delete', ['id' => $land->land->id])}}">
                            @csrf
                            @method('delete')
        ...
        <table class="list">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button onclick="location.href='{{ route('admin.mansion.detail', ['id' => $mansion->mansion->id]) }}'">詳細</button>
                    </td>
                    <td>
                        <form method="POST" action="{{route('admin.mansionRecommend.delete', ['id' => $mansion->mansion->id])}}">
                            @csrf
                            @method('delete')
        ...
        <table class="list">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button onclick="location.href='{{ route('admin.new_detached_house.detail', ['id' => $new_detached_house->new_detached_house->id]) }}'">詳細</button>
                    </td>
                    <td>
                        <form method="POST" action="{{route('admin.new_detached_houseRecommend.delete', ['id' => $new_detached_house->new_detached_house->id])}}">
                            @csrf
                            @method('delete')
        ...
        <table class="list">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button onclick="location.href='{{ route('admin.new_detached_house_group.detail', ['id' => $new_detached_house_group->new_detached_house_group->id]) }}'">詳細</button>
                    </td>
                    <td>
                        <form method="POST" action="{{route('admin.new_detached_house_groupRecommend.delete', ['id' => $new_detached_house_group->new_detached_house_group->id])}}">
                            @csrf
                            @method('delete')
        ...
        <table class="list">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button onclick="location.href='{{ route('admin.old_detached_house.detail', ['id' => $old_detached_house->old_detached_house->id]) }}'">詳細</button>
                    </td>
                    <td>
                        <form method="POST" action="{{route('admin.old_detached_houseRecommend.delete', ['id' => $old_detached_house->old_detached_house->id])}}">
                            @csrf
                            @method('delete')
