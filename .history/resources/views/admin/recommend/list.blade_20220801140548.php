        ...
        <table class="list">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $new_detached_house_group->new_detached_house_group->number_of_rooms }}{{ $new_detached_house_group->new_detached_house_group->type_of_room }}</td>
                    <td>{{ $new_detached_house_group->new_detached_house_group->lowest_priceprice }}万円〜{{ $new_detached_house_group->new_detached_house_group->lowest_priceprice }}万円</td>
