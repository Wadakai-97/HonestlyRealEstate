...
<form method="post" action="{{ route('admin.customer.edit',  ['id' => $customer->id]) }}"  enctype="multipart/form-data">
    ...
    <table class="single_table">
        ...
        <tbody>
            <tr>
                <th><label<label class="required">お客様名</label></th>
                <td>
            ...
            <tr>
                ...
                <td>
                    <textarea maxlength="200" placeholder="最大200文字まで" name="content" id="countTerms">{{ old('content', $customer->content) }}</textarea>
