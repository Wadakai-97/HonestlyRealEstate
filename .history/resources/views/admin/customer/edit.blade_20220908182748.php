    ...
    <table class="single_table">
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('name'))) has-error @endif">
                        <input type="text" name="customer_name" value="{{ old('name', $customer->name) }}">
            ...
            <tr>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('email'))) has-error @endif">
                        <input type="text" name="email" value="{{ old('email', $customer->email) }}" step="1">
            ...
            <tr>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('phone'))) has-error @endif">
                        <input type="text" name="phone" value="{{ old('phone', $customer->phone) }}" step="1">
            ...
            <tr>
                ...
                <td>
                    <textarea maxlength="200" placeholder="最大200文字まで" name="contents" id="countTerms">{{ old('contents', $customer->content) }}</textarea>
