            ...
            <tr>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('balcony_area'))) has-error @endif">
                        <input type="text" name="balcony_area" value="{{ old('balcony_area', $mansion->balcony_area) }}">㎡
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <label id="maxLengthLabel">入力可能文字数：<span id="showSalesComment">200</span></label>
                </td>
            </tr>
            <tr>
                <th><p>物件紹介コメント</p></th>
                <td>
                    <textarea maxlength="800" placeholder="最大800文字まで" name="property_introduction" id="coountIntroComment">{{ old('property_introduction', $mansion->property_introduction) }}</textarea>
                    <label id="maxLengthLabel">入力可能文字数：<span id="showIntroComment">800</span></label>
                </td>
            </tr>
            <tr>
                <th><p>設備条件</p></th>
                <td>
                    <textarea maxlength="200" placeholder="最大200文字まで" name="terms_and_conditions" id="">{{ old('terms_and_conditions', $mansion->terms_and_conditions) }}</textarea>
                    <label id="maxLengthLabel">入力可能文字数：<span id="showTerms">200</span></label>
                </td>
            </tr>
        </tbody>
    </table>
