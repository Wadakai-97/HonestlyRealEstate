            ...
            <tr class="property_images">
                @for($i = 1; $i < 21; $i++)
                    <td class="property_images_block">
                        ...
                        <img src="{{ asset('/storage/mansion_images/no_image.jpeg') }}" id="noImage{{ $i }}" class="no_image" alt="プレビュー画像{{ $i }}">
                        <div id="{{ $i }}"></div>
                        <div class="form-group @if(!empty($errors->first("imagei"))) has-error @endif">
