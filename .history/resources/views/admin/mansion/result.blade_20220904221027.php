    ...
    <table class="filtering_table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="multiple_answers">
                        <label for="accessMethod1"><input type="radio" id="accessMethod1" value="徒歩" name="access_method"> 徒歩</label>
                        <label for="accessMethod2"><input type="radio" id="accessMethod2" value="バス" name="access_method"> バス</label>
                        <label for="accessMethod3"><input type="radio" id="accessMethod3" value="車" name="access_method"> 車</label>
                    </div>
                    <div class="multiple_answers">
                        <label for="distanceStation1"><input type="radio" id="distanceStation1" value="5" name="distance_station"> 5分以内</label>
                        <label for="distanceStation2"><input type="radio" id="distanceStation2" value="10" name="distance_station"> 10分以内</label>
                        <label for="distanceStation3"><input type="radio" id="distanceStation3" value="15" name="distance_station"> 15分以内</label>
                        <label for="distanceStation4"><input type="radio" id="distanceStation4" value="20" name="distance_station"> 20分以内</label>
                    </div>
                </td>
            </tr>
        </tbody>
...
<form action="{{ route('admin.mansion.filteringCsv') }}">
    ...
    <input type="hidden" name="apartment_name" value="{{ $request->apartment_name }}">
...
@if(!empty(request()))
    <div class="search_condition">
        ...
        <p>
            ...
            @endif
            @if(!empty(request()->access_method))
                【駅までのアクセス方法】{{ $request->access_method }}分
            @endif
            @if(!empty(request()->distance_station))
                【駅までの所要時間】{{ $request->distance_station }}分
            @endif
        </p>
    </div>
@endif
