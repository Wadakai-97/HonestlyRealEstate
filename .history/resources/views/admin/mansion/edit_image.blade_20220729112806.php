                    ...
                    <td class="property_images_block">
                        <form method="post" action="{{ route('admin.mansionImage.update', ['id' => $mansion_image->id]) }}" enctype="multipart/form-data">
                            ...
                            <div class="display_image">
                                <img src="{{ asset('/storage/mansion_images/' . $mansion_image->path) }}" id="showImage{{ $image_counter }}" class="no_image" alt="物件画像{{ $image_counter }}">
                            </div>
                        ...
                        <form method="post" action="{{ route('admin.mansionImage.allDelete', ['id' => $mansion_image->id]) }}">
                            @csrf
