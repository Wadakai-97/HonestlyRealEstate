        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <label id="maxLengthLabel">入力可能文字数：<span id="countSalesComment">200</span></label>
                </td>
            </tr>
            <tr>
                <th><p>物件紹介コメント</p></th>
                <td>
                    ...
                    <label id="maxLengthLabel">入力可能文字数：<span id="countIntroComment">800</span></label>
                </td>
            </tr>
            <tr>
                <th><p>設備条件</p></th>
                <td>
                    ...
                    <label id="maxLengthLabel">入力可能文字数：<span id="countTerms">200</span></label>
                </td>
            </tr>
        </tbody>
    </table>
