...
<table class="list">
    ...
    <tbody>
        ...
        <td>
            <form method="POST" action="/public/mansion/recommend/${val.id}">
                @csrf
        ...
        <td>
            <form method="delete" action="/public/mansion/delete/${val.id}">@csrf<input type="submit" id="mansionDelete" value="削除"></form></td>
        @empty
