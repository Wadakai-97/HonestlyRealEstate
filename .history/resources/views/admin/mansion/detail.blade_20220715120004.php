...
<table>
    <tbody>
        ...
        <tr>
            <th>土地面積</th>
            <td>
                {{ number_formmat($mansion->land_area) }}㎡
            </td>
            <th>建物面積</th>
            <td>
                {{ number_formmat($mansion->building_area) }}㎡
            </td>
        </tr>
        <tr>
            <th>間取り</th>
        ...
        <tr>
            <th>管理費</th>
            <td>
                {{ number_formmat($mansion->maintenance_fee) }}円
            </td>
            <th>修繕積立金</th>
            <td>
                {{ number_formmat($mansion->reserve_fund_for_repair) }}円
            </td>
        </tr>
        <tr>
            <th>その他費用</th>
