            ...
            @empty
                <td>
                    <form action="post">
                        @csrf
                        @method('patch')
                        <img src="{{ asset('/storage/mansion_images/no_image.jpeg') }}" width="300px" height="300px">
                        <label for="category">分類：<input type="text" value="" name="catogory" id="category"></label>
                        <label for="category">コメント：<input type="text" value="" name="comment"></label>
                        <input type="submit" value="削除">
                    </form>
                </td>
            @endforelse
