            ...
            <tr>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('apartment_name'))) has-error @endif">
                        <input type="text" name="apartment_name" value="{{ old('apartment_name') }}"autofocus>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('measuring_method'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('occupation_area'))) has-error @endif">
                            ...
                            <input type="number" step="0.01" name="occupation_area" value="{{ old('occupation_area') }}"> ㎡
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('balcony'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('balcony_area'))) has-error @endif">
                            <input type="radio" name="balcony" id="noBalcony" value="なし" {{ old('balcony') == 'なし' ? 'checked' : '' }} onclick="balconySignUp()"><label for="noBalcony">なし</label>
                            <input type="radio" name="balcony" id="haveBalcony" value="あり" {{ old('balcony') == 'あり' ? 'checked' : '' }} onclick="balconySignUp()"><label for="haveBalcony">あり</label>
