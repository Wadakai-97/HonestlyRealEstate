    ...
    <table class="filtering_table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="multiple_answers">
                        <label for="accessMethod1"><input type="radio" id="accessMethod1" value="5" name="access_method"> 徒歩</label>
                        <label for="accessMethod2"><input type="radio" id="accessMethod2" value="10" name="access_method"> バス</label>
                        <label for="accessMethod3"><input type="radio" id="accessMethod3" value="15" name="access_method"> 車</label>
                    </div>
                    <div class="multiple_answers">
