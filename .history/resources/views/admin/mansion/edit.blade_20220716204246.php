                ...
                <td>
                    ...
                    <div>
                        ...
                        <select name="station" id="station">
                            <option value="{{ old('station', $mansion->station) }}" @if(old('conditions_of_transactions', $mansion->conditions_of_transactions) === $conditions_of_transactions) selected @endif>路線を選択してください。</option>
                        </select>
                    </div>
                    まで徒歩
