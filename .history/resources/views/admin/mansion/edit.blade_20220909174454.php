    ...
    <table>
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('room'))) has-error @endif">
                        <input type="number" name="room" value="{{ old('room', $mansion->room) }}">
                ...
                <td colspan=3>
                    <div class="form-group @if(!empty($errors->first('price'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('tax'))) has-error @endif">
                            <input type="number" step="0.1" min="0.1" max="99999.9" name="price" value="{{ old('price', $mansion->price) }}">万円
                            <select name="tax">
            ...
            <tr>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('pref'))) has-error @endif">
                        <input type="text" maxlength="4" id="都道府県" name="pref" placeholder="〇〇県" value="{{ old('pref', $mansion->pref) }}">
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('municipalities'))) has-error @endif">
                        <input type="text" maxlength="70" id="市区町村" name="municipalities" placeholder="〇〇市〇〇区〇〇町" value="{{ old('municipalities', $mansion->municipalities) }}">
            ...
            <tr>
                <th>住所３（丁目番地）</th>
                <td colspan=3>
                    <input type="text" maxlength="30" name="block" placeholder="〇〇-〇" value="{{ old('block', $mansion->block) }}">
                </td>
            </tr>
            <tr>
                <th>土地面積</th>
                <td>
                    <input type="number" step="0.01" min="0.01" max="99999.99" name="land_area" value="{{ old('land_area', $mansion->land_area) }}"> ㎡
                </td>
                <th>建物面積</th>
                <td>
                    <input type="number" step="0.01" min="0.01" max="99999.99" name="building_area" value="{{ old('building_area', $mansion->building_area) }}"> ㎡
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('measuring_method'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('occupation_area'))) has-error @endif">
                            ...
                            <input type="number" step="0.01" name="occupation_area" value="{{ old('occupation_area', $mansion->occupation_area) }}"> ㎡
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('balcony'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('balcony_area'))) has-error @endif">
                            <input type="radio" name="balcony" id="noBalcony" value="なし" onclick="balconyEdit()" @if(old('balcony', $mansion->balcony) === 'なし') checked @endif><label for="noBalcony">なし</label>
                            <input type="radio" name="balcony" id="haveBalcony" value="あり" onclick="balconyEdit()" @if(old('balcony', $mansion->balcony) === 'あり') checked @endif><label for="haveBalcony">あり</label>
                            <div id="balconyAreaForm">
                                <label for="balconyArea">バルコニー面積：<input type="number" step="0.01" min="0.01" max="999.99" name="balcony_area" id="balconyArea" value="{{ old('balcony_area', $mansion->balcony_area) }}"> m</label>
                            </div>
                    ...
                    <div class="form-group @if(!empty($errors->first('year'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('month'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('day'))) has-error @endif">
                                <input type="number" name="year" id="year" value="{{ old('year', $mansion->year) }}" min="1900" max="2100" step="1"> 年
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="form-group @if(!empty($errors->first('distance_station'))) has-error @endif">
                        <input type="number" step="1" min="1" max="60" name="distance_station" value="{{ old('distance_station', $mansion->distance_station) }}"> 分
            ...
            <tr>
                <th>小学校</th>
                <td colspan=3>
                    <input type="text" placeholder="〇〇小学校" name="elementary_school_name" value="{{ old('elementary_school_name', $mansion->elementary_school_name) }}"> まで徒歩 <input type="number" step="1" min="1" max="60" name="elementary_school_district" value="{{ old('elementary_school_district', $mansion->elementary_school_district) }}"> 分
                </td>
            </tr>
            <tr>
                <th>中学校</th>
                <td colspan=3>
                    <input type="text" placeholder="〇〇中学校" name="junior_high_school_name" value="{{ old('junior_high_school_name', $mansion->junior_high_school_name) }}"> まで徒歩 <input type="number" step="1" min="1" max="60" name="junior_high_school_district" value="{{ old('junior_high_school_district', $mansion->junior_high_school_district) }}"> 分
                </td>
            </tr>
        </tbody>
    </table><br>
