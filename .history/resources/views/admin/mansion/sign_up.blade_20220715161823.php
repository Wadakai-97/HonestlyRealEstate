                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('balcony'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('balcony_area'))) has-error @endif">
                            ...
                            <input type="radio" name="balcony" id="noBalcony" value="なし" {{ old('balcony', 'なし') == 'なし' ? 'checxked' : '' }} onclick="balconyClick()"></label>
                            <label for="haveBalcony">あり
                            <input type="radio" name="balcony" id="haveBalcony" value="あり" {{ old('balcony', 'あり') == 'あり' ? 'checxked' : '' }} onclick="balconyClick()"></label>
