    ...
    <table class="filtering_table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="multiple_answers">
                        <label for="accessethod1"><input type="radio" id="accessethod1" value="5" name="distance_station"> 5分以内</label>
                        <label for="accessethod2"><input type="radio" id="accessethod2" value="10" name="distance_station"> 10分以内</label>
                        <label for="accessethod3"><input type="radio" id="accessethod3" value="15" name="distance_station"> 15分以内</label>
                        <label for="accessethod4"><input type="radio" id="accessethod4" value="20" name="distance_station"> 20分以内</label>
                    </div>
                    <div class="multiple_answers">
