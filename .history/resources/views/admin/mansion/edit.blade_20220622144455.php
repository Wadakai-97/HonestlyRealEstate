                    ...
                    <div class="form-group @if(!empty($errors->first('land_use_zones'))) has-error @endif">
                        <select name="land_use_zones">
                            <option disabled selected>未選択</option>
                                    ...
                                    @foreach (PropertyInformationConsts::LAND_UZE_ZONES_LIST as $key => $land_uze_zones )
                                    <option value="{{ $key }}" @if(old('land_use_zones', $mansion->land_use_zones) === '{{ $key }}') selected @endif>{{ $land_uze_zones }}</option>
                                    @endforeach
                            <option value="田園住居地域" @if(old('land_use_zones', $mansion->land_use_zones) === '田園住居地域') selected @endif>田園住居地域</option>
                            <option value="第一種低層住居専用地域" @if(old('land_use_zones', $mansion->land_use_zones) === '第一種低層住居専用地域') selected @endif>第一種低層住居専用地域</option>
                            <option value="第二種低層住居専用地域" @if(old('land_use_zones', $mansion->land_use_zones) === '第二種低層住居専用地域') selected @endif>第二種低層住居専用地域</option>
                            <option value="第一種中高層住居専用地域" @if(old('land_use_zones', $mansion->land_use_zones) === '第一種中高層住居専用地域') selected @endif>第一種中高層住居専用地域</option>
                            <option value="第二種中高層住居専用地域" @if(old('land_use_zones', $mansion->land_use_zones) === '第二種中高層住居専用地域') selected @endif>第二種中高層住居専用地域</option>
                            <option value="第一種住居地域" @if(old('land_use_zones', $mansion->land_use_zones) === '第一種住居地域') selected @endif>第一種住居地域</option>
                            <option value="第二種住居地域" @if(old('land_use_zones', $mansion->land_use_zones) === '第二種住居地域') selected @endif>第二種住居地域</option>
                            <option value="準住居地域" @if(old('land_use_zones', $mansion->land_use_zones) === '準住居地域') selected @endif>準住居地域</option>
                            <option value="近隣商業地域" @if(old('land_use_zones', $mansion->land_use_zones) === '近隣商業地域') selected @endif>近隣商業地域</option>
                            <option value="商業地域" @if(old('land_use_zones', $mansion->land_use_zones) === '商業地域') selected @endif>商業地域</option>
                            <option value="準工業地域" @if(old('land_use_zones', $mansion->land_use_zones) === '準工業地域') selected @endif>準工業地域</option>
                            <option value="工業地域" @if(old('land_use_zones', $mansion->land_use_zones) === '工業地域') selected @endif>工業地域</option>
                        </select>
