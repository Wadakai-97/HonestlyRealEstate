    ...
    <table class="filtering_table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="multiple_answers">
                        <label for="1"><input type="radio" id="1" value="5" name="distance_station"> 5分以内</label>
                        <label for="2"><input type="radio" id="2" value="10" name="distance_station"> 10分以内</label>
                        <label for="3"><input type="radio" id="3" value="15" name="distance_station"> 15分以内</label>
                        <label for="4"><input type="radio" id="4" value="20" name="distance_station"> 20分以内</label>
                    </div>
                    <div class="multiple_answers">
