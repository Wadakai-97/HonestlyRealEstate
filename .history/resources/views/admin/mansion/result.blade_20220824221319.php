        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="multiple_answers">
                        <label for="distanceStatio1"><input type="radio" id="distanceStatio1" value="5" name="distance_station"> 5分以内</label>
                        <label for="distanceStatio2"><input type="radio" id="distanceStatio2" value="10" name="distance_station"> 10分以内</label>
                        <label for="distanceStatio3"><input type="radio" id="distanceStatio3" value="15" name="distance_station"> 15分以内</label>
                        <label for="distanceStatio4"><input type="radio" id="distanceStatio4" value="20" name="distance_station"> 20分以内</label>
                    </div>
                </td>
            </tr>
        </tbody>
