    ...
    <table class="filtering_table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="multiple_answers">
                        <label for="accessMethod1"><input type="radio" id="accessMethod1" value="5" name="access_method"> 5分以内</label>
                        <label for="accessMethod2"><input type="radio" id="accessMethod2" value="10" name="access_method"> 10分以内</label>
                        <label for="accessMethod3"><input type="radio" id="accessMethod3" value="15" name="access_method"> 15分以内</label>
                        <label for="accessMethod4"><input type="radio" id="accessMethod4" value="20" name="access_method"> 20分以内</label>
                    </div>
                    <div class="multiple_answers">
