    ...
    <table class="filtering_table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="multiple_answers">
                        <label for="access_method1"><input type="radio" id="access_method1" value="5" name="distance_station"> 5分以内</label>
                        <label for="access_method2"><input type="radio" id="access_method2" value="10" name="distance_station"> 10分以内</label>
                        <label for="access_method3"><input type="radio" id="access_method3" value="15" name="distance_station"> 15分以内</label>
                        <label for="access_method4"><input type="radio" id="access_method4" value="20" name="distance_station"> 20分以内</label>
                    </div>
                    <div class="multiple_answers">
