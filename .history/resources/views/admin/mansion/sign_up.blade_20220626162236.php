    ...
    <table>
        <tbody>
            ...
            <tr>
                <th><p>セールスコメント</p></th>
                <td>
                    <textarea maxlength="200" placeholder="最大200文字まで" name="sales_comment" id="countDown200">{{ old('sales_comment') }}</textarea>
                    <span id="showCount200">200</span>
                </td>
            </tr>
            <tr>
                <th><p>物件紹介コメント</p></th>
                <td>
                    <textarea maxlength="800" placeholder="最大800文字まで" name="property_introduction" id="countDown800">{{ old('property_introduction') }}</textarea>
                    <span id="showCount800">800</span>
                </td>
            </tr>
            <tr>
                <th><p>設備条件</p></th>
                <td>
                    <textarea maxlength="200" placeholder="最大200文字まで" name="terms_and_conditions" id="countDown200">{{ old('terms_and_conditions') }}</textarea>
                    <span id="showCount200"><label>入力可能文字数：</label>200</span>
                </td>
            </tr>
        </tbody>
    </table>
