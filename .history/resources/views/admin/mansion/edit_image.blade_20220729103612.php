                    ...
                    <td class="property_images_block">
                        <form method="post" action="{{ route('admin.mansionImage.update', ['id' => $mansion_image->id]) }}" enctype="multipart/form-data">
                            ...
                            <div class="display_image">
                                <img src="{{ asset('/storage/mansion_images/' . $mansion_image->path) }}" id="noImage{{ $image_counter }}" class="no_image" alt="物件画像{{ $image_counter }}">
                            </div>
                            <form action="{{ route('admin.mansionImage.delete'< ['id', => $mansion_image">
                                <input type="hidden" id="mansionImageId" value="{{ $mansion_image->id }}">
                            </form>
                            <input type="submit" id="mansionImageDelete" value="画像削除">
                            @endif
