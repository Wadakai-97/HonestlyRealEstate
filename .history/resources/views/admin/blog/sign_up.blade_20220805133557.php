                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('images'))) has-error @endif">
                        ...
                        <div class="form-group @if(!empty($errors->first("image" . $i))) has-error @endif">
                            <input type="file" name="image" id="inputImage" onchange="previewPropertyImage(event, )">
                            <span class="help-block">{{$errors->first("image" . $i )}}</span>
                        </div><br>
                        <input type="button" onclick="resetPropertyImage()" value="削除">

                        {{-- <img id="preview" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==">
                        <div class="inputForm">
                            <input type="file" name="images" id="image" onchange="previewImage(this);">
