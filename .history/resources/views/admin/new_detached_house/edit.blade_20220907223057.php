                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('parking'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('parking_lot'))) has-error @endif">
                            ...
                            <input type="radio" name="parking" id="haveParking" value="{{ old('parking', 'あり') }}" onclick="parkingClick()"@if(old('parking', $new->parking) === 'あり') checked @endi></label>
                            <div id="parkingLotForm">
                                <label for="parkingLot">駐車場台数：
                                <input type="number" name="parking_lot" id="parkingLot" value="{{ old('parking_lot', $new->parking_lot) }}">m</label>
                            </div>
