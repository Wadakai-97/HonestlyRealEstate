                    ...
                    <div class="form-group @if(!empty($errors->first('balcony'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('balcony_area'))) has-error @endif">
                            <label for="noBalcony">なし
                                <option type="text" value="税込" @if(old('tax', $new_detached_house->tax) === '税込') selected @endif>税込</option>
                            <input type="radio" name="balcony" id="noBalcony" value="なし" onclick="balconyClick()" @if(old('balcony', $new_detached_house->balcony) === '税込') checked @endif></label>
                            <label for="yesbalcony">あり
                            <input type="radio" name="balcony" id="havebalcony" value="あり” onclick="balconyClick()"></label>
