                ...
                <td colspan=3>
                    <div class="form-group" @if(!empty($errors->first('balcony'))) has-error @endif>
                        <div class="form-group" @if(!empty($errors->first('balcony_area'))) has-error @endif>
                            <input type="radio" name="balcony" id="noBalcony" value="なし" onclick="balconyClick()" @if(old('balcony', $new_detached_house->balcony) === 'なし') checked @endif><label for="noBalcony">なし</label>
                            <input type="radio" name="balcony" id="haveBalcony" value="あり" onclick="balconyClick()" @if(old('balcony', $new_detached_house->balcony) === 'あり') checked @endif><label for="haveBalcony">あり</label>
                ...
                <td>
                    <div class="form-group" @if(!empty($errors->first('parking'))) has-error @endif>
                        <div class="form-group" @if(!empty($errors->first('parking_lot'))) has-error @endif>
                            <input type="radio" name="parking" id="noParking" value="{{ old('parking', 'なし') }}" onclick="parkingClick()"@if(old('parking', $new_detached_house->parking) === 'なし') checked @endif><label for="noParking">なし</label>
                            <input type="radio" name="parking" id="haveParking" value="{{ old('parking', 'あり') }}" onclick="parkingClick()"@if(old('parking', $new_detached_house->parking) === 'あり') checked @endif><label for="haveParking">あり</label>
                            <div id="parkingLotForm">
                                <label for="parkingLot">駐車場台数：<input type="number" name="parking_lot" id="parkingLot" value="{{ old('parking_lot', $new_detached_house->parking_lot) }}">m</label>
                            </div>
                ...
                <td>
                    <div class="form-group" @if(!empty($errors->first('setback'))) has-error @endif>
                        <div class="form-group" @if(!empty($errors->first('setback_length'))) has-error @endif>
                            <input type="radio" name="setback" id="noSetback" value="なし" onclick="setbackClick()" @if(old('setback', $new_detached_house->setback) === 'なし') checked @endif><label for="noSetback">なし</label>
                            <input type="radio" name="setback" id="haveSetback" value="あり" onclick="setbackClick()" @if(old('setback', $new_detached_house->setback) === 'あり') checked @endif><label for="haveSetback">あり</label>
                            <div id="setbackLengthForm">
                                <label for="setbackLength">セットバック幅：<input type="number" step=""name="setback_length" id="setbackLength" value="{{ old('setback_length', $new_detached_house->setback_length) }}">m</label>
                                <input type="number" step="0.01" name="land_area" value="{{ old('land_area', $new_detached_house->land_area) }}"> ㎡
                            </div>
