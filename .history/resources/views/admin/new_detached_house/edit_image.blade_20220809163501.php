            ...
            @foreach($new_detached_house_images as $new_detached_house_image)
                <td class="property_images_block">
                    <form method="post" action="{{ route('admin.newDetachedHouseImage.update', ['id' => $new_detached_house_image->id]) }}" enctype="multipart/form-data">
                        ...
                        <input type="submit" id="ImageSignUpRequest for DH<DHG<LANDImageUpdate" value="登録">
                    </form>
                    <form action="{{ route('admin.ImageSignUpRequest for DH<DHG<LANDImage.delete', ['id' => $new_detached_house_image->id]) }}">
