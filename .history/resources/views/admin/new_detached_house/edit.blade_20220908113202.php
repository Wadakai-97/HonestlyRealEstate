                    ...
                    <div class="form-group @if(!empty($errors->first('balcony'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('balcony_area'))) has-error @endif">
                            ...
                            <div id="balconyAreaForm">
                                ...
                                <input type="number" step="0.01" name="balcony_area" id="balconyArea" value="{{ old('balcony_area', $new_detached_house->balcony_area) }}">m</label>
                            </div>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('parking'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('parking_lot'))) has-error @endif">
                            ...
                            <input type="radio" name="parking" id="noParking" value="{{ old('parking', 'なし') }}" onclick="parkingClick()"@if(old('parking', $new_detached_house->parking) === 'なし') checked @endif></label>
                            <label for="yesParking">あり
                            <input type="radio" name="parking" id="haveParking" value="{{ old('parking', 'あり') }}" onclick="parkingClick()"@if(old('parking', $new_detached_house->parking) === 'あり') checked @endi></label>
                            <div id="parkingLotForm">
                                <label for="parkingLot">駐車場台数：
                                <input type="number" name="parking_lot" id="parkingLot" value="{{ old('parking_lot', $new_detached_house->parking_lot) }}">m</label>
                            </div>
                        ...
                        <div class="form-group @if(!empty($errors->first('adjacent_road'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('adjacent_road_width'))) has-error @endif">
                                <select name="adjacent_road_direction">
                                    ...
                                    <option value="{{ $key }}" @if(old('adjacent_road_direction', $new_detached->adjacent_road_direction) === $adjacent_road_direction) selected @endif>{{ $adjacent_road_direction }}</option>
                                    @endforeach
                                </select>
                                ...
                                <input type="text" name="adjacent_road_width" value="{{ old('adjacent_road_width', $new_detached->adjacent_road_width) }}" placeholder="接道幅">ｍ
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('setback'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('setback_length'))) has-error @endif">
                            ...
                            <input type="radio" name="setback" id="noSetback" value="なし" onclick="setbackClick()" @if(old('setback', $new_detached_house->setback) === 'なし') checked @endif></label>
                            <label for="yesSetback">あり
                            <input type="radio" name="setback" id="haveSetback" value="あり" onclick="setbackClick()" @if(old('setback', $new_detached_house->setback) === 'あり') checked @endif></label>
