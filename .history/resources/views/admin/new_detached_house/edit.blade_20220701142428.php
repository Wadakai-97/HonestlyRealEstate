    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td colspan=3>
                    <div class="form-group @if(!empty($errors->first('balcony', $new_detached_house->balcony))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('balcony_area', $new_detached_house->balcony_area))) has-error @endif">
                            <label for="noBalcony">なし
                            <input type="radio" name="balcony" id="noBalcony" value="{{ old('balcony') }}" onclick="balconyClick()"></label>
                            <label for="yesbalcony">あり
                            <input type="radio" name="balcony" id="havebalcony" value="{{ old('balcony') }}" onclick="balconyClick()"></label>
