                ...
                <td colspan=3>
                    <div class="form-group @if(!empty($errors->first('balcony'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('balcony_area'))) has-error @endif">
                            ...
                            <input type="radio" name="balcony" id="noBalcony" value="なし" onclick="balconyClick()" @if(old('balcony', $new_detached_house->balcony) === 'なし') checked @endif></label>
                            <label for="yesBalcony">あり
                            <input type="radio" name="balcony" id="haveBalcony" value="あり" onclick="balconyClick()" @if(old('balcony', $new_detached_house->balcony) === 'あり') checked @endif></label>
    ...
    <table>
        ...
        <tbody>
            <tr>
                <th>セールスコメント</th>
                <td>
                    <textarea maxlength="200" placeholder="最大200文字まで" name="sales_comment" id="countDownSalesComment">{{ old('sales_comment', $new_detached_house->sales_comment) }}</textarea>
