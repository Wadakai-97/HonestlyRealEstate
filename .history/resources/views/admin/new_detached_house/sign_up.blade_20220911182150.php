    ...
    <table>
        ...
        <tbody>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('price'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('tax'))) has-error @endif">
                            <input type="number" step="0.1" min="0.1" max="99999.9" name="price" value="{{ old('price') }}">万円
                            <select name="tax">
                    ...
                    <div class="form-group @if(!empty($errors->first('balcony'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('balcony_area'))) has-error @endif">
                            ...
                            <div id="balconyAreaForm">
                                <label for="balconyArea">バルコニー面積：<input type="number" step="0.01" min="0.01" max="999.99" name="balcony_area" id="balconyArea" value="{{ old('balcony_area') }}">m</label>
                            </div>
            ...
            <tr>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('land_area'))) has-error @endif">
                        <input type="number" step="0.01" min="0.01" max="99999.99" name="land_area" value="{{ old('land_area') }}"> ㎡
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('building_area'))) has-error @endif">
                        <input type="number" step="0.01" min="0.01" max="99999.99" name="building_area" value="{{ old('building_area') }}"> ㎡
            ...
            <tr>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('floor_area_ratio'))) has-error @endif">
                        <input type="number" min="50" max="1300" name="floor_area_ratio" value="{{ old('floor_area_ratio') }}"> ％
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('building_coverage_ratio'))) has-error @endif">
                        <input type="number" min="30" max="80" name="building_coverage_ratio" value="{{ old('building_coverage_ratio') }}"> ％
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('parking'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('parking_lot'))) has-error @endif">
                            <input type="radio" name="parking" id="noParking" value="{{ old('parking', 'なし') }}" onclick="parkingSignUp()"><label for="noParking"> なし</label>
                            <input type="radio" name="parking" id="haveParking" value="{{ old('parking', 'あり') }}" onclick="parkingSignUp()"><label for="haveParking"> あり</label>
                            <div id="parkingLotForm">
                                <label for="parkingLot">駐車台数：<input type="number" step="1" min="1" max="10" name="parking_lot" id="parkingLot" value="{{ old('parking_lot') }}">m</label>
                            </div>
            ...
            <tr>
                ...
                <th><label class="required">引き渡し日</label></th>
                <td>
                    ...
                    <div class="form-group @if(!empty($errors->first('adjacent_road_direction'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('adjacent_road'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('adjacent_road_width'))) has-error @endif">
                                ...
                                <input type="text" name="adjacent_road_width" value="{{ old('adjacent_road_width') }}" placeholder="接道幅">ｍ
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('setback'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('setback_length'))) has-error @endif">
                            <input type="radio" name="setback" id="noSetback" value="{{ old('setback', 'なし') }}" onclick="setbackSignUp()"><label for="noSetback">なし</label>
                            <input type="radio" name="setback" id="haveSetback" value="{{ old('setback', 'あり') }}" onclick="setbackSignUp()"><label for="haveSetback">あり</label>
                            <div id="setbackLengthForm">
                                <label for="setbackLength">セットバック幅：<input type="number" step="0.01" min="0.01" max="4.00" name="setback_length" id="setbackLength" value="{{ old('setback_length') }}">m</label>
                            </div>
            ...
            <tr>
                <th>小学校</th>
                <td>
                    <input type="text" placeholder="〇〇小学校" name="elementary_school_name" value="{{ old('elementary_school_name') }}"> まで徒歩 <input type="number" step="1" min="1" max="60" name="elementary_school_district" value="{{ old('elementary_school_district') }}"> 分
                </td>
                <th>中学校</th>
                <td>
                    <input type="text" placeholder="〇〇中学校" name="junior_high_school_name" value="{{ old('junior_high_school_name') }}"> まで徒歩 <input type="number" step="1" min="1" max="60" name="junior_high_school_district" value="{{ old('junior_high_school_district') }}"> 分
                </td>
            </tr>
        </tbody>
    </table><br>
