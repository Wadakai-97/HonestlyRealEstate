                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('setback'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('setback_length'))) has-error @endif">
                            ...
                            <input type="radio" name="setback" id="noSetback" value="あり{{ old('setback', $new_detached_house->setback) }}" onclick="setbackClick()"></label>
                            <label for="yesSetback">あり
                            <input type="radio" name="setback" id="haveSetback" value="{{ old('setback', $new_detached_house->setback) }}" onclick="setbackClick()"></label>
