                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('urban_planning'))) has-error @endif">
                        <select name="urban_planning">
                            ...
                            <option value="{{ $key }}" @if(old('urban_planning', $new_detached_house->) === $urban_planning) selected @endif>{{ $urban_planning }}</option>
                            @endforeach
                        </select>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('land_use_zones'))) has-error @endif">
                        <select name="land_use_zones">
                            ...
                            <option value="{{ $key }}" @if(old('land_use_zones', $new_detahced_house->) === $land_use_zones) selected @endif>{{ $land_use_zones }}</option>
                            @endforeach
                        </select>
            ...
            <tr>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('land_classification'))) has-error @endif">
                        <input type="text" name="land_classification" value="{{ old('land_classification', $new_detahced_house->) }}">
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('land_right'))) has-error @endif">
                        <select name="land_right">
                            ...
                            <option value="{{ $key }}" @if(old('land_right', $new_detahced_house->) === $land_right) selected @endif>{{ $land_right }}</option>
                            @endforeach
                        </select>
            ...
            <tr>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('status'))) has-error @endif">
                        <select name="status">
                            <option disabled selected>未選択</option>
                            <option value="更地" @if(old('status', $new_detahced_house->) === '更地') selected @endif>更地</option>
                            <option value="建築中" @if(old('status', $new_detahced_house->) === '建築中') selected @endif>建築中</option>
                            <option value="完成済み" @if(old('status', $new_detahced_house->) === '完成済み') selected @endif>完成済み</option>
                        </select>
