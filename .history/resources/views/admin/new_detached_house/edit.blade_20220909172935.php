                    ...
                    <div class="form-group" @if(!empty($errors->first('balcony'))) has-error @endif>
                        <div class="form-group" @if(!empty($errors->first('balcony_area'))) has-error @endif>
                            ...
                            <div id="balconyAreaForm">
                                <label for="balconyArea">バルコニー面積：<input type="number" step="0.01" min="0.01" max="99999.99" name="balcony_area" id="balconyArea" value="{{ old('balcony_area', $new_detached_house->balcony_area) }}"> m</label>
                            </div>
