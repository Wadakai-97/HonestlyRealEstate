                ...
                <td>
                    <div class="form-group" @if(!empty($errors->first('parking'))) has-error @endif>
                        <div class="form-group" @if(!empty($errors->first('parking_lot'))) has-error @endif>
                            ...
                            <input type="radio" name="parking" id="haveParking" value="{{ old('parking', 'あり') }}" onclick="parkingClick()"@if(old('parking', $new_detached_house->parking) === 'あり') checked @endif><label for="Parking">あり</label>
