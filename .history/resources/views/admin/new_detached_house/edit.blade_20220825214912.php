                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('access_method'))) has-error @endif">
                        <select name="access_method">
                            ...
                            <option value="{{ $key }}" @if(old('access_method', $->access_method) === $access_method) selected @endif>{{ $access_method }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group @if(!empty($errors->first('distance_station'))) has-error @endif">
                        <input type="number" name="distance_station" value="{{ old('distance_station', $->distance_station) }}">分
