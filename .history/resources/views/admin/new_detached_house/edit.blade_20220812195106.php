...
<table class="edit_menu">
    <tbody>
        <td><a href="{{ route('admin.new_detach.edit', ['id' => $new_detach->id]) }}" class="edit_menu_link">物件概要</a></td>
        <td><a href="{{ route('admin.new_detachImage.edit', ['id' => $new_detach->id]) }}" class="edit_menu_link">物件画像</a></td>
    </tbody>
</table><br>
