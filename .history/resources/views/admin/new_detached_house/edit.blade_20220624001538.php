...
<form method="post" action="{{ route('admin.newDetachedHouse.save', ['id' => $new_detached_house->od]) }}" enctype="multipart/form-data">
    @csrf
    <table>
        <thead>
            ...
            <tr>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('name'))) has-error @endif">
                        <input type="text" name="name" value="{{ old('name', $new_detahced_house->name) }}">
