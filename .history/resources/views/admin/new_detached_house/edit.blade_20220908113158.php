                        ...
                        <div class="form-group @if(!empty($errors->first('adjacent_road'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('adjacent_road_width'))) has-error @endif">
                                <select name="adjacent_road_direction">
                                    ...
                                    <option value="{{ $key }}" @if(old('adjacent_road_direction', $->adjacent_road_direction) === $adjacent_road_direction) selected @endif>{{ $adjacent_road_direction }}</option>
                                    @endforeach
                                </select>
                                ...
                                <input type="text" name="adjacent_road_width" value="{{ old('adjacent_road_width', $->adjacent_road_width) }}" placeholder="接道幅">ｍ
