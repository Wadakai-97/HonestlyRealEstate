    ...
    <table class="filtering_table">
        ...
        <tbody>
            ...
            <tr>
                <th>土地面積</th>
                <td>
                    <label for="lowest_land">
                        最低面積 ：
                        <select name="lowest_land">
                            <option disabled selected>-- 下限なし --</option>
                            @foreach (FilteringConsts::land_LIST as $key => $lowest_land)
                            <option value="{{ $key }}" @if(old('lowest_land') === $lowest_land) selected @endif>{{ $lowest_land }}㎡以上</option>
                            @endforeach
                        </select>
                    </label>
                    <label for="highest_land">
                        〜 最高面積 ：
                        <select name="highest_land">
                            <option disabled selected>-- 上限なし --</option>
                            @foreach (FilteringConsts::land_LIST as $key => $highest_land)
                            <option value="{{ $key }}" @if(old('highest_land') === $highest_land) selected @endif>{{ $highest_land }}㎡未満</option>
                            @endforeach
                        </select>
                    </label>
                </td>
