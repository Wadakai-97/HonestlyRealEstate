                ...
                <td colspan=3>
                    <div class="form-group @if(!empty($errors->first('balcony'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('balcony_area'))) has-error @endif">
                            ...
                            <input type="radio" name="balcony" id="noBalcony" value="{{ old('balcony', $new_detached_house->urban_planning) === $urban_planning) selected @endif>) }}" onclick="balconyClick()"></label>
