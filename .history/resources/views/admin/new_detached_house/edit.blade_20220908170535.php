                ...
                <td colspan=3>
                    <div class="form-group" @if(!empty($errors->first('balcony'))) has-error @endif>
                        <div class="form-group" @if(!empty($errors->first('balcony_area'))) has-error @endif>
                            ...
                            <input type="radio" name="balcony" id="haveBalcony" value="あり" onclick="balconyClick()" @if(old('balcony', $new_detached_house->balcony) === 'あり') checked @endif><label for="Balcony">あり</label>
