    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td colspan=3>
                    <div class="form-group" @if(!empty($errors->first('municipalities'))) has-error @endif>
                        <input type="text" maxlength="70" id="住所" name="municipalities" placeholder="〇〇市〇〇区〇〇町" value="{{ old('municipalities', $new_detached_house->municipalities) }}">
            ...
            <tr>
                <th>住所３（丁目番地）</th>
                <td colspan=3>
                    <input type="text" maxlength="30" name="block" placeholder="〇〇-〇" value="{{ old('block', $new_detached_house->block) }}">
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <div class="form-group" @if(!empty($errors->first('land_area'))) has-error @endif>
                        <input type="number" step="0.01" min="0.01" max="99999.99" name="land_area" value="{{ old('land_area', $new_detached_house->land_area) }}"> ㎡
                ...
                <td>
                    <div class="form-group" @if(!empty($errors->first('building_area'))) has-error @endif>
                        <input type="number" step="0.01" min="0.01" max="99999.99" name="building_area" value="{{ old('building_area', $new_detached_house->building_area) }}"> ㎡
            ...
            <tr>
                ...
                <td>
                    <div class="form-group" @if(!empty($errors->first('floor_area_ratio'))) has-error @endif>
                        <input type="number" min="50" max="1300" name="floor_area_ratio" value="{{ old('floor_area_ratio', $new_detached_house->floor_area_ratio) }}"> ％
                ...
                <td>
                    <div class="form-group" @if(!empty($errors->first('building_coverage_ratio'))) has-error @endif>
                        <input type="number" min="30" max="80" name="building_coverage_ratio" value="{{ old('building_coverage_ratio', $new_detached_house->building_coverage_ratio) }}"> ％
                    ...
                    <div class="form-group" @if(!empty($errors->first('balcony'))) has-error @endif>
                        <div class="form-group" @if(!empty($errors->first('balcony_area'))) has-error @endif>
                            ...
                            <div id="balconyAreaForm">
                                <label for="balconyArea">バルコニー面積：<input type="number" step="0.01" min="0.01" max="999.99" name="balcony_area" id="balconyArea" value="{{ old('balcony_area', $new_detached_house->balcony_area) }}"> m</label>
                            </div>
                    ...
                    <div class="form-group" @if(!empty($errors->first('year'))) has-error @endif>
                        <div class="form-group" @if(!empty($errors->first('month'))) has-error @endif>
                            <div class="form-group" @if(!empty($errors->first('day'))) has-error @endif>
                                <input type="number" name="year" id="year" value="{{ old('year', $new_detached_house->year) }}" min="1900" max="2100" step="1"> 年
                    ...
                    <div class="form-group" @if(!empty($errors->first('parking'))) has-error @endif>
                        <div class="form-group" @if(!empty($errors->first('parking_lot'))) has-error @endif>
                            ...
                            <div id="parkingLotForm">
                                <label for="parkingLot">駐車台数：<input type="number" step="1" min="1" max="10" name="parking_lot" id="parkingLot" value="{{ old('parking_lot', $new_detached_house->parking_lot) }}">m</label>
                            </div>
                    ...
                    <div class="form-group" @if(!empty($errors->first('setback'))) has-error @endif>
                        <div class="form-group" @if(!empty($errors->first('setback_length'))) has-error @endif>
                            ...
                            <div id="setbackLengthForm">
                                <label for="setbackLength">セットバック幅：<input type="number" step="0.01" min="0.01" max="4.00" name="setback_length" id="setbackLength" value="{{ old('setback_length', $new_detached_house->setback_length) }}"> m</label>
                            </div>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="form-group" @if(!empty($errors->first('distance_station'))) has-error @endif>
                        <input type="number" step="1" min="1" max="60" name="distance_station" value="{{ old('distance_station', $new_detached_house->distance_station) }}"> 分
            ...
            <tr>
                <th>小学校</th>
                <td colspan=3>
                    <input type="text" placeholder="〇〇小学校" name="elementary_school_name" value="{{ old('elementary_school_name', $new_detached_house->elementary_school_name) }}"> まで徒歩 </th><input type="number" step="1" min="1" max="60" name="elementary_school_district" value="{{ old('elementary_school_district', $new_detached_house->elementary_school_district) }}"> 分
                </td>
            </tr>
            <tr>
                <th>中学校</th>
                <td colspan=3>
                    <input type="text" placeholder="〇〇中学校" name="junior_high_school_name" value="{{ old('junior_high_school_name', $new_detached_house->junior_high_school_name) }}"> まで徒歩 </th><input type="number" step="1" min="1" max="60" name="junior_high_school_district" value="{{ old('junior_high_school_district', $new_detached_house->junior_high_school_district) }}"> 分
                </td>
            </tr>
        </tbody>
    </table><br>
