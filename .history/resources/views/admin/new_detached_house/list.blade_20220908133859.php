...
<form action="{{ route('admin.newDetachedHouse.csv') }}">
    @csrf
    ...
    <tbody>
        @forelse($new_detached_houses as $new_detached_house)
            <tr>
                ...
                <td>{{ $new_detached_house->station }}まで{{ $new_detached_house->access_method }}{{ $new_detached_house->distance_station }}分</td>
                <td>
