                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('setback'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('setback_length'))) has-error @endif">
                            ...
                            <input type="radio" name="setback" id="haveSetback" value="あり" onclick="setbackClick()" @if(old('balcony', $old_detached_house->setback) === 'あり') checked @endif><label for="yesSetback">あり</label>
