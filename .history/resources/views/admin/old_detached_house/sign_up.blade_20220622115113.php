                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('land_use_zones'))) has-error @endif">
                        <select name="land_use_zones">
                            <option disabled selected>未選択</option>
                            <option value="田園住居地域" @if(old('land_use_zones') === '田園住居地域') selected @endif>田園住居地域</option>
                            <option value="第一種低層住居専用地域" @if(old('land_use_zones') === '第一種低層住居専用地域') selected @endif>第一種低層住居専用地域</option>
                            <option value="第二種低層住居専用地域" @if(old('land_use_zones') === '第二種低層住居専用地域') selected @endif>第二種低層住居専用地域</option>
                            <option value="第一種中高層住居専用地域" @if(old('land_use_zones') === '第一種中高層住居専用地域') selected @endif>第一種中高層住居専用地域</option>
                            <option value="第二種中高層住居専用地域" @if(old('land_use_zones') === '第二種中高層住居専用地域') selected @endif>第二種中高層住居専用地域</option>
                            <option value="第一種住居地域" @if(old('land_use_zones') === '第一種住居地域') selected @endif>第一種住居地域</option>
                            <option value="第二種住居地域" @if(old('land_use_zones') === '第二種住居地域') selected @endif>第二種住居地域</option>
                            <option value="準住居地域" @if(old('land_use_zones') === '準住居地域') selected @endif>準住居地域</option>
                            <option value="近隣商業地域" @if(old('land_use_zones') === '近隣商業地域') selected @endif>近隣商業地域</option>
                            <option value="商業地域" @if(old('land_use_zones') === '商業地域') selected @endif>商業地域</option>
                            <option value="準工業地域" @if(old('land_use_zones') === '準工業地域') selected @endif>準工業地域</option>
                            <option value="工業地域" @if(old('land_use_zones') === '工業地域') selected @endif>工業地域</option>
                        </select>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('adjacent_road'))) has-error @endif">
                        <select name="adjacent_road">
                            <option disabled selected>未選択</option>
                            <option value="法42条1項1号道路（公道）" @if(old('adjacent_road') === '法42条1項1号道路（公道）') selected @endif>法42条1項1号道路（公道）</option>
                            <option value="法42条1項2号道路（開発道路）" @if(old('adjacent_road') === '法42条1項2号道路（開発道路）') selected @endif>法42条1項2号道路（開発道路）</option>
                            <option value="法42条1項3号道路（既存道路）" @if(old('adjacent_road') === '法42条1項3号道路（既存道路）') selected @endif>法42条1項3号道路（既存道路）</option>
                            <option value="法42条1項4号道路（計画道路）" @if(old('adjacent_road') === '法42条1項4号道路（計画道路）') selected @endif>法42条1項4号道路（計画道路）</option>
                            <option value="法42条1項5号道路（位置指定道路）" @if(old('adjacent_road') === '法42条1項5号道路（位置指定道路）') selected @endif>法42条1項5号道路（位置指定道路）</option>
                            <option value="法42条2項道路（みなし道路）" @if(old('adjacent_road') === '法42条2項道路（みなし道路）') selected @endif>法42条2項道路（みなし道路）</option>
                        </select>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('water_supply'))) has-error @endif">
                        <select name="water_supply">
                            <option disabled selected>未選択</option>
                            <option value="公営水道" @if(old('water_supply') === '公営水道') selected @endif>公営水道</option>
                            <option value="私営水道" @if(old('water_supply') === '私営水道') selected @endif>私営水道</option>
                            <option value="井戸" @if(old('water_supply') === '井戸') selected @endif>井戸</option>
                        </select>
