                ...
                <td colspan=3>
                    <div class="form-group @if(!empty($errors->first('balcony'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('balcony_area'))) has-error @endif">
                            <input type="radio" name="balcony" id="noBalcony" value="なし" onclick="balcony                        <p>駅</p>
                            ...
                            </select>()" @if(old('balcony', $old_detached_house->balcony) === 'なし') checked @endif><label for="noBalcony">なし</label>
