                ...
                <td colspan=3>
                    <div class="form-group @if(!empty($errors->first('balcony'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('balcony_area'))) has-error @endif">
                            ...
                            <input type="radio" name="balcony" id="noBalcony" value="なし" onclick="balconyClick()" @if(old('balcony', $old_detached_house->balcony) === 'あり') checked @endif></label>
                            <label for="yesbalcony">あり
                            <input type="radio" name="balcony" id="havebalcony" value="あり" onclick="balconyClick()" @if(old('balcony', $old_detached_house->balcony) === 'なし') checked @endif></label>
                            <div id="balconyAreaForm">
                                <label for="balconyArea">バルコニー面積：
                                <input type="number" name="balcony_area" id="balconyArea" value="{{ old('balcony_area', $old_detached_house->balcony_area) }}">m</label>
                            </div>
