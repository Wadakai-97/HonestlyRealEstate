                ...
                <td colspan=3>
                    <div class="form-group @if(!empty($errors->first('balcony'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('balcony_area'))) has-error @endif">
                            <input type="radio" name="balcony" id="noBalcony" value="なし" onclick="balconyClick()" @if(old('balcony', $old_detached_house->balcony) === 'なし') checked @endif><label for="noBalcony">なし</label>
                            <input type="radio" name="balcony" id="haveBalcony" value="あり" onclick="balconyClick()" @if(old('balcony', $old_detached_house->balcony) === 'あり') checked @endif><label for="haveBalcony">あり</label>
                            <div id="balconyAreaForm">
                                <label for="balconyArea">バルコニー面積：<input type="number" step="0.01" name="balcony_area" id="balconyArea" value="{{ old('balcony_area', $old_detached_house->balcony_area) }}"> m</label>
                            </div>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('setback'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('setback_length'))) has-error @endif">
                            <input type="radio" name="setback" id="noSetback" value="なし" onclick="setbackClick()" @if(old('balcony', $old_detached_house->setback) === 'なし') checked @endif><label for="noSetback">なし</label>
                            <input type="radio" name="setback" id="haveSetback" value="あり" onclick="setbackClick()" @if(old('balcony', $old_detached_house->setback) === 'あり') checked @endif><label for="haveSetback">あり</label>
