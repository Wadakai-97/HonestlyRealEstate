                ...
                <td colspan=3>
                    <div class="form-group @if(!empty($errors->first('balcony'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('balcony_area'))) has-error @endif">
                            ...
                            <input type="radio" name="balcony" id="noBalcony" value="なし" onclick="balconyClick()" @if(old('balcony', $new_detached_house->balcony) === 'あり') checked @endif></label>
                            <label for="yesbalcony">あり
                            <input type="radio" name="balcony" id="havebalcony" value="あり" onclick="balconyClick()" @if(old('balcony', $new_detached_house->balcony) === 'なし') checked @endif></label>
                            <div id="balconyAreaForm">
                                <label for="balconyArea">バルコニー面積：
                                <input type="number" name="balcony_area" id="balconyArea" value="{{ old('balcony_area', $new_detached_house->balcony_area) }}">m</label>
                            </div>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('setback'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('setback_length'))) has-error @endif">
                            ...
                            <input type="radio" name="setback" id="noSetback" value="{{ old('setback', $old_detached_house->setback) }}" onclick="setbackClick()"></label>
                            <label for="yesSetback">あり
                            <input type="radio" name="setback" id="haveSetback" value="{{ old('setback', $old_detached_house->setback) }}" onclick="setbackClick()"></label>
