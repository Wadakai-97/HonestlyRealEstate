            ...
            <tr>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('land_area'))) has-error @endif">
                        <input type="number" step="0.01" name="land_area" value="{{ old('land_area', $old_detached_house->land_area) }}">㎡
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('building_area'))) has-error @endif">
                        <input type="number" step="0.01" name="building_area" value="{{ old('building_area', $old_detached_house->building_area) }}">㎡
                ...
                <td colspan=3>
                    <div class="form-group @if(!empty($errors->first('balcony'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('balcony_area'))) has-error @endif">
                            ...
                            <input type="radio" name="balcony" id="noBalcony" value="なし" onclick="balconyClick()" @if(old('balcony', $old_detached_house->balcony) === 'なし') checked @endif></label>
                            <label for="haveBalcony">あり
                            <input type="radio" name="balcony" id="haveBalcony" value="あり" onclick="balconyClick()" @if(old('balcony', $old_detached_house->balcony) === 'あり') checked @endif></label>
                            <div id="balconyAreaForm">
                                <label for="balconyArea">バルコニー面積：
                                <input type="number" step="0.01" name="balcony_area" id="balconyArea" value="{{ old('balcony_area', $old_detached_house->balcony_area) }}">m</label>
                            </div>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('parking'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('parking_lot'))) has-error @endif">
                            ...
                            <input type="radio" name="parking" id="noParking" value="{{ old('parking', 'なし') }}" onclick="parkingClick()" @if(old('parking', $old_detached_house->parking) === 'なし') checked @endif></label>
                            <label for="yesParking">あり
                            <input type="radio" name="parking" id="haveParking" value="{{ old('parking', 'あり') }}" onclick="parkingClick()"@if(old('parking', $old_detached_house->parking) === 'あり') checked @endif></label>
                            <div id="parkingLotForm">
                                <label for="parkingLot">駐車場台数：
                                <input type="number" name="parking_lot" id="parkingLot" value="{{ old('parking_lot') }}">m</label>
                            </div>
                    ...
                    <td>
                        <div class="form-group @if(!empty($errors->first('parking'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('parking_lot'))) has-error @endif">
                                <label for="noParking">なし
                                <input type="radio" name="parking" id="noParking" value="{{ old('parking', 'なし') }}" onclick="parkingClick()"></label>
                                <label for="yesParking">あり
                                <input type="radio" name="parking" id="haveParking" value="{{ old('parking', 'あり') }}" onclick="parkingClick()"@if(old('parking', $old_detached_house->parking) === 'あり') checked @endi></label>
                                <div id="parkingLotForm">
                                    <label for="parkingLot">駐車場台数：
                                    <input type="number" name="parking_lot" id="parkingLot" value="{{ old('parking_lot') }}">m</label>
                                </div>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('setback'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('setback_length'))) has-error @endif">
                            ...
                            <input type="radio" name="setback" id="noSetback" value="なし" onclick="setbackClick()" @if(old('balcony', $old_detached_house->setback) === 'なし') checked @endif></label>
                            <label for="yesSetback">あり
                            <input type="radio" name="setback" id="haveSetback" value="あり" onclick="setbackClick()" @if(old('balcony', $old_detached_house->setback) === 'あり') checked @endif></label>
                            <div id="setbackLengthForm">
                                <label for="setbackLength">セットバック幅：
                                <input type="number" name="setback_length" id="setbackLength" value="{{ old('setback_length', $old_detached_house->setback_length) }}">m</label>
                            </div>
