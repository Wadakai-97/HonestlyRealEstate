                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('setback'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('setback_length'))) has-error @endif">
                            ...
                            <input type="radio" name="setback" id="noSetback" value="なし" onclick="setbackClick()" @if(old('balcony', $new_detached_house->setback) === 'なし') checked @endif></label>
                            <label for="yesSetback">あり
                            <input type="radio" name="setback" id="haveSetback" value="あり" onclick="setbackClick()" @if(old('balcony', $new_detached_house->setback) === 'あり') checked @endif></label>
                            <div id="setbackLengthForm">
                                <label for="setbackLength">セットバック幅：
                                <input type="number" name="setback_length" id="setbackLength" value="{{ old('setback_length', $new_detached_house->setback_length) }}">m</label>
                            </div>
