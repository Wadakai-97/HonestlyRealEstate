...
<form action="{{ route('admin.oldDetachedHouse.csv') }}">
    @csrf
    ...
    <tbody>
        @forelse($old_detached_houses as $old_detached_house)
            <tr>
                ...
                <td>{{ $old_detached_house->station }}まで{{ $old_detached_house->access_method }}{{ $old_detached_house->distance_station }}分</td>
...
<div class="d-flex justify-content-center">
    {{ $old_detached_houses->links('pagination::default') }}
</div>
@endsection
