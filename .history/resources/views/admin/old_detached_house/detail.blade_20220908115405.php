...
<table>
    ...
    <tbody>
        ...
        <tr>
            <th>完成時期（築年月）</th>
            <td>
                @if(!empty($old_detached_house->day))
                    {{ $old_detached_house->year }}年{{ $old_detached_house->month }}月{{ $old_detached_house->day }}日
                @elseif(empty($old_detached_house->day))
                    {{ $old_detached_house->year }}年{{ $old_detached_house->month }}月
                @endif
            </td>
            <th>建物構造</th>
            <td>
