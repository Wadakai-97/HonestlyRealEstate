            ...
            <tr>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('setback'))) has-error @endif">
                        ...
                        <input type="radio" name="setback" id="noSetback" value="{{ old('setback', $->setback) }}" onclick="setbackClick()"></label>
                        <label for="yesSetback">あり
                        <input type="radio" name="setback" id="haveSetback" value="{{ old('setback', $->setback) }}" onclick="setbackClick()"></label>
                        <div id="setbackLengthForm">
                            <label for="setbackLength">セットバック幅：
                            <input type="number" name="setback_length" id="setbackLength" value="{{ old('setback_length', $->setback_length) }}">m</label>
                        </div>
