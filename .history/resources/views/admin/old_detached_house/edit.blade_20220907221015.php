                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('parking'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('parking_lot'))) has-error @endif">
                            ...
                            <input type="radio" name="parking" id="noParking" value="{{ old('parking', $old_detached_house->land_classification) }}" onclick="parkingClick()"></label>
                            <label for="yesParking">あり
                            <input type="radio" name="parking" id="haveParking" value="{{ old('parking', $old_detached_house->land_classification) }}" onclick="parkingClick()"></label>
