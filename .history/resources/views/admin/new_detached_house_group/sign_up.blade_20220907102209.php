                    ...
                    <div class="form-group @if(!empty($errors->first('parking_lot'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('lowest_parking_lot'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('highest_parking_lot'))) has-error @endif">
                                ...
                                <input type="radio" name="parkinglot" id="noParkinglot" value="{{ old('parking_lot') }}" onclick="parkinglotClick()"></label>
                                <label for="yesParkinglot">あり
                                <input type="radio" name="parkinglot" id="haveParkinglot" value="{{ old('parkinglot') }}" onclick="parkinglotClick()"></label>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('setback'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('lowest_setback_length'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('highestsetback_length'))) has-error @endif">
