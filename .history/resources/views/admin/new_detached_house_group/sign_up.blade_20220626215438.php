    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <th>駐車場</th>
                <td>
                    <div class="form-group @if(!empty($errors->first('ぉうぇｓｔ＿ぱｒきんｇ＿ぉｔ'))) has-error @endif">
                        <input type="number" name="ぉうぇｓｔ＿ぱｒきんｇ＿ぉｔ" value="{{ old('ぉうぇｓｔ＿ぱｒきんｇ＿ぉｔ') }}">㎡
                    <span class="help-block">{{$errors->first('ぉうぇｓｔ＿ぱｒきんｇ＿ぉｔ')}}</span>
                </td>
            </tr>
            <tr>
