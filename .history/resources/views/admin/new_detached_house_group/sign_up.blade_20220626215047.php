    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td colspan=3>
                    <div class="form-group @if(!empty($errors->first('lowest_building_coverage'))) has-error @endif">
                        <input type="number" name="lowest_building_coverage" value="{{ old('lowest_building_coverage') }}">％
                    <span class="help-block">{{$errors->first('lowest_building_coverage')}}</span>
                </td>
            </tr>
            <tr>
                <th>バルコニー面積</th>
