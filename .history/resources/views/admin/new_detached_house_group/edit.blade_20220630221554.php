                ...
                <td colspan=3>
                    <div class="form-group @if(!empty($errors->first('lowest_balcony_area'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('highest_balcony_area'))) has-error @endif">
                            <input type="number" name="lowest_balcony_area" value="{{ old('balcony_area', $new_detached_house_group->lowest_balcony_area) }}"> ㎡ 〜
                            <input type="number" name="highest_balcony_area" value="{{ old('balcony_area', $new_detached_house_group->highest_balcony_area) }}"> ㎡
