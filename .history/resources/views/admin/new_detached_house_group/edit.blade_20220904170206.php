                    ...
                    <div class="form-group @if(!empty($errors->first('parking_lot'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('lowest_parking_lot'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('highest_parking_lot'))) has-error @endif">
                                ...
                                <input type="radio" name="parkinglot" id="noParkinglot" value="なし" onclick="parkinglotClick()" @if(old('parking_lot', $new_detached_house_group->parking_lot) === 'なし') checked @endif></label>
                                <label for="yesParkinglot">あり
                                <input type="radio" name="parkinglot" id="haveParkinglot" value="あり" onclick="parkinglotClick()" @if(old('parking_lot', $new_detached_house_group->parking_lot) === 'あり') checked @endif></label>
