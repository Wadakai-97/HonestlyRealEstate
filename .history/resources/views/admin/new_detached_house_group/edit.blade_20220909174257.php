    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <th>小学校</th>
                <td colspan=3>
                    <input type="text" placeholder="〇〇小学校" name="elementary_school_name" value="{{ old('elementary_school_name', $new_detached_house_group->elementary_school_name) }}"> まで徒歩 <input type="number" name="elementary_school_district" value="{{ old('elementary_school_district', $new_detached_house_group->elementary_school_district) }}"> 分
                </td>
            </tr>
            <tr>
                <th>中学校</th>
