...
<table>
    <tbody>
        ...
        <tr>
            <th>土地面積</th>
            <td>
                {{ $new_detached_house_group->lowest_land_area }}㎡〜{{ $new_detached_house_group->lowest_price}}万円（{{ $new_detached_house_group->tax }}）
            </td>
            <th>建物面積</th>
            <td>
                {{ $new_detached_house_group->lowest_building_area }}㎡〜{{ $new_detached_house_group->lowest_price}}万円（{{ $new_detached_house_group->tax }}）
            </td>
        </tr>
        <tr>
            <th>間取り</th>
            <td>
                {{ $new_detached_house_group->lowest_number_of_rooms }}{{ $new_detached_house_group->lowest_type_of_room }}〜
            </td>
        </tr>
        <tr>
            <th>方角</th>
