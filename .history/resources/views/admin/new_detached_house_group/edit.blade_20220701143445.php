                ...
                <td colspan=3>
                    <div class="form-group @if(!empty($errors->first('balcony'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('balcony_area'))) has-error @endif">
                            ...
                            <input type="radio" name="balcony" id="havebalcony" value="あり" onclick="balconyClick()" @if(old('balcony', $new_detached_house_group->balcony) === 'なし') checked @endif></label>
                            <div id="balconyAreaForm">
                                <label for="balconyArea">バルコニー面積：
                                <input type="number" name="balcony_area" id="balconyArea" value="{{ old('balcony_area', $new_detached_house_group->balcony_area) }}">m</label>
                            </div>
