    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td colspan=3>
                    <div class="form-group @if(!empty($errors->first('parkinglot'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('lowest_parking_lot'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('highest_parking_lot'))) has-error @endif">
                                ...
                                <input type="radio" name="parkinglot" id="noParkinglot" value="{{ old('parkinglot') }}" onclick="parkinglotClick()"></label>
                                ...
                                <div id="parkinglotForm">
                                    ...
                                    <span class="help-block">{{$errors->first('parkinglot')}}</span>
