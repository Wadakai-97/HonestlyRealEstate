                    ...
                    <div class="form-group @if(!empty($errors->first('lowest_price'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('highest_price'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('tax'))) has-error @endif">
                                最低販売価格：<input type="number" name="lowest_price" value="{{ old('lowest_price', $new_detached_house_group->lowest_price) }}">万円〜
                                最高販売価格：<input type="number" name="highest_price" value="{{ old('highest_price', $new_detached_house_group->highest_price) }}">万円
                                <select name="tax">
