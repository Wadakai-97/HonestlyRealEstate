                        ...
                        <div class="form-group @if(!empty($errors->first('lowest_type_of_room'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('lowest_number_of_rooms'))) has-error @endif">
                                <div class="form-group @if(!empty($errors->first('lowest_type_of_room'))) has-error @endif">
                                    ...
                                    <input type="number" name="highestnumber_of_rooms" value="{{ old('highestnumber_of_rooms', $new_detached_house_group->highestnumber_of_rooms) }}">
                                    <select name="type_of_room">
                                        <option disabled selected>未選択</option>
                                        @foreach (PropertyInformationConsts::TYPE_OF_ROOM_LIST as $key => $type_of_room)
                                        <option value="{{ $key }}" @if(old('type_of_room', $new_detached_house_group->highesttype_of_room) === $type_of_room) selected @endif>{{ $type_of_room }}</option>
                                        @endforeach
                                    </select>
