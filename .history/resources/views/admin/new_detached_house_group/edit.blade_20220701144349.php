                    ...
                    <div class="form-group @if(!empty($errors->first('balcony'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('lowest_balcony_area'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('highest_balcony_area'))) has-error @endif">
                                ...
                                <input type="radio" name="balcony" id="noBalcony" value="{{ old('balcony', $new_detached_house_group->balcony) }}" onclick="balconyClick()" @if(old('balcony', $new_detached_house->balcony) === 'あり') checked @endif></label>
                                <label for="yesbalcony">あり
                                <input type="radio" name="balcony" id="havebalcony" value="{{ old('balcony', $new_detached_house_group->balcony) }}" onclick="balconyClick()"></label>
                                <div id="balconyAreaForm">
                                    <label>最低：
                                    <input type="number" name="lowest_balcony_area" id="lowestBalconyArea" value="{{ old('lowest_balcony_area', $new_detached_house_group->lowest_balcony_area) }}"> ㎡〜</label>
                                    <label>最高：
                                    <input type="number" name="highest_balcony_area" id="highestBalconyArea" value="{{ old('highest_balcony_area', $new_detached_house_group->highest_balcony_area) }}"> ㎡</label>
                                </div>
                ...
                <td colspan=3>
                    <div class="form-group @if(!empty($errors->first('lowest_parking_lot'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('highest_parking_lot'))) has-error @endif">
                            <input type="number" name="lowest_parking_lot" value="{{ old('lowest_parking_lot', $new_detached_house_group->lowest_parking_lot) }}"> 台〜
                            <input type="number" name="highest_parking_lot" value="{{ old('highest_parking_lot', $new_detached_house_group->highest_parking_lot) }}"> 台
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('setback'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('setback_length'))) has-error @endif">
                            ...
                            <input type="radio" name="setback" id="noSetback" value="{{ old('setback', $new_detached_house_group->setback) }}" onclick="setbackClick()"></label>
                            <label for="yesSetback">あり
                            <input type="radio" name="setback" id="haveSetback" value="{{ old('setback', $new_detached_house_group->setback) }}" onclick="setbackClick()"></label>
