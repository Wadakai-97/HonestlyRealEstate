    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <th>駐車場</th>
                <td>
                    <div class="form-group @if(!empty($errors->first('lowest_balcony'))) has-error @endif">
                        <input type="number" name="lowest_balcony" value="{{ old('lowest_balcony') }}">㎡
                    <span class="help-block">{{$errors->first('lowest_balcony')}}</span>
                </td>
            </tr>
            <tr>
