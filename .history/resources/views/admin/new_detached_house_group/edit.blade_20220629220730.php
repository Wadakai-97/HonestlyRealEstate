                ...
                <td colspan=3>
                    <div class="form-group @if(!empty($errors->first('lowest_parking_lot'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('highest_parking_lot'))) has-error @endif">
                            <label for="lowest_parking_lot">最低：
                            <input type="number" name="lowest_parking_lot" id="lowest_parking_lot" value="{{ old('lowest_parking_lot', $new_detached_house_group->parking_lot) }}"> 台〜</label>
                            <label>最高：
