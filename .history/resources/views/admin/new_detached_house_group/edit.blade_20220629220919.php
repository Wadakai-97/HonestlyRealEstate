                            ...
                            <div class="form-group @if(!empty($errors->first('highest_number_of_rooms'))) has-error @endif">
                                <div class="form-group @if(!empty($errors->first('highest_type_of_room'))) has-error @endif">
                                    ...
                                    <select name="type_of_room">
                                        ...
                                        <option value="{{ $key }}" @if(old('type_of_room', $new_detached_house_group->lowest_type_of_room) === $type_of_room) selected @endif>{{ $type_of_room }}</option>
                                        @endforeach
                                    </select> 〜
                                    ...
                                    <select name="type_of_room">
                                        <option disabled selected>未選択</option>
                                        @foreach (PropertyInformationConsts::TYPE_OF_ROOM_LIST as $key => $type_of_room)
                                        <option value="{{ $key }}" @if(old('type_of_room', $new_detached_house_group->highest_type_of_room) === $type_of_room) selected @endif>{{ $type_of_room }}</option>
                                        @endforeach
                                    </select>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('status'))) has-error @endif">
                        <select name="status">
                            ...
                            <option value="{{ $key }}" @if(old('status', $new_detached_house_group) === $status) selected @endif>{{ $status }}</option>
                            @endforeach
                        </select>
