...
<table>
    <tbody>
        ...
        <tr>
            <th>間取り</th>
            <td>
                {{ $new_detached_house_group->lowest_number_of_rooms }}{{ $new_detached_house_group->lowest_type_of_room }}〜{{ $new_detached_house_group->highest_number_of_rooms }}{{ $new_detached_house_group->lowest_type_of_room }}
            </td>
        </tr>
        <tr>
            <th>方角</th>
