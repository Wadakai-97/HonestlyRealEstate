    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td colspan=3>
                    <div class="form-group @if(!empty($errors->first('lowest_buil'))) has-error @endif">
                        <input type="number" name="lowest_buil" value="{{ old('lowest_buil') }}">％
                    <span class="help-block">{{$errors->first('lowest_buil')}}</span>
                </td>
            </tr>
            <tr>
                <th>バルコニー面積</th>
