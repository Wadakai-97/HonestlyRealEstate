    ...
    <table>
        ...
        <tbody>
                    ...
                    <div class="form-group @if(!empty($errors->first('lowest_price'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('highest_price'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('tax'))) has-error @endif">
                                <label>最低価格：
                                <input type="number" step="0.1" name="lowest_price" value="{{ old('lowest_price') }}"> 万円 〜</label>
                                <label>最高価格：
                                <input type="number" step="0.1" name="highest_price" value="{{ old('highest_price') }}"> 万円</label>
                                <select name="tax">
            ...
            <tr>
                ...
                <td colspan=3>
                    <div class="form-group @if(!empty($errors->first('pref'))) has-error @endif">
                        <input type="text" maxlength="4" id="都道府県" name="pref" placeholder="〇〇県" value="{{ old('pref') }}">
            ...
            <tr>
                ...
                <td colspan=3>
                    <div class="form-group @if(!empty($errors->first('municipalities'))) has-error @endif">
                        <input type="text" maxlength="70" id="住所" name="municipalities" placeholder="〇〇市〇〇区〇〇町" value="{{ old('municipalities') }}">
            ...
            <tr>
                <th>住所３（丁目番地）</th>
                <td colspan=3>
                    <input type="text" maxlength="30" name="block" placeholder="〇〇-〇" value="{{ old('block') }}">
                </td>
            </tr>
            <tr>
                ...
                <td colspan=3>
                    <div class="form-group @if(!empty($errors->first('lowest_land_area'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('highest_land_area'))) has-error @endif">
                            <label>最低面積：
                            <input type="number" step="0.01" min="0.01" max="99999.99" name="lowest_land_area" value="{{ old('lowest_land_area') }}"> ㎡〜</label>
                            <label>最高面積：
                            <input type="number" step="0.01" min="0.01" max="99999.99" name="highest_land_area" value="{{ old('highest_land_area') }}"> ㎡</label>
                ...
                <td colspan=3>
                    <div class="form-group @if(!empty($errors->first('lowest_building_area'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('highest_building_area'))) has-error @endif">
                            <label>最低面積：
                            <input type="number" step="0.01" min="0.01" max="99999.99" name="lowest_building_area" value="{{ old('lowest_building_area') }}"> ㎡〜</label>
                            <label>最高面積：
                            <input type="number" step="0.01" min="0.01" max="99999.99" name="highest_building_area" value="{{ old('lowest_building_area') }}"> ㎡</label>
                ...
                <td colspan=3>
                    <div class="form-group @if(!empty($errors->first('lowest_floor_area_ratio'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('highest_floor_area_ratio'))) has-error @endif">
                            <label>最低：
                            <input type="number" min="50" max="1300" name="lowest_floor_area_ratio" value="{{ old('lowest_floor_area_ratio') }}"> ％〜</label>
                            <label>最高：
                            <input type="number" min="50" max="1300" name="highest_floor_area_ratio" value="{{ old('highest_floor_area_ratio') }}"> ％</label>
            ...
            <tr>
                ...
                <td colspan=3>
                    ...
                    <div class="form-group @if(!empty($errors->first('highest_building_coverage_ratio'))) has-error @endif">
                        <label>最低：
                        <input type="number" min="30" max="80" name="lowest_building_coverage_ratio" value="{{ old('lowest_building_coverage_ratio') }}"> ％〜</label>
                        <label>最高：
                        <input type="number" min="30" max="80" name="highest_building_coverage_ratio" value="{{ old('highest_building_coverage_ratio') }}"> ％</label>
                    ...
                    <div class="form-group @if(!empty($errors->first('balcony'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('lowest_balcony_area'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('highest_balcony_area'))) has-error @endif">
                                <input type="radio" name="balcony" id="noBalcony" value="{{ old('balcony', 'なし') }}" onclick="balconySignUp()"><label for="noBalcony">なし</label>
                                <input type="radio" name="balcony" id="haveBalcony" value="{{ old('balcony', 'あり') }}" onclick="balconySignUp()"><label for="haveBalcony">あり</label>
                                <div id="balconyAreaForm">
                                    <label>最低：<input type="number" step="0.01" min="0.01" max="999.99" name="lowest_balcony_area" id="balconyArea" value="{{ old('lowest_balcony_area') }}"> ㎡〜</label>
                                    <label>最高：<input type="number" step="0.01" min="0.01" max="999.99" name="highest_balcony_area" id="balconyArea" value="{{ old('highest_balcony_area') }}"> ㎡</label>
                                </div>
                    ...
                    <div class="form-group @if(!empty($errors->first('parking'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('lowest_parking_lot'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('highest_parking_lot'))) has-error @endif">
                                <input type="radio" name="parking" id="noParking" value="{{ old('parking') }}" onclick="parkingSignUp()"><label for="noParking">なし</label>
                                <input type="radio" name="parking" id="haveParking" value="{{ old('parking') }}" onclick="parkingSignUp()"><label for="haveParking">あり</label>
                                <div id="parkingLotForm">
                                    <label>最低：<input type="number" step="1" min="1" max="10" name="lowest_parking_lot" id="parkingLot" value="{{ old('lowest_parking_lot') }}"> 台〜</label>
                                    <label>最高：<input type="number" step="1" min="1" max="10" name="highest_parking_lot" id="parkingLot" value="{{ old('highest_parking_lot') }}"> 台</label>
                                </div>
                ...
                <td colspan=3>
                    <div class="form-group @if(!empty($errors->first('lowest_number_of_rooms'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('lowest_type_of_room'))) has-error @endif">
                            <label>最低：
                            <input type="number" name="lowest_number_of_rooms" value="{{ old('lowest_number_of_rooms') }}">
                            <select name="lowest_type_of_room">
                                <option disabled selected>未選択</option>
                                @foreach (PropertyInformationConsts::TYPE_OF_ROOM_LIST as $key => $type_of_room)
                                <option value="{{ $key }}" @if(old('lowest_type_of_room') === $type_of_room) selected @endif>{{ $type_of_room }}</option>
                                @endforeach
                            </select> 〜 </label>
                            <label>最高：
                            <input type="number" name="highest_number_of_rooms" value="{{ old('highest_number_of_rooms') }}">
                            <select name="highest_type_of_room">
                                <option disabled selected>未選択</option>
                                @foreach (PropertyInformationConsts::TYPE_OF_ROOM_LIST as $key => $type_of_room)
                                <option value="{{ $key }}" @if(old('highest_type_of_room') === $type_of_room) selected @endif>{{ $type_of_room }}</option>
                                @endforeach
                            </select></label>
                    ...
                    <div class="form-group @if(!empty($errors->first('year'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('month'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('day'))) has-error @endif">
                                <input type="number" name="year" id="year" value="{{ old('year') }}" min="1900" max="2100" step="1"> 年
                                <input type="number" name="month" id="month" value="{{ old('month') }}" min="1" max="12"> 月
                        ...
                        <div class="form-group @if(!empty($errors->first('adjacent_road'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('lowest_adjacent_road_width'))) has-error @endif">
                                ...
                                <select name="adjacent_road_direction">
                                    ...
                                    <option value="{{ $key }}" @if(old('adjacent_road_direction') === $adjacent_road_direction) selected @endif>{{ $adjacent_road_direction }}</option>
                                    @endforeach
                                </select>
                                ...
                                <input type="text" name="lowest_adjacent_road_width" value="{{ old('lowest_adjacent_road_width') }}" placeholder="最小接道幅"> ｍ〜
                    ...
                    <div class="form-group @if(!empty($errors->first('setback'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('lowest_setback_length'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('highest_setback_length'))) has-error @endif">
                                <input type="radio" name="setback" id="noSetback" value="{{ old('setback', 'なし') }}" onclick="multiSetbackSignUp()"><label for="noSetback">なし</label>
                                <input type="radio" name="setback" id="haveSetback" value="{{ old('setback', 'あり') }}" onclick="multiSetbackSignUp()"><label for="haveSetback">あり</label>
                                <div id="setbackLengthForm">
                                    <label for="lowestSetbackLength">最小：<input type="number" step="0.01" min="0.01" max="4.00" name="lowest_setback_length" id="lowestSetbackLength" value="{{ old('lowest_setback_length') }}"> m〜</label>
                                    <label for="highestSetbackLength">最大：<input type="number" step="0.01" min="0.01" max="4.00" name="highest_setback_length" id="highestSetbackLength" value="{{ old('highest_setback_length') }}"> m</label>
                                </div>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="form-group @if(!empty($errors->first('distance_station'))) has-error @endif">
                        <input type="number" step="1" min="1" max="60" name="distance_station" value="{{ old('distance_station') }}"> 分
            ...
            <tr>
                <th>小学校</th>
                <td colspan=3>
                    <input type="text" placeholder="〇〇小学校" name="elementary_school_name" value="{{ old('elementary_school_name') }}"> まで徒歩 </th><input type="number" step="1" min="1" max="60" name="elementary_school_district" value="{{ old('elementary_school_district') }}"> 分
                </td>
            </tr>
            <tr>
                <th>中学校</th>
                <td colspan=3>
                    <input type="text" placeholder="〇〇中学校" name="junior_high_school_name" value="{{ old('junior_high_school_name') }}"> まで徒歩 </th><input type="number" step="1" min="1" max="60" name="junior_high_school_district" value="{{ old('junior_high_school_district') }}"> 分
                </td>
            </tr>
        </tbody>
    </table><br>
