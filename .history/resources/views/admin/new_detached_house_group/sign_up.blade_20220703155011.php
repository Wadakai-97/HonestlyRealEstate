                    ...
                    <div class="form-group @if(!empty($errors->first('balcony'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('lowest_balcony_area'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('highest_balcony_area'))) has-error @endif">
                                ...
                                <input type="radio" name="balcony" id="noBalcony" value="{{ old('balcony') }}" onclick="balconyHide()" checked></label>
                                <label for="yesbalcony">あり
                                <input type="radio" name="balcony" id="haveBalcony" value="{{ old('balcony') }}" onclick="balconyShow()"></label>
                                @if (isset($_POST['haveBalcony']))
                                    <div id="balconyAreaForm">
                                        <label>最低：
                                        <input type="number" name="lowest_balcony_area" id="lowestBalconyArea" value="{{ old('lowest_balcony_area') }}"> ㎡〜</label>
                                        <label>最高：
