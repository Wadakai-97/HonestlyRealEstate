                    ...
                    <div class="form-group @if(!empty($errors->first('balcony'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('lowest_balcony_area'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('highest_balcony_area'))) has-error @endif">
                                <input type="radio" name="balcony" id="noBalcony" value="なし" onclick="balconyClick()" @if(old('balcony', $new_detached_house_group->balcony) === 'なし') checked @endif><label for="noBalcony">なし</label>
                                <input type="radio" name="balcony" id="haveBalcony" value="あり" onclick="balconyClick()" @if(old('balcony', $new_detached_house_group->balcony) === 'あり') checked @endif><label for="haveBalcony">あり</label>
                    ...
                    <div class="form-group @if(!empty($errors->first('parking'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('lowest_parking_lot'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('highest_parking_lot'))) has-error @endif">
                                <input type="radio" name="parking" id="noParking" value="なし" onclick="parkingClick()" @if(old('parking', $new_detached_house_group->parking) === 'なし') checked @endif><label for="noParking">なし</label>
                                <input type="radio" name="parking" id="haveParking" value="あり" onclick="parkingClick()" @if(old('parking', $new_detached_house_group->parking) === 'あり') checked @endif><label for="haveParking">あり</label>
                    ...
                    <div class="form-group @if(!empty($errors->first('setback'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('lowest_setback_length'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('highest_setback_length'))) has-error @endif">
                                <input type="radio" name="setback" id="noSetback" value="なし" onclick="multiSetbackClick()" @if(old('setback', $new_detached_house_group->setback) === 'なし') checked @endif><label for="noSetback">なし</label>
                                <input type="radio" name="setback" id="haveSetback" value="あり" onclick="multiSetbackClick()" @if(old('setback', $new_detached_house_group->setback) === 'あり') checked @endif><label for="haveSetback">あり</label>
