                        ...
                        <div class="form-group @if(!empty($errors->first('lowest_balcony_area'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('highest_balcony_area'))) has-error @endif">
                                ...
                                <div id="balconyAreaForm">
                                    <label>最低：
                                    <input type="number" name="lowest_balcony_area" id="balconyArea" value="{{ old('lowest_balcony_area', $new_detached_house_group->lowest_balcony_area) }}"> ㎡〜</label>
                                    <label>最高：
                                    <input type="number" name="highest_balcony_area" id="balconyArea" value="{{ old('highest_balcony_area', $new_detached_house_group->highest_balcony_area) }}"> ㎡</label>
                                </div>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('setback'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('setback_length'))) has-error @endif">
                            ...
                            <input type="radio" name="setback" id="noSetback" value="なし" onclick="setbackClick()" @if(old('balcony', $new_detached_house_group->setback) === 'なし') checked @endif></label>
                            <label for="yesSetback">あり
                            <input type="radio" name="setback" id="haveSetback" value="あり" onclick="setbackClick()" @if(old('balcony', $new_detached_house_group->setback) === 'あり') checked @endif></label>
