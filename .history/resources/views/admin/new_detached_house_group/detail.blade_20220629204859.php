...
<table>
    <tbody>
        ...
        <tr>
            ...
            <th>販売価格</th>
            <td>
                {{ $new_detached_house_group->lowest_price}}万円（{{ $new_detached_house_group->tax }}）〜{{ $new_detached_house_group->lowest_price}}万円（{{ $new_detached_house_group->tax }}）
            </td>
        </tr>
        <tr>
            <th>住所</th>
        ...
        <tr>
            <th>土地面積</th>
            <td>
                {{ $new_detached_house_group->lowest_land_area }}㎡〜{{ $new_detached_house_group->lowest_land_area }}㎡
            </td>
            <th>建物面積</th>
            <td>
                {{ $new_detached_house_group->lowest_building_area }}㎡〜{{ $new_detached_house_group->lowest_building_area }}㎡
            </td>
        </tr>
        <tr>
            <th>間取り</th>
            <td>
                {{ $new_detached_house_group->lowest_number_of_rooms }}{{ $new_detached_house_group->lowest_type_of_room }}〜{{ $new_detached_house_group->lowest_number_of_rooms }}{{ $new_detached_house_group->lowest_type_of_room }}
            </td>
        </tr>
        <tr>
            <th>方角</th>
            <td>
                {{ $new_detached_house_group->direction }}
            </td>
            <th>バルコニー面積</th>
            <td>
                {{ $new_detached_house_group->lowest_balcony_area }}㎡~{{ $new_detached_house_group->lowest_balcony_area }}㎡
            </td>
        </tr>
        <tr>
            <th>完成時期（築年月）</th>
        ...
        <tr>
            ...
            <th>駐車場</th>
            <td>
                {{ $new_detached_house_group->lowest_parking_lot }}~{{ $new_detached_house_group->lowest_parking_lot }}
            </td>
        </tr>
        <tr>
            <th>用途地域</th>
