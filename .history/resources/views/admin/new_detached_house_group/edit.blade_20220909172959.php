                        ...
                        <div class="form-group @if(!empty($errors->first('lowest_balcony_area'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('highest_balcony_area'))) has-error @endif">
                                ...
                                <div id="balconyAreaForm">
                                    <label>最低：<input type="number" step="0.01" min="0.01" max="99999.99" name="lowest_balcony_area" id="balconyArea" value="{{ old('lowest_balcony_area', $new_detached_house_group->lowest_balcony_area) }}"> ㎡〜</label>
                                    <label>最高：<input type="number" step="0.01" min="0.01" max="99999.99" name="highest_balcony_area" id="balconyArea" value="{{ old('highest_balcony_area', $new_detached_house_group->highest_balcony_area) }}"> ㎡</label>
                                </div>
