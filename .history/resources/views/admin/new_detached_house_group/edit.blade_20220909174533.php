    ...
    <table>
        ...
        <tbody>
                    ...
                    <div class="form-group @if(!empty($errors->first('lowest_price'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('highest_price'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('tax'))) has-error @endif">
                                <input type="number" step="0.1" min="0.1" max="99999.9" name="lowest_price" value="{{ old('lowest_price', $new_detached_house_group->lowest_price) }}"> 万円 〜
                                <input type="number" step="0.1" min="0.1" max="99999.9" name="highest_price" value="{{ old('highest_price', $new_detached_house_group->highest_price) }}"> 万円
                                <select name="tax">
            ...
            <tr>
                ...
                <td colspan=3>
                    <div class="form-group @if(!empty($errors->first('pref'))) has-error @endif">
                        <input type="text" maxlength="4" id="都道府県" name="pref" placeholder="〇〇県" value="{{ old('pref', $new_detached_house_group->pref) }}">
            ...
            <tr>
                ...
                <td colspan=3>
                    <div class="form-group @if(!empty($errors->first('municipalities'))) has-error @endif">
                        <input type="text" maxlength="70" id="住所" name="municipalities" placeholder="〇〇市〇〇区〇〇町" value="{{ old('municipalities', $new_detached_house_group->municipalities) }}">
            ...
            <tr>
                <th>住所３（丁目番地）</th>
                <td colspan=3>
                    <input type="text" maxlength="30" name="block" placeholder="〇〇-〇" value="{{ old('block', $new_detached_house_group->block) }}">
                </td>
            </tr>
            <tr>
                ...
                <td colspan=3>
                    <div class="form-group @if(!empty($errors->first('lowest_land_area'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('highest_land_area'))) has-error @endif">
                            <input type="number" step="0.01" min="0.01" max="99999.99" name="lowest_land_area" value="{{ old('lowest_land_area', $new_detached_house_group->lowest_land_area) }}"> ㎡〜
                            <input type="number" step="0.01" min="0.01" max="99999.99" name="lowest_land_area" value="{{ old('highest_land_area', $new_detached_house_group->highest_land_area) }}"> ㎡
                ...
                <td colspan=3>
                    <div class="form-group @if(!empty($errors->first('lowest_floor_area_ratio'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('highest_floor_area_ratio'))) has-error @endif">
                            <input type="number" min="50" max="1300" name="lowest_floor_area_ratio" value="{{ old('lowest_floor_area_ratio', $new_detached_house_group->lowest_floor_area_ratio) }}"> ％ 〜
                            <input type="number" min="50" max="1300" name="highest_floor_area_ratio" value="{{ old('highest_floor_area_ratio', $new_detached_house_group->highest_floor_area_ratio) }}"> ％
                ...
                <td  colspan=3>
                    <div class="form-group @if(!empty($errors->first('lowest_building_coverage_ratio'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('highest_building_coverage_ratio'))) has-error @endif">
                            <input type="number" min="30" max="80" name="lowest_building_coverage_ratio" value="{{ old('lowest_building_coverage_ratio', $new_detached_house_group->lowest_building_coverage_ratio) }}"> ％ 〜
                            <input type="number" min="30" max="80" name="highest_building_coverage_ratio" value="{{ old('highest_building_coverage_ratio', $new_detached_house_group->highest_building_coverage_ratio) }}"> ％
                    ...
                    <div class="form-group @if(!empty($errors->first('balcony'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('lowest_balcony_area'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('highest_balcony_area'))) has-error @endif">
                                <input type="radio" name="balcony" id="noBalcony" value="なし" onclick="balconyEdit()" @if(old('balcony', $new_detached_house_group->balcony) === 'なし') checked @endif><label for="noBalcony">なし</label>
                                <input type="radio" name="balcony" id="haveBalcony" value="あり" onclick="balconyEdit()" @if(old('balcony', $new_detached_house_group->balcony) === 'あり') checked @endif><label for="haveBalcony">あり</label>
                                <div id="balconyAreaForm">
                                    <label>最低：<input type="number" step="0.01" min="0.01" max="999.99" name="lowest_balcony_area" id="balconyArea" value="{{ old('lowest_balcony_area', $new_detached_house_group->lowest_balcony_area) }}"> ㎡〜</label>
                                    <label>最高：<input type="number" step="0.01" min="0.01" max="999.99" name="highest_balcony_area" id="balconyArea" value="{{ old('highest_balcony_area', $new_detached_house_group->highest_balcony_area) }}"> ㎡</label>
                                </div>
                    ...
                    <div class="form-group @if(!empty($errors->first('parking'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('lowest_parking_lot'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('highest_parking_lot'))) has-error @endif">
                                <input type="radio" name="parking" id="noParking" value="なし" onclick="parkingEdit()" @if(old('parking', $new_detached_house_group->parking) === 'なし') checked @endif><label for="noParking">なし</label>
                                <input type="radio" name="parking" id="haveParking" value="あり" onclick="parkingEdit()" @if(old('parking', $new_detached_house_group->parking) === 'あり') checked @endif><label for="haveParking">あり</label>
                                <div id="parkingLotForm">
                                    <label>最低：<input type="number" step="1" min="1" max="10" name="lowest_parking_lot" id="parkingLot" value="{{ old('lowest_parking_lot', $new_detached_house_group->lowest_parking_lot ) }}"> 台〜</label>
                                    <label>最高：<input type="number" step="1" min="1" max="10" name="highest_parking_lot" id="parkingLot" value="{{ old('highest_parking_lot', $new_detached_house_group->highest_parking_lot ) }}"> 台</label>
                    ...
                    <div class="form-group @if(!empty($errors->first('year'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('month'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('day'))) has-error @endif">
                                <input type="number" name="year" id="year" value="{{ old('year', $new_detached_house_group->year) }}" min="1900" max="2100" step="1"> 年
                    ...
                    <div class="form-group @if(!empty($errors->first('adjacent_road_direction'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('adjacent_road'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('lowest_adjacent_road_width'))) has-error @endif">
                                ...
                                <input type="text" name="lowest_adjacent_road_width" value="{{ old('lowest_adjacent_road_width', $new_detached_house_group->lowest_adjacent_road_width) }}" placeholder="最小接道幅"> ｍ〜
                                <input type="text" name="highest_adjacent_road_width" value="{{ old('highest_adjacent_road_width', $new_detached_house_group->highest_adjacent_road_width) }}" placeholder="最大接道幅"> ｍ
                    ...
                    <div class="form-group @if(!empty($errors->first('setback'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('lowest_setback_length'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('highest_setback_length'))) has-error @endif">
                                <input type="radio" name="setback" id="noSetback" value="なし" onclick="multiSetbackEdit()" @if(old('setback', $new_detached_house_group->setback) === 'なし') checked @endif><label for="noSetback">なし</label>
                                <input type="radio" name="setback" id="haveSetback" value="あり" onclick="multiSetbackEdit()" @if(old('setback', $new_detached_house_group->setback) === 'あり') checked @endif><label for="haveSetback">あり</label>
                                <div id="setbackLengthForm">
                                    <label for="lowestSetbackLength">最小：<input type="number" step="0.01" min="0.01" max="4.00" name="lowest_setback_length" id="lowestSetbackLength" value="{{ old('lowest_setback_length', $new_detached_house_group->lowest_setback_length) }}"> m〜</label>
                                    <label for="highestSetbackLength">最大：<input type="number" step="0.01" min="0.01" max="4.00" name="highest_setback_length" id="highestSetbackLength" value="{{ old('highest_setback_length', $new_detached_house_group->highest_setback_length) }}"> m</label>
                                </div>
            ...
            <tr>
                ...
                <td>
                    ...
                    <div>
                        ...
                        <select name="station" id="station">
                            <option value="{{ old('station', $new_detached_house_group->station) }}" @if(old('station', $new_detached_house_group->station) === $new_detached_house_group->station) selected @endif>{{ $new_detached_house_group->station }}</option>
                        </select>
                    </div>
                </td>
                ...
                <td>
                    ...
                    <div class="form-group @if(!empty($errors->first('distance_station'))) has-error @endif">
                        <input type="number" step="1" min="1" max="60" name="distance_station" value="{{ old('distance_station', $new_detached_house_group->distance_station) }}"> 分
            ...
            <tr>
                <th>小学校</th>
                <td colspan=3>
                    <input type="text" placeholder="〇〇小学校" name="elementary_school_name" value="{{ old('elementary_school_name', $new_detached_house_group->elementary_school_name) }}"> まで徒歩 <input type="number" step="1" min="1" max="60" name="elementary_school_district" value="{{ old('elementary_school_district', $new_detached_house_group->elementary_school_district) }}"> 分
                </td>
            </tr>
            <tr>
                <th>中学校</th>
                <td colspan=3>
                    <input type="text" placeholder="〇〇中学校" name="junior_high_school_name" value="{{ old('junior_high_school_name', $new_detached_house_group->junior_high_school_name) }}"> まで徒歩 <input type="number" step="1" min="1" max="60" name="junior_high_school_district" value="{{ old('junior_high_school_district', $new_detached_house_group->junior_high_school_district) }}"> 分
                </td>
            </tr>
        </tbody>
    </table><br>
