    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('lowest'))) has-error @endif">
                        <input type="number" name="lowest" value="{{ old('lowest', $new_detached_house_group->lowest) }}">㎡
                    <span class="help-block">{{$errors->first('lowest')}}</span>
                </td>
