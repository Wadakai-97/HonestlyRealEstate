    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                <th>駐車場</th>
                <td>
                    <div class="form-group @if(!empty($errors->first('lowest_'))) has-error @endif">
                        <input type="number" name="lowest_" value="{{ old('lowest_') }}">㎡
                    <span class="help-block">{{$errors->first('lowest_')}}</span>
                </td>
            </tr>
            <tr>
