            ...
            <tr>
                ...
                <td colspan=3>
                    ...
                    <div class="form-group @if(!empty($errors->first('highest_building_coverage_ratio'))) has-error @endif">
                        <label></label>
                        <input type="number" name="lowest_building_coverage_ratio" value="{{ old('lowest_building_coverage_ratio') }}">％
                        <input type="number" name="highest_building_coverage_ratio" value="{{ old('highest_building_coverage_ratio') }}">％
