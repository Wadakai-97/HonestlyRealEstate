            ...
            <tr>
                ...
                <td>
                    ...
                    <div class="form-group @if(!empty($errors->first('highest_floor_area_ratio'))) has-error @endif">
                        <input type="number" name="lowest_floor_area_ratio" value="{{ old('lowest_floor_area_ratio') }}">％
                        <input type="number" name="highest_floor_area_ratio" value="{{ old('highest_floor_area_ratio') }}">％
                    <span class="help-block">{{$errors->first('lowest_floor_area_ratio')}}</span>
                    <span class="help-block">{{$errors->first('higest_floor_area_ratio')}}</span>
                </td>
