                        ...
                        <div class="form-group @if(!empty($errors->first('lowest_parking_lot'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('highest_parking_lot'))) has-error @endif">
                                ...
                                <div id="parkingLotForm">
                                    <label>最低：<input type="number" name="lowest_parking_lot" id="parkingLot" value="{{ old('lowest_parking_lot') }}"> 台〜</label>
                                    <label>最高：<input type="number" name="highest_parking_lot" id="parkingLot" value="{{ old('highest_parking_lot') }}"> 台</label>
                                </div>
