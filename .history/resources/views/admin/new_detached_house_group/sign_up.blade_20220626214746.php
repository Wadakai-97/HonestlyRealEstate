    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('lowest_floor_area'))) has-error @endif">
                        <input type="number" name="lowest_floor_area" value="{{ old('lowest_floor_area') }}">％
                    <span class="help-block">{{$errors->first('lowest_floor_area')}}</span>
                </td>
