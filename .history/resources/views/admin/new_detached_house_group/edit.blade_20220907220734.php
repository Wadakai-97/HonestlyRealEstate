                    ...
                    <div class="form-group @if(!empty($errors->first('parking'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('lowest_parking_lot'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('highest_parking_lot'))) has-error @endif">
                                ...
                                <input type="radio" name="parkinglot" id="noParkinglot" value="なし" onclick="parkinglotClick()" @if(old('parking', $new_detached_house_group->parking) === 'なし') checked @endif></label>
                                <label for="yesParkinglot">あり
                                <input type="radio" name="parkinglot" id="haveParkinglot" value="あり" onclick="parkinglotClick()" @if(old('parking', $new_detached_house_group->parking) === 'あり') checked @endif></label>
