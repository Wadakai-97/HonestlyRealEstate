                        ...
                        <div class="form-group @if(!empty($errors->first('lowest_setback_length'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('highest_setback_length'))) has-error @endif">
                                ...
                                <div id="setbackLengthForm">
                                    <label for="lowestSetbackLength">最小：<input type="number" step="0.01"name="lowest_setback_length" id="lowestSetbackLength" value="{{ old('lowest_setback_length', $new_detached_house_group->lowest_setback_length) }}"> m〜</label>
