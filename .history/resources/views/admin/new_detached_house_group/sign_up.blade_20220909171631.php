                ...
                <td colspan=3>
                    <div class="form-group @if(!empty($errors->first('lowest_floor_area_ratio'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('highest_floor_area_ratio'))) has-error @endif">
                            <label>最低：
                            <input type="number" min="30" max="80" name="lowest_floor_area_ratio" value="{{ old('lowest_floor_area_ratio') }}"> ％〜</label>
                            <label>最高：
                            <input type="number" min="30" max="80" name="highest_floor_area_ratio" value="{{ old('highest_floor_area_ratio') }}"> ％</label>
