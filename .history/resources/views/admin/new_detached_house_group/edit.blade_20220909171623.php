                ...
                <td colspan=3>
                    <div class="form-group @if(!empty($errors->first('lowest_floor_area_ratio'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('highest_floor_area_ratio'))) has-error @endif">
                            <input type="number" min="30" max="80" name="lowest_floor_area_ratio" value="{{ old('lowest_floor_area_ratio', $new_detached_house_group->lowest_floor_area_ratio) }}"> ％ 〜
                            <input type="number" min="30" max="80" name="highest_floor_area_ratio" value="{{ old('highest_floor_area_ratio', $new_detached_house_group->highest_floor_area_ratio) }}"> ％
