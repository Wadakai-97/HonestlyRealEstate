...
<ul class="menu">
    ...
    <ul class="top_property_management_menu">
        ...
        <ul>
            ...
            <li class="top_list"><a href="{{ route('admin.newDetachedHouseGroup.groupForm') }}">新築分譲住宅</a></li>
        ...
        <ul>
            ...
            <li class="top_list"><a href="{{ route('admin.newDetachedHouseGroup.groupList') }}">新築分譲住宅</a></li>
