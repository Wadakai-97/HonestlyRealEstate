...
<div class ="top_menu">
    <ul class="menu">
        ...
        <ul class="top_property_management_menu">
            ...
            <ul>
                ...
                <li class="top_list"><a href="{{ route('admin.newDetachedHouseGroup.form') }}">新築分譲住宅</a></li>
            ...
            <ul>
                <li class="top_list"><a href="{{ route('admin.recommend.list') }}">おすすめ物件</a></li>
                <li class="top_list"><a href="{{ route('admin.newDetachedHouse.list') }}">新築戸建</a></li>
                <li class="top_list"><a href="{{ route('admin.newDetachedHouseGroup.list') }}">新築分譲住宅</a></li>
    ...
    <ul class="menu">
        <li class="top_customer">顧客管理</li>
        <ul>
            <li class="top_list"><a href="{{ route('admin.customer.form') }}">新規登録</a></li>
            <li class="top_list"><a href="{{ route('admin.customer.list') }}">一覧表示</a></li>
        </ul>
    </ul>
    <ul class="menu">
