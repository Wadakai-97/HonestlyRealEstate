...
<form method="post" action="{{ route('admin.newDetachedHouseGroup.groupSave', ['id' => $new_detached_house_group->id]) }}" enctype="multipart/form-data">
    @method('patch')
    @csrf
    <table>
        <thead>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('price'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('tax'))) has-error @endif">
                            <input type="number" name="price" value="{{ old('price', $new_detached_house_group->price) }}">万円
                            <select name="tax">
            ...
            <tr>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('land_area'))) has-error @endif">
                        <input type="number" name="land_area" value="{{ old('land_area', $new_detached_house_group->land_area) }}">㎡
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('building_area'))) has-error @endif">
                        <input type="number" name="building_area" value="{{ old('building_area', $new_detached_house_group->building_area) }}">㎡
                    ...
                    <div class="form-group @if(!empty($errors->first('number_of_rooms'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('type_of_room'))) has-error @endif">
                            ...
                            <select name="type_of_room">
                                <option disabled selected>未選択</option>
                                <option value="K" @if(old('type_of_room', $new_detached_house_group->type_of_room) === 'K') selected @endif>K</option>
                                <option value="DK" @if(old('type_of_room', $new_detached_house_group->type_of_room) === 'DK') selected @endif>DK</option>
                                <option value="LDK" @if(old('type_of_room', $new_detached_house_group->type_of_room) === 'LDK') selected @endif>LDK</option>
                            </select>
            ...
            <tr>
                ...
                <td>
                    <select name="parking_lot">
                        <option disabled selected>未選択</option>
                        <option value="なし" @if(old('parking_lot', $new_detached_house_group->parking_lot) === 'なし') selected @endif>なし</option>
                        <option value="１台" @if(old('parking_lot', $new_detached_house_group->parking_lot) === '１台') selected @endif>１台</option>
                        <option value="２台" @if(old('parking_lot', $new_detached_house_group->parking_lot) === '２台') selected @endif>２台</option>
                        <option value="３台" @if(old('parking_lot', $new_detached_house_group->parking_lot) === '３台') selected @endif>３台</option>
                        <option value="４台" @if(old('parking_lot', $new_detached_house_group->parking_lot) === '４台') selected @endif>４台</option>
                    </select>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('status'))) has-error @endif">
                        <select name="status">
                            <option disabled selected>未選択</option>
                            <option value="更地" @if(old('status', $new_detached_house_group->status) === '更地') selected @endif>更地</option>
                            <option value="建築中" @if(old('status', $new_detached_house_group->status) === '建築中') selected @endif>建築中</option>
                            <option value="完成済み" @if(old('status', $new_detached_house_group->status) === '完成済み') selected @endif>完成済み</option>
                        </select>
