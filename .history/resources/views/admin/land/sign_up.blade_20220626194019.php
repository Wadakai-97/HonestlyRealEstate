            ...
            <tr>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('setback'))) has-error @endif">
                        <input type="radio" name="setback" id="setback" value="{{ old('setback') }}"><label for="setbacck1">指定なし</label>
                        <input type="radio" name="setback" id="setback" value="{{ old('setback') }}">あり
