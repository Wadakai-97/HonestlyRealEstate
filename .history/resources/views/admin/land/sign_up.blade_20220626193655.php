            ...
            <tr>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('setback'))) has-error @endif">
                        <input type="checkbox" name="setback" id="setback" value="{{ old('setback') }}">なし
                        <input type="checkbox" name="setback" id="setback" value="{{ old('setback') }}">あり
                        <input type="number" name="setback_length" value0="{{ old('setback_length') }}"><main></main>
