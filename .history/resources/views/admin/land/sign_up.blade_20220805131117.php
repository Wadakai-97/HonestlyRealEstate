                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('setback'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('setback_length'))) has-error @endif">
                            <label for="noSetback">
                            <input type="radio" name="setback" id="noSetback" value="{{ old('setback') }}" onclick="setbackClick()">なし</label>
                            <label for="yesSetback">
                            <input type="radio" name="setback" id="haveSetback" value="{{ old('setback') }}" onclick="setbackClick()">あり</label>
            ...
            <tr class="property_images">
                @for($i = 1; $i < 21; $i++)
                    <td class="property_images_block">
                        ...
                        <img src="{{ asset('/storage/property_images/land/no_image.jpeg') }}" id="noImage{{ $i }}" class="no_image" alt="プレビュー画像{{ $i }}">
                        <div id="{{ $i }}"></div>
