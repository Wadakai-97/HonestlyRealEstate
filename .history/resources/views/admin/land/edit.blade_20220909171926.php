            ...
            <tr>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('building_coverage_ratio'))) has-error @endif">
                        <input type="number" min="50" max="1300" name="building_coverage_ratio" value="{{ old('building_coverage_ratio', $land->building_coverage_ratio) }}"> ％
                    ...
                    <div class="form-group @if(!empty($errors->first('setback'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('setback_length'))) has-error @endif">
                            ...
                            <div id="setbackLengthForm">
                                <label for="setbackLength">セットバック幅：<input type="number" step="0.01" name="setback_length" id="setbackLength" value="{{ old('setback_length', $land->setback_length) }}"> m</label>
                            </div>
