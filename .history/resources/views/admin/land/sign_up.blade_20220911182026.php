    ...
    <table>
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('name'))) has-error @endif">
                        <input type="text" outfocus name="name" value="{{ old('name') }}">
            ...
            <tr>
                ...
                <th><label class="required">引渡し日</label></th>
                <td>
                    ...
                    <div class="form-group @if(!empty($errors->first('adjacent_road_direction'))) has-error @endif">
                        <div class="form-group @if(!empty($errors->first('adjacent_road'))) has-error @endif">
                            <div class="form-group @if(!empty($errors->first('adjacent_road_width'))) has-error @endif">
                                ...
                                <input type="number" step="0.01" name="adjacent_road_width" value="{{ old('adjacent_road_width') }}" placeholder="接道幅"> ｍ
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('national_land_utilization_law'))) has-error @endif">
                        <select name="national_land_utilization_law">
                            ...
                            <option value="{{ $key }}" @if(old('national_land_utilization_law') === $national_land_utilization_law) selected @endif>{{ $national_land_utilization_law }}</option>
                            @endforeach
                        </select>
