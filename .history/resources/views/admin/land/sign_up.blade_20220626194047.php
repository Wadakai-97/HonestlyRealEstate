            ...
            <tr>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('setback'))) has-error @endif">
                        <input type="radio" name="setback" id="setback1" value="{{ old('setback') }}"><label for="setbacck1">なし</label>
                        <input type="radio" name="setback" id="setback2" value="{{ old('setback') }}"><label for="setbacl2">指定なし</label>
                        <input type="number" name="setback_length" value0="{{ old('setback_length') }}">m
