            ...
            <tr>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('setback'))) has-error @endif">
                        <input type="radio" name="setback" id="setback1" value="{{ old('setback') }}"><label for="setback1">なし</label>
                        <input type="radio" name="setback" id="setback2" value="{{ old('setback') }}"><label for="setback2">あり</label>
                        <div><input type="number" name="setback_length" id="setbackLength" value="{{ old('setback_length') }}"><label for="setbackLength">m</label></div>
