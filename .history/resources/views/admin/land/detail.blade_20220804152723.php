...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                {{ $land->building_certification_number }}
            </td>
        ...
        <tr>
            ...
            <td>
                {{ $land->station }}まで徒歩{{ $land->walking_distance_station }}分
            </td>
...
<button onclick="location.href='{{ route('admin.mansion.detail', ['id' => $mansion->id]) }}'">詳細</button>

<form action="{{ route('admin.land.edit', ['id' => $land->id]) }}">
    @csrf
