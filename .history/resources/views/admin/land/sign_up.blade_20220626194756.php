            ...
            <tr>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('setback'))) has-error @endif">
                        ...
                        <input type="radio" name="setback" id="setback2" value="{{ old('setback') }}">
                        <input type="number" name="setback_length" id="setbackLength" value="{{ old('setback_length') }}"><label for="setbackLength"><main></main></label>
