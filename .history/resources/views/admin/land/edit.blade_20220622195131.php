    ...
    <table>
        ...
        <tbody>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('land_use_zones'))) has-error @endif">
                        <select name="land_use_zones">
                            ...
                            <option value="{{ $key }}" @if(old('land_use_zones', $mansion->land_use_zones) === '{{ $key }}') selected @endif>{{ $land_use_zones }}</option>
                            @endforeach
                            <option value="田園住居地域" @if(old('land_use_zones', $land->land_use_zones) === '田園住居地域') selected @endif>田園住居地域</option>
                            <option value="第一種低層住居専用地域" @if(old('land_use_zones', $land->land_use_zones) === '第一種低層住居専用地域') selected @endif>第一種低層住居専用地域</option>
                            <option value="第二種低層住居専用地域" @if(old('land_use_zones', $land->land_use_zones) === '第二種低層住居専用地域') selected @endif>第二種低層住居専用地域</option>
                            <option value="第一種中高層住居専用地域" @if(old('land_use_zones', $land->land_use_zones) === '第一種中高層住居専用地域') selected @endif>第一種中高層住居専用地域</option>
                            <option value="第二種中高層住居専用地域" @if(old('land_use_zones', $land->land_use_zones) === '第二種中高層住居専用地域') selected @endif>第二種中高層住居専用地域</option>
                            <option value="第一種住居地域" @if(old('land_use_zones', $land->land_use_zones) === '第一種住居地域') selected @endif>第一種住居地域</option>
                            <option value="第二種住居地域" @if(old('land_use_zones', $land->land_use_zones) === '第二種住居地域') selected @endif>第二種住居地域</option>
                            <option value="準住居地域" @if(old('land_use_zones', $land->land_use_zones) === '準住居地域') selected @endif>準住居地域</option>
                            <option value="近隣商業地域" @if(old('land_use_zones', $land->land_use_zones) === '近隣商業地域') selected @endif>近隣商業地域</option>
                            <option value="商業地域" @if(old('land_use_zones', $land->land_use_zones) === '商業地域') selected @endif>商業地域</option>
                            <option value="準工業地域" @if(old('land_use_zones', $land->land_use_zones) === '準工業地域') selected @endif>準工業地域</option>
                            <option value="工業地域" @if(old('land_use_zones', $land->land_use_zones) === '工業地域') selected @endif>工業地域</option>
                        </select>
            ...
            <tr>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('status'))) has-error @endif">
                        <select name="status">
                            <option disabled selected>未選択</option>
                            <option value="更地" @if(old('status', $land->status) === '更地') selected @endif>更地</option>
                            <option value="古屋あり（現況渡し）" @if(old('status', $land->status) === '古屋あり（現況渡し）') selected @endif>古屋あり（現況渡し）</option>
                            <option value="古屋あり（更地渡し" @if(old('status', $land->status) === '古屋あり（更地渡し') selected @endif>古屋あり（更地渡し</option>
                        </select>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('water_supply'))) has-error @endif">
                        <select name="water_supply">
                            <option disabled selected>未選択</option>
                            <option value="公営水道" @if(old('water_supply', $land->water_supply) === '公営水道') selected @endif>公営水道</option>
                            <option value="私営水道" @if(old('water_supply', $land->water_supply) === '私営水道') selected @endif>私営水道</option>
                            <option value="井戸" @if(old('water_supply', $land->water_supply) === '井戸') selected @endif>井戸</option>
                        </select>
            ...
            <tr>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('sewage_line'))) has-error @endif">
                        <select name="sewage_line">
                            <option disabled selected>未選択</option>
                            <option value="公共下水" @if(old('sewage_line', $land->sewage_line) === '公共下水') selected @endif>公共下水</option>
                            <option value="個別浄化槽" @if(old('sewage_line', $land->sewage_line) === '個別浄化槽') selected @endif>個別浄化槽</option>
                            <option value="集中浄化槽" @if(old('sewage_line', $land->sewage_line) === '集中浄化槽') selected @endif>集中浄化槽</option>
                            <option value="汲取式" @if(old('sewage_line', $land->sewage_line) === '汲取式') selected @endif>汲取式</option>
                        </select>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('gas'))) has-error @endif">
                        <select name="gas">
                            <option disabled selected>未選択</option>
                            <option value="都市ガス" @if(old('gas', $land->gas) === '都市ガス') selected @endif>都市ガス</option>
                            <option value="個別プロパン" @if(old('gas', $land->gas) === '個別プロパン') selected @endif>個別プロパン</option>
                            <option value="集中プロパン" @if(old('gas', $land->gas) === '集中プロパン') selected @endif>集中プロパン</option>
                        </select>
            ...
            <tr>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('building_certification_number'))) has-error @endif">
                        <input type="text" name="building_certification_number" value="{{ old('building_certification_number', $land->building_certification_number) }}">
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('conditions_of_transactions'))) has-error @endif">
                        <select name="conditions_of_transactions">
                            <option disabled selected>未選択</option>
                            <option value="媒介" @if(old('conditions_of_transactions', $land->conditions_of_transactions) === '媒介') selected @endif>媒介</option>
                            <option value="売主" @if(old('conditions_of_transactions', $land->conditions_of_transactions) === '売主') selected @endif>売主</option>
                            <option value="代理" @if(old('conditions_of_transactions', $land->conditions_of_transactions) === '代理') selected @endif>代理</option>
                        </select>
            ...
            <tr>
                <th>小学校</th>
                <td colspan=3>
                    <input type="text" placeholder="〇〇小学校" name="elementary_school_name" value="{{ old('elementary_school_name', $land->elementary_school_name) }}">まで徒歩</th><input type="number" name="elementary_school_district" value="{{ old('elementary_school_district') }}">分
                </td>
            </tr>
            <tr>
                <th>中学校</th>
                <td colspan=3>
                    <input type="text" placeholder="〇〇中学校" name="junior_high_school_name" value="{{ old('junior_high_school_name', $land->junior_high_school_name) }}">まで徒歩</th><input type="number" name="junior_high_school_district" value="{{ old('junior_high_school_district') }}">分
                </td>
            </tr>
                <th>物件画像（複数可能）</th>
                <td colspan=3>
