            ...
            <tr>
                ...
                <td>
                    <div class="form-group @if(!empty($errors->first('setback'))) has-error @endif">
                        <input type="radio" name="setback" value="{{ old('setback') }}" onclick="setbackClick()" id="noSetback"><label for="setback1">なし</label>
                        <input type="radio" name="setback" value="{{ old('setback') }}" onclick="setbackClick()"><label for="setback2">あり</label>
