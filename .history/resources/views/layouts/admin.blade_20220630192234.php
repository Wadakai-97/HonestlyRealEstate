                    ...
                    $.each(data, function(key, val) {
                        html = `
                            <tr>
                                ...
                                <td width="20%">${val.lowest_number_of_rooms}${val.lowest_type_of_room}~${val.highest_number_of_rooms}${val.highest_type_of_room}</td>
                                <td width="20%">${val.lowest_price}万円~${val.highest_price}万円</td>
