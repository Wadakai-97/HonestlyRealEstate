...
<head>
    ...
    <script>
        $(function() {
            $('#mansionSearch').on('click', function() {
                var apartment_name_keyword = document.getElementById('apartmentNameKeyword').value
                var number_of_rooms = document.getElementById('numberOfRooms').value
                var type_of_room = document.getElementById('typeOfRoom').value
                var lowest_price = document.getElementById('lowestPrice').value
                var highest_price = document.getElementById('highestPrice').value
                var municipalities_keyword = document.getElementById('municipalitiesKeyword').value

                $.ajaxSetup({ headers: { 'csrftoken' : '{{ csrf_token() }}' } });
                $.ajax({
                    url: "/resources/php/mansion_search.php",
                    type: "POST",
                    data: {
                        "apartment_name_keyword": apartment_name_keyword,
                        "number_of_rooms": number_of_rooms,
                        "type_of_room": type_of_room,
                        "lowest_price": lowest_price,
                        "highest_price": highest_price,
                        "municipalities_keyword": municipalities_keyword,
                    },
                    dataType: "json",
                }).done(function(data) {
                    $('.mansion').remove();
                    $.each(data, function(key, val) {
                        ...
                        $("#mansionList").append(mansionhtml);
                    });
                    console.log(mansionhtml)    ;
                    ...
                    $.each(data, function(key, val) {
                        html = `
                            <tr>
                                ...
                                <td><button id="customerDetail" type="button" onclick="customerDetail()">詳細</button></td>
                                <td><form method="POST" action="/public/customer/delete/${val.id}">@csrf<input type="submit" id="customerDelete" value="削除"></form></td>
                            </tr>`
