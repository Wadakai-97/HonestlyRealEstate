                ...
                $.ajax({
                    ...
                    $.each(data, function(key, val) {
                        html = `
                            <tr>
                                <td class="hidden">${val.id}</td>
                                <td width="0%">${val.name}</td>
                                <td width="10%">${val.lowest_number_of_rooms}${val.lowest_type_of_room}~${val.highest_number_of_rooms}${val.highest_type_of_room}</td>
                                <td width="10%">${val.lowest_price}万円~${val.highest_price}万円</td>
                                <td width="10%">${val.municipalities}</td>
