                ...
                <div class="header_keyword">
                    <form method="get" action="#" class="search_container">
                        <div class="multiple_answers">
                            ...
                            <label for="old2"><input type="radio" id="old2" value="10" name="old"> 中古戸建</label>
                            <label for="old3"><input type="radio" id="old3" value="15" name="old"> マンション</label>
                            <label for="old4"><input type="radio" id="old4" value="20" name="old"> 土地</label>
                        </div>
