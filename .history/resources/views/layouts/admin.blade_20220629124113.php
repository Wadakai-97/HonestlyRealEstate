                    ...
                    $.each(data, function(key, val) {
                        html = `
                            <tr>
                                ...
                                <td width="15%">${val.price}万円</td>
                                <td width="20%">${val.municipalities}</td>
                                <td width="10%"><button id="newDetachedHouseGroupDetail" type="button" onclick="newDetachedHouseGroupDetail()">詳細</button></td>
                                <td width="10%"><form method="POST" action="/public/new_detached_house_group/delete/${val.id}">@csrf<input type="submit" id="newDetachedHouseGroupDelete" value="削除"></form></td>
                            </tr>`
                    ...
                    $.each(data, function(key, val) {
                        html = `
                            <tr>
                                ...
                                <td width="15%">${val.price}万円</td>
                                <td width="20%">${val.municipalities}</td>
                                <td width="10%"><button id="oldDetachedHouseGroupDetail" type="button" onclick="oldDetachedHouseGroupDetail()">詳細</button></td>
                                <td width="10%"><form method="POST" action="/public/old_detached_house_group/delete/${val.id}">@csrf<input type="submit" id="oldDetachedHouseGroupDelete" value="削除"></form></td>
                            </tr>`
