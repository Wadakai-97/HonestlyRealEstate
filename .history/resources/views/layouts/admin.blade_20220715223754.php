                    ...
                    $.each(data, function(key, val) {
                        html = `
                            <tr>
                                ...
                                <td>${val.position}</td>
                                <td><input id="staffDetail" type="button" onclick="staffDetail()" value="詳細"></td>
                                <td><form method="POST" action="/public/staff/delete/${val.id}">@csrf<input type="submit" id="staffDelete" value="削除"></form>
                                </td>
                            </tr>`
