        ...
        $(function() {
            $(document).on('click', '#recommendDelete', function() {
                ...
                if(delete_confirm == true) {
                    ...
                    $.ajax({
                        type: "post",
                        url: "/public/recommend/delete/" + id,
                        data: {"id": id,
                                "_method": "delete",}
                    }).done(function() {
                        target.hide();
                    ...
                    $.each(data, function(key, val) {
                        html = `
                            <tr class="mansion">
                                ...
                                <td><form method="POST" action="/public/mansion/delete/${val.id}">@csrf @method('delete')<input type="submit" id="mansionDelete" value="削除"></form></td>
                            </tr>`
