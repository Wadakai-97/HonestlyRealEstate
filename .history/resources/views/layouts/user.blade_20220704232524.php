    ...
    <footer>
        ...
        <div class="footer_list">
            <div class="footer_menu">
                <h2>買いたい</h2>
                <ul>
                    <a href="{{ route('') }}"><li>新築戸建を探す</li></a>
                    <a href="{{ route('') }}"><li>中古戸建を探す</li></a>
                    <a href="{{ route('mansion') }}"><li>マンションを探す</li></a>
                    <a href="{{ route('') }}"><li>土地を探す</li></a>
                    <a href="{{ route('') }}"><li>学区から探す</li></a>
                </ul>
            </div>
            <div class="footer_menu">
                <h2>売りたい</h2>
                <ul>
                    <a href="{{ route('') }}"><li>無料査定</li></a>
                    <a href="{{ route('') }}"><li>売却方法について</li></a>
                    <a href="{{ route('') }}"><li>よくある質問</li></a>
                    <a href="{{ route('') }}"><li>売却サポートについて</li></a>
                    <a href="{{ route('') }}"><li>WEB査定依頼はこちら</li></a>
                </ul>
            </div>
            <div class="footer_menu">
                <h2>HREについて</h2>
