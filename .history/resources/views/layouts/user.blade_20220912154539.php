    ...
    <header>
        <div class="header">
            <div class="header_top">
                <a href="{{ route('')}}"><img src="/storage/company/logo.png" alt="企業ロゴ" class="header_top_logo"></a>
                ...
                @auth
                    <a href="{{ route('guest.favorite')}}">お気に入り物件</a>
                @endauth
                @guest
                    <a href="{{ route('member.favorite')}}">お気に入り物件</a>
                @endguest
            </div>
            @auth
