                    ...
                    $.each(data, function(key, val) {
                        html = `
                            <tr>
                                ...
                                <td>${val.position}</td>
                                <td class="combine_td_left"><button id="staffDetail" type="button" onclick="staffDetail()">詳細</button>
                                    <form method="POST" action="/public/staff/delete/${val.id}">@csrf<input type="submit" id="staffDelete" value="削除"></form></td>
                            </tr>`
