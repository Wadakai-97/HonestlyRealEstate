                    ...
                    $.each(data, function(key, val) {
                        html = `
                            <tr>
                                ...
                                <td>${val.price}万円</td>
                                <td>${val.pref}${val.municipalities}</td>
                                <td class="combine_td_left">
<td class="combine_td_right">
                                <td class=”combine_td_left"><button id="landDetail" type="button" onclick="landDetail()">詳細</button></td>
                                <td class=”combine_td_right"><for‰m method="POST" action="/public/land/delete/${val.id}">@csrf<input type="submit" id="landDelete" value="削除"></form></td>
                            </tr>`
