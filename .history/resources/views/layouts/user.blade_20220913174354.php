        ...
        <div class="header">
            <div class="header_top">
                ...
                <div class="header_keyword">
                    <form method="post" action="{{ route('keyword') }}" class="search_container">
                        @csrf
                        <div class="multiple_answers">
                            <label for="type1"><input type="radio" id="type1" value="新築戸建" name="type"> 新築戸建</label>
                            <label for="type2"><input type="radio" id="type2" value="中古戸建" name="type"> 中古戸建</label>
                            <label for="type3"><input type="radio" id="type3" value="マンション" name="type"> マンション</label>
                            <label for="type4"><input type="radio" id="type4" value="土地" name="type"> 土地</label>
                        </div>
                        <input type="text" name="keyword" size="30" placeholder="例）横浜　南向き">
