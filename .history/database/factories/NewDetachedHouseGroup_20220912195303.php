...
$factory->define(NewDetachedHouseGroup::class, function (Faker $faker) {
    ...
    $tax = ['税込', '非課税', ];
    $pref = ['神奈川県', '東京都', ];
    $municipalities = ['横浜市西区みなとみらい', '横浜市中区本牧三之谷', '横浜市港北区新横浜', '鎌倉市雪ノ下', '渋谷区松涛', '港区六本木', '千代田区丸の内', '中央区銀座', '大田区田園調布'];
    ...
    return [
            ...
            'lowest_price' => $faker->randomFloat(1, 900, 6000),
            'highest_price' => $faker->randomFloat(1, 6100, 11000),
            ...
            'adjacent_road_direction' => $faker->randomElement($direction),
            'lowest_adjacent_road_width'=>$faker->randomFloat(2, 2, 3),
            'highest_adjacent_road_width'=>$faker->randomFloat(2, 4, 5),
