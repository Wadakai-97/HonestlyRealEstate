...
$factory->define(NewDetachedHouseGroup::class, function (Faker $faker) {
    ...
    return [
            ...
            'lowest_land_area'=>$faker->randomFloat(2, 0, 300),
            'highest_land_area'=>$faker->randomFloat(2, 0, 300),
            'lowest_building_area'=>$faker->randomFloat(2, 0, 300),
            'highest_building_area'=>$faker->randomFloat(2, 0, 300),
            'balcony' => $faker->randomElement($yes_or_no),
            'lowest_balcony_area'=>$faker->randomNumber(2),
            'highest_balcony_area'=>$faker->randomNumber(2),
