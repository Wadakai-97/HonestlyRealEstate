...
$factory->define(Model::class, function (Faker $faker) {
    ...
    return [
            ...
            'number_of_rooms'=>$faker->numberBetween(6, 9),
            'type_of_room'=>$faker->randomElement($type_of_room),
            'land_area'=>$faker->numberBetween(80, 100),
            'land_area'=>$faker->numberBetween(100, 120),
            'building_area'=>$faker->numberBetween(80, 100),
            'building_area'=>$faker->numberBetween(110, 150),
            'balcony_area'=>$faker->randomElement($balcony_area),
            'building_coverage_ratio'=>$faker->numberBetween(60, 80),
            'building_coverage_ratio'=>$faker->numberBetween(80, 100),
            'floor_area_ratio'=>$faker->numberBetween(100, 120),
            'floor_area_ratio'=>$faker->numberBetween(150, 200),
            'parking_lot'=>$faker->numberBetween(1, 5),
            'parking_lot'=>$faker->numberBetween(4, 5),
