...
$factory->define(Mansion::class, function (Faker $faker) {
    ...
    return [
            ...
            'land_area'=>$faker->randomFloat(2, 500, 300),
            'building_area'=>$faker->randomFloat(2, 0, 300),
            ...
            'occupation_area'=>$faker->randomFloat(2, 0, 300),
            'balcony' => $faker->randomElement($yes_or_no),
            'balcony_area'=>$faker->randomFloat(2, 0, 30),
