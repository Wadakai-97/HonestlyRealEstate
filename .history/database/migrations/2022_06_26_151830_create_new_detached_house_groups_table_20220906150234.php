...
class CreateNewDetachedHouseGroupsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('new_detached_house_groups', function (Blueprint $table) {
            ...
            $table->string('lowest_price')->unsigned()->comment('最低価格');
            $table->string('highest_price')->unsigned()->comment('最高価格');
            ...
            $table->integer('lowest_land_area')->unsigned()->comment('最低土地面積');
            $table->integer('highest_land_area')->unsigned()->comment('最高土地面積');
            $table->integer('lowest_building_area')->unsigned()->comment('最低建物面積');
            $table->integer('highest_building_area')->unsigned()->comment('最高建物面積');
            $table->string('balcony')->comment('バルコ二ー');
            $table->integer('lowest_balcony_area')->unsigned()->nullable()->comment('最低バルコニー面積');
            $table->integer('highest_balcony_area')->unsigned()->nullable()->comment('最高バルコニー面積');
            ...
            $table->string('lowest_parking_lot')->unsigned()->nullable()->comment('最低駐車場数');
            $table->string('highest_parking_lot')->unsigned()->nullable()->comment('最高駐車場数');
            ...
            $table->string('setback_length')->unsigned()->nullable()->comment('セットバック幅');
