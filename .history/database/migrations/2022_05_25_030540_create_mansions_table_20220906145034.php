...
class CreateMansionsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('mansions', function (Blueprint $table) {
            ...
            $table->integer('land_area')->unsigned()->nullable()->comment('土地面積');
            $table->string('building_area')->unsigned()->nullable()->comment('建物面積');
            ...
            $table->integer('total_number_of_households')->unsigned()->comment('総戸数');
