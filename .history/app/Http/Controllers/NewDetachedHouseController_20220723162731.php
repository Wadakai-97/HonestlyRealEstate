...
class NewDetachedHouseController extends Controller
{
    ...
    public function search(Request $request) {
        $new_detached_house = NewDetachedHouse::select('pref', 'price', DB::raw(" '' AS lowest_price"), 'land_area', 'building_area', 'number_of_rooms', 'station', 'walking_distance_station', 'land_right');
