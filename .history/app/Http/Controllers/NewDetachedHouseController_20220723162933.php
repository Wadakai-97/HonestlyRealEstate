...
class NewDetachedHouseController extends Controller
{
    ...
    public function search(Request $request) {
        $new_detached_house = NewDetachedHouse::select('pref', 'price', DB::raw(" '' AS lowest_price"), DB::raw(" '' AS highest_price"), 'land_area', DB::raw(" '' AS lowest_land_area"), DB::raw(" '' AS highest_land_area"),'building_area', DB::raw(" '' AS lowest_building_area"), DB::raw(" '' AS highest_building_area"), 'number_of_rooms', 'station', 'walking_distance_station', 'land_right')
