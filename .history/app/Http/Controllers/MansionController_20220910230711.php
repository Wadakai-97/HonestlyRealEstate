...
class MansionController extends Controller
{
    ...
    public function kanagawa() {
        ...
        $kawa02 = Mansion::where('municipalities', 'LIKE', '川崎市川崎区%')->count();
        $kawa03 = Mansion::where('municipalities', 'LIKE', '川崎市川崎区%')->count();
        $kawa04 = Mansion::where('municipalities', 'LIKE', '川崎市川崎区%')->count();
        $kawa05 = Mansion::where('municipalities', 'LIKE', '川崎市川崎区%')->count();
        $kawa06 = Mansion::where('municipalities', 'LIKE', '川崎市川崎区%')->count();
        $kawa07 = Mansion::where('municipalities', 'LIKE', '川崎市川崎区%')->count();
