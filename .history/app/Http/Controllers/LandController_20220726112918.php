...
class LandController extends Controller
{
    ...
    public function search(Request $request) {
        ...
        $lands = Land::select('id', 'name', 'pref', 'municipalities', 'block', 'price', 'land_area', 'building_coverage_ratio', 'floor_area_ratio', 'station', 'walking_distance_station', 'updated_at')
                            ->wherePref($pref)
