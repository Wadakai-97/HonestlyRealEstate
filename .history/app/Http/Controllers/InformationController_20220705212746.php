...
class InformationController extends Controller
{
    ...
    // sell
    public function sellContact(Request $request) {
        $inputs = $request->all();
        SellContact::create([
            'name' => $request->name,
            'email' => Hash::make($request->email),
        ...
        return view('user.sell_contact.confirm', compact('inputs'));
    }
    public function sellSend(Request $request) {
        $action = $request->input('action');
        $inputs = $request->except('action');
        ...
        if($action !== 'submit') {
            ...
            $request->session()->regenerateToken();
            $name = $request->name;
            return view('user.sell_contact.complete', compact('name'));
        }
    }
