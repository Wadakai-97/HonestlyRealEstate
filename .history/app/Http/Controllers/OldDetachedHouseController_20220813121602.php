...
class OldDetachedHouseController extends Controller
{
    ...
    public function imageEdit($id) {
        $old_detached_house = OldDetachedHouse::find($id);
        $old_detached_house_images = OldDetachedHouseImage::where('old_detached_house_id', '=', $id)->get();c
        $image_counter = 1;c
        return view('admin.old_detached_house.edit_image', compact('old_detached_house', 'old_detached_house_images', 'image_counter')c);
    }
