...
class MansionController extends Controller
{
    ...
    public function mansionImageUpdate($id, Request $request) {
        ...
        $request->session()->regenerateToken();
        return view('admin.mansion.edit_image', compact('mansion', 'image_counter', 'mansion_images', 'id') ['id' => $mansion->id])->with('message', '変更内容を登録しました。');
    }
