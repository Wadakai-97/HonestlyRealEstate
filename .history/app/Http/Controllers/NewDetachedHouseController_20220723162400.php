...
class NewDetachedHouseController extends Controller
{
    ...
    public function search(Request $request) {
        ...
        $new_detached_houses = NewDetachedHouseGroup::select('pref', 'lowest_price', 'highest_price', 'lowest_land_area', 'building_area', 'number_of_rooms', 'station', 'walking_distance_station', 'land_right')
                                                    ->wherePref($request)
