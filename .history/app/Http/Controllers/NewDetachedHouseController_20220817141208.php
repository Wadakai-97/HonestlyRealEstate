...
class NewDetachedHouseController extends Controller
{
    ...
    $itemsForCurrentPage = array_slice($new_detached, $offSet, $paginate, true);
    $new_detached = new LengthAwarePaginator($itemsForCurrentPage, count($new_detached), $paginate, $page);
