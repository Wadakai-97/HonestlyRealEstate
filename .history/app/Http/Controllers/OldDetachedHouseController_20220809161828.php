...
class OldDetachedHouseController extends Controller
{
    ...
    public function imageDelete($id) {
        ...
        $old_detached_house = NewDetachedHouse::find($old_detached_house_id);
        $old_detached_house_images = NewDetachedHouseImage::where('old_detached_house_id', '=', $old_detached_house_id)->get();
        $existing_images = NewDetachedHouseImage::where('old_detached_house_id', '=', $old_detached_house_id)->count();
    ...
    public function imageUpdate($id, Request $request) {
        ...
        $old_detached_house = NewDetachedHouse::find($old_detached_house_image->old_detached_house_id);
        $old_detached_house_images = NewDetachedHouseImage::where('old_detached_house_id', '=', $id)->get();
        $image_counter = 1;
        $request->session()->regenerateToken();
