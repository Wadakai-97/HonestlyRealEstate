...
class MansionController extends Controller
{
    ...
    public function search(MansionSearchRequest $request) {
        $mansions = Mansion::select('id', 'apartment_name', 'pref', 'municipalities', 'price', 'occupation_area', 'number_of_rooms', 'type_of_room', 'floor', 'story', 'year', 'station', 'access_method', 'distance_station''elementary_school_name', 'junior_high_school_name',)
                            ->wherePref($request)
                            ->wherePlan($request)
