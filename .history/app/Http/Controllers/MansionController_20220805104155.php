...
class MansionController extends Controller
{
    ...
    public function list() {
        $mansions = Mansion::select('id', 'apartment_name', 'room', 'number_of_rooms', 'type_of_room', 'occupation_area', 'price', 'pref', 'municipalities')
                            ->paginate(10);
    ...
    public function adminSearch(Request $request) {
        ...
        $mansions = Mansion::select('id', 'pref', 'municipalities',  'apartment_name', 'price', 'occupation_area', 'number_of_rooms', 'type_of_room', 'year', 'station', 'walking_distance_station')
                            ->wherePref($pref)
                            ->whereMunicipalities($municipalities)
