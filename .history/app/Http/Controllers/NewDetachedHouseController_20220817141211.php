...
class NewDetachedHouseController extends Controller
{
    ...
    $itemsForCurrentPage = array_slice($new_detached_houses, $offSet, $paginate, true);
    $new_detached_houses = new LengthAwarePaginator($itemsForCurrentPage, count($new_detached_houses), $paginate, $page);
