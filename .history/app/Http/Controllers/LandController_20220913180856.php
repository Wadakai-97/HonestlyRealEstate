...
class LandController extends Controller
{
    ...
    public function sort(request $request) {
        ...
        $lands = Land::select('id', 'name', 'pref', 'municipalities', 'block', 'price', 'land_area', 'building_coverage_ratio', 'floor_area_ratio', 'land_right', 'station', 'construction_conditions', 'station', 'elementary''access_method', 'distance_station')
                    ->wherePref($request)
                    ->whereAddress($request)
                    ->whereLowestPrice($request)
                    ->whereHighestPrice($request)
