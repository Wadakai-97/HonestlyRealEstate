...
class NewDetachedHouseController extends Controller
{
    ...
    public function adminGroupSearch(Request $request) {
        ...
        $new_detached_house = NewDetachedHouseGroup::select('id', 'name', 'pref', 'municipalities', 'lowest_price', 'highest_price', 'lowest_land_area', 'highest_land_area', 'lowest_building_area', 'highest_building_area', 'lowest_number_of_rooms', 'type_of_room', 'station', 'walking_distance_station', 'land_right')
                                                ->wherePref($pref)
                                                ->whereMunicipalities($municipalities)
                                                ->whereLowestPrice($lowest_price)
                                                ->whereHighestPrice($highest_price)
