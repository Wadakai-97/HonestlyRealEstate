...
class NewDetachedHouseController extends Controller
{
    ...
    public function search(Request $request) {
        ...
        $new_detached_houses = NewDetachedHouseGroup::select('pref', 'lowest_price', 'highest_price', 'lowest_land_area', 'highest_land_area', 'lowest_building_area', 'highest_buui' 'number_of_rooms', 'station', 'walking_distance_station', 'land_right')
                                                    ->wherePref($request)
