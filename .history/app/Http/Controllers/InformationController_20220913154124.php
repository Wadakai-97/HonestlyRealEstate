...
class InformationController extends Controller
{
    ...
    public function keywordSearch(Request $request) {
        ...
        $new_detached_houses = Mansion::select('id', 'apartment_name', 'pref', 'municipalities', 'price', 'occupation_area', 'number_of_rooms', 'type_of_room', 'floor', 'story', 'year', 'station', 'access_method', 'distance_station')
                            ->whereKeyword($request)
                            ->paginate(15);
        $new_detached_house_group = Mansion::select('id', 'apartment_name', 'pref', 'municipalities', 'price', 'occupation_area', 'number_of_rooms', 'type_of_room', 'floor', 'story', 'year', 'station', 'access_method', 'distance_station')
                            ->whereKeyword($request)
                            ->paginate(15);
        $mansions = Mansion::select('id', 'apartment_name', 'pref', 'municipalities', 'price', 'occupation_area', 'number_of_rooms', 'type_of_room', 'floor', 'story', 'year', 'station', 'access_method', 'distance_station')
                            ->whereKeyword($request)
        ...
        return view('user.mansion.result', compact('mansions', 'lands', 'new_detached_houses', 'new_detached_house_group', 'old_detached_houses'));
    }
