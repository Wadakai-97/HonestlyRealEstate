...
class InformationController extends Controller
{
    ...
    // 登録削除
    public function favoriteSignOff($type, $id){
        DB::transaction(function() use($id) {
            ...
            if(Auth::check()) {
                ...
                return redirect()->route('member.favorite')->with('message', 'お気に入り登録を削除しました。');
            } else {
                if($type = "mansion") {
                ...
                return redirect()->route('guest.favorite')->with('message', 'お気に入り登録を削除しました。');
            }
        });
    }
