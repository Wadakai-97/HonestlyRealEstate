...
class NewDetachedHouseController extends Controller
{
    ...
    public function adminGroupSearch(Request $request) {
        ...
        $new_detached_house = NewDetachedHouseGroup::select('id', 'name', 'pref', 'municipalities', 'lowest_price', 'land_area', 'building_area', 'number_of_rooms', 'type_of_room', 'station', 'walking_distance_station', 'land_right')
                                                ->wherePref($pref)
                                                ->whereMunicipalities($municipalities)
                                                ->whereLowestPrice($lowest_price)
                                                ->whereHighestPrice($highest_price)
