...
class NewDetachedHouseController extends Controller
{
    ...
    public function save($id) {
        DB::transaction(function() use($id, $request) {
            ...
            $ex_new_detached_house->management_company = $request->management_company;
            $ex_new_detached_house->management_system = $request->management_system;
            $ex_new_detached_house->maintenance_fee = $request->maintenance_fee;
            $ex_new_detached_house->reserve_fund_for_repair = $request->reserve_fund_for_repair;
        ...
        $new_detached_house = OldDetachedHouse::find($id);
        $request->session()->regenerateToken();
