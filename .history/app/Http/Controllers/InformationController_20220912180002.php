...
class InformationController extends Controller
{
    ...
    public function guestFavoriteList(Request $request) {
        ...
        if(Auth::check()) {
            $lands = Favorite::where()->whereNotNull('land_id')->get();
            $mansions = Favorite::where()->whereNotNull('mansion_id')->get();
            $new_detached_houses = Favorite::where()->whereNotNull('new_detached_house_id')->get();
            $new_detached_house_groups = Favorite::where()->whereNotNull('new_detached_house_group_id')->get();
            $old_detached_houses = Favorite::where()->whereNotNull('old_detached_house_id')->get();
