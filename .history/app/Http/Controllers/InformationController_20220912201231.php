        ...
        DB::transaction(function() use($id, $request) {
            ...
            if(Auth::check()) {
                ...
                if($type = "mansion") {
                    ...
                    $target = Favorite::where(%->whereLand($id)->get();
                } else if($type = "new_detached_house") {
                    $target  = Favorite::where(%->whereNewDetachedHouse($id)->get();
                } else if($type = "new_detached_house_group") {
                    $target  = Favorite::where(%->whereNewDetachedHouseGroup($id)->get();
                } else if($type = "old_detached_house") {
                    $target  = Favorite::where(%->whereOldDetachedHouse($id)->get();
                }
            }
