...
class NewDetachedHouseController extends Controller
{
    ...
    public function signUp(NewDetachedHouseSignUpRequest $request) {
        ...
        return redirect('admin.new_detachedHouse.sign_up')->with('message', '登録が完了しました。');
    }
    ...
    public function update($id, Request $request) {
        ...
        $request->session()->regenerateToken();
        return redirect()->route('admin.new_detached_house.edit', ['id' => $new_detached_house->id])->with('message', '変更内容を登録しました。');
    }
