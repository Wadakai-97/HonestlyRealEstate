...
class InformationController extends Controller
{
    ...
    public function recommendList() {
        $land = Recommend::whereNotNull('land_id')->get();
        $mansion = Recommend::whereNotNull('mansion_id')->get();
        $new_detached_house = Recommend::whereNotNull('new_detached_house_id')->get();
        $new_detached_house_group = Recommend::whereNotNull('new_detached_house_group_id')->get();
        $old_detached_house = Recommend::whereNotNull('old_detached_house_id')->get();
        return view('admin.recommend.list', compact('recommends', 'mansion'));
    }
