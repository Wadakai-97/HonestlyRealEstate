...
class MansionController extends Controller
{
    ...
    public function search(MansionSearchRequest $request) {
        $mansion = Mansion::select('pref', 'price', 'occupation_area', 'number_of_rooms', 'years', 'station', 'walking_distance_station')
                            ->wherePref($request)
    ...
    public function detail($id) {
        ...
        $today = Carbon::today();
        $rollo = $today->addDays(14);
        return view('user.mansion.detail', compact('mansion', 'rollo'));
    }
