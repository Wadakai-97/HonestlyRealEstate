...
class MansionController extends Controller
{
    ...
    public function search(Request $request) {
        $pref = $request->pref;
        $mansions = Mansion::select('id', 'apartment_name', 'pref', 'municipalities', 'price', 'occupation_area', 'number_of_rooms', 'type_of_room' 'year', 'station', 'walking_distance_station', 'updated_at')
                            ->wherePref($pref)
