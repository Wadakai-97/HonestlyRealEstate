...
class MansionController extends Controller
{
    ...
    public function kanagawa() {
        $yoko01 = Mansion::where('municipalities', 'LIKE', '横浜市西区%')->count();
        $yoko02 = Mansion::where('municipalities', 'LIKE', '横浜市中区%')->count();
        $yokohama_kanagawa = Mansion::where('municipalities', 'LIKE', '横浜市神奈川区%')->count();
