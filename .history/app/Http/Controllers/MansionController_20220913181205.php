...
class MansionController extends Controller
{
    ...
    public function kanagawa() {
        ...
        $yokosuka = Mansion::where('municipalities', 'LIKE', '横須賀市%')->count();
        $hiratsuka = Mansion::where('municipalities', 'LIKE', '平塚市%')->count();
        $kamakura = Mansion::where('municipalities', 'LIKE', '鎌倉市%')->count();
        $fujisawa = Mansion::where('municipalities', 'LIKE', '藤沢市%')->count();
        $odawara = Mansion::where('municipalities', 'LIKE', '小田原市%')->count();
        $chigasaki = Mansion::where('municipalities', 'LIKE', '茅ヶ崎市%')->count();
        $zushi = Mansion::where('municipalities', 'LIKE', '逗子市%')->count();
        $miura = Mansion::where('municipalities', 'LIKE', '三浦市%')->count();
        $hadano = Mansion::where('municipalities', 'LIKE', '秦野市%')->count();
        $atsugi = Mansion::where('municipalities', 'LIKE', '厚木市%')->count();
        $yamato = Mansion::where('municipalities', 'LIKE', '大和市%')->count();
        $isehara = Mansion::where('municipalities', 'LIKE', '伊勢原市%')->count();
        $ebina = Mansion::where('municipalities', 'LIKE', '海老名市%')->count();
        $zama = Mansion::where('municipalities', 'LIKE', '座間市%')->count();
        $minami_ashigara = Mansion::where('municipalities', 'LIKE', '南足柄市%')->count();
        $ayase = Mansion::where('municipalities', 'LIKE', '綾瀬市%')->count();
        $hayama = Mansion::where('municipalities', 'LIKE', '三浦郡葉山町%')->count();
        $kouza = Mansion::where('municipalities', 'LIKE', '高座郡%')->count();
        $naka = Mansion::where('municipalities', 'LIKE', '中郡%')->count();
        $ashigara_kami = Mansion::where('municipalities', 'LIKE', '足柄上郡%')->count();
        $aikou = Mansion::where('municipalities', 'LIKE', '愛甲郡%')->count();
        $ashigara_shimo = Mansion::where('municipalities', 'LIKE', '足柄下郡%')->count();
        return view('user.mansion.top_kanagawa', compact('yoko01', 'yoko02','yoko03','yoko04','yoko05','yoko06','yoko07','yoko08','yoko09','yoko10','yoko11','yoko12','yoko13','yoko14','yoko15','yoko16','yoko17', 'yoko18', 'kawa01','kawa02','kawa03','kawa04','kawa05','kawa06','kawa07','saga01','saga02','saga03','yokosuka','hiratsuka','kamakura','fujisawa','odawara','chigasaki','zushi','miura','hadano','atsugi','yamato','isehara','ebina','zama','minami_ashigara','ayase','hayama','kouza','naka','ashigara_kami','aikou','ashigara_shimo',));
    }
    //東京都
    public function tokyo() {
        return view('user.mansion.top_tokyo');
    }
    public function search(MansionSearchRequest $request) {
        $mansions = Mansion::select('id', 'apartment_name', 'pref', 'municipalities', 'price', 'occupation_area', 'number_of_rooms', 'type_of_room', 'floor', 'story', 'year', 'station', 'access_method', 'building_construction', 'distance_station','elementary_school_name', 'junior_high_school_name', 'terms_and_conditions', 'property_introduction', 'sales_comment',)
                            ->wherePref($request)
                            ->wherePlan($request)
