...
class NewDetachedHouseController extends Controller
{
    ...
    public function search(Request $request) {
        ...
        return view('user.new_detached_house.result', compact('new_detached_houses'));
    }
    ...
    public function adminSearch(Request $request) {
        ...
        $new_detached_house = NewDetachedHouse::select('id', 'name', 'pref', 'price', 'land_area', 'building_area', DB::raw(" '' AS lowest_building_area"), DB::raw(" '' AS highest_building_area"), 'number_of_rooms', DB::raw(" '' AS lowest_number_of_rooms"), DB::raw(" '' AS highest_number_of_rooms"), 'type_of_room', 'station', 'walking_distance_station', 'land_right')
                                                ->wherePref($pref)
                                                ->whereMunicipalities($municipalities)
                                                ->whereLowestPrice($lowest_price)
                                                ->whereHighestPrice($highest_price)
