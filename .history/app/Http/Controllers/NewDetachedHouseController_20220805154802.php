...
class NewDetachedHouseController extends Controller
{
    ...
    public function recommendSignUp($id) {
        ...
        return redirect()->route('admin.new_detached_house.list')->with('message', 'お気に入り登録が完了しました。');
    }
    ...
    public function groupList() {
        $new_detached_house_groups = NewDetachedHouseGroup::select('id', 'name', 'lowest_number_of_rooms', 'highest_number_of_rooms', 'lowest_type_of_room', 'highest_type_of_room', 'lowest_price', 'highest_price', 'lowest_land_area', 'highest_land_area', '' 'pref', 'municipalities', 'block')
                                                        ->paginate(10);
    ...
    public function recommendGroupSignUp($id) {
        ...
        return redirect()->route('admin.new_detached_house_group.list')->with('message', 'お気に入り登録が完了しました。');
    }
