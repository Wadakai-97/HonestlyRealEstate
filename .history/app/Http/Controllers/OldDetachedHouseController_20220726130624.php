...
class OldDetachedHouseController extends Controller
{
    ...
    public function adminSearch(Request $request) {
        ...
        $old_detached_house = NewDetachedHouse::select('id', 'name', 'pref', 'price', 'land_area', 'building_area', 'number_of_rooms', 'type_of_room', 'station', 'walking_distance_station', 'land_right')
                                                ->wherePref($pref)
                                                ->whereMunicipalities($municipalities)
                                                ->whereLowestPrice($lowest_price)
                                                ->whereHighestPrice($highest_price)
