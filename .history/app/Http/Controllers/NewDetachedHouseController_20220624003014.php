...
class NewDetachedHouseController extends Controller
{
    ...
    public function save($id) {
        DB::transaction(function() use($id, $request) {
            $ex_ = ::find($id);
            $ex_->apartment_name = $request->apartment_name;
            $ex_->room = $request->room;
            $ex_->price = $request->price;
            $ex_->tax = $request->tax;
            $ex_->pref = $request->pref;
            $ex_->municipalities = $request->municipalities;
            $ex_->block = $request->block;
            $ex_->land_area = $request->land_area;
            $ex_->building_area = $request->building_area;
            $ex_->number_of_rooms = $request->number_of_rooms;
            $ex_->type_of_room = $request->type_of_room;
            $ex_->measuring_method = $request->measuring_method;
            $ex_->occupation_area = $request->occupation_area;
            $ex_->balcony_area = $request->balcony_area;
            $ex_->parking_lot = $request->parking_lot;
            $ex_->floor = $request->floor;
            $ex_->story = $request->story;
            $ex_->year = $request->year;
            $ex_->month = $request->month;
            $ex_->day = $request->day;
            $ex_->direction = $request->direction;
            $ex_->station = $request->station;
            $ex_->walking_distance_station = $request->walking_distance_station;
            $ex_->building_construction = $request->building_construction;
            $ex_->total_number_of_households = $request->total_number_of_households;
            $ex_->land_right = $request->land_right;
            $ex_->land_use_zones = $request->land_use_zones;
            $ex_->management_company = $request->management_company;
            $ex_->management_system = $request->management_system;
            $ex_->maintenance_fee = $request->maintenance_fee;
            $ex_->reserve_fund_for_repair = $request->reserve_fund_for_repair;
            $ex_->other_fee = $request->other_fee;
            $ex_->status = $request->status;
            $ex_->delivery_date = $request->delivery_date;
            $ex_->property_introduction = $request->property_introduction;
            $ex_->sales_comment = $request->sales_comment;
            $ex_->elementary_school_name = $request->elementary_school_name;
            $ex_->elementary_school_district = $request->elementary_school_district;
            $ex_->junior_high_school_name = $request->junior_high_school_name;
            $ex_->junior_high_school_district = $request->junior_high_school_district;
            $ex_->terms_and_conditions = $request->terms_and_conditions;
            $ex_->conditions_of_transactions = $request->conditions_of_transactions;
            $ex_->save();
            if(!empty($request->file('files'))) {
                foreach ($request->file('files') as $index => $e) {
                    $ext = $e['image']->guessExtension();
                    $file_name = "{$request->apartment_name}_{$index}.{$ext}";
                    $e['image']->storeAs('public/_images', $file_name);
                    $images = Image::find($id);
                    $images->path = $file_name;
                    $images->_id = $->id;
                    $images->save();
                }
                $ex_->images = $file_name;
                $ex_->save();
            }
        });
        $ = ::find($id);
