...
class LandController extends Controller
{
    ...
    public function adminSearch(Request $request) {
        ...
        $lands = Land::select('id', 'apartment_name', 'number_of_rooms', 'type_of_room', 'occupation_area', 'price', 'pref', 'municipaliteis')
                            ->wherePref($pref)
                            ->whereMunicipalities($municipalities)
                            ->whereLowestPrice($lowest_price)
                            ->whereHighestPrice($highest_price)
                            ->whereLowestArea($lowest__area)
                            ->whereHighestArea($highest__area)
                            ->wherePlan($plan)
