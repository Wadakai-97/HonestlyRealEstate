...
class NewDetachedHouseController extends Controller
{
    ...
    public function adminSearch(Request $request) {
        $new_detached_houses = NewDetachedHouse::select('id', 'pref', 'municipalities', 'price', 'land_area', 'building_area', 'number_of_rooms', 'type_of_room', 'station', 'walking_distance_station', 'land_right')
                                                ->wherePlan($request)
                                                ->wherePref($request)
                                                ->whereMunicipalities($request)
                                                ->whereLowestPrice($request)
