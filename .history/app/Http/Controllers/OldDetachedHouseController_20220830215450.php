...
class OldDetachedHouseController extends Controller
{
    ...
    public function csvDownload() {
        ...
        $item_name = [
            'ID', '物件名', '販売価格', '税金', '都道府県', '市区町村', '番町番地', '部屋数', '間取り', '土地面積', '建物面積', 'バルコニー', 'バルコニー面積', '建ぺい率', '容積率', '駐車場', '築年', '築月', '築日', '最寄り駅', '最寄り駅までのアクセス方法', '最寄り駅までの所要時間', '建物構造', '土地権利', 'その他の費用', '都市計画区域', '用途地域', '法令上の制限', '地目', '地勢', '接道', '接道幅', '私道', 'セットバック', 'セットバック幅', '上水道', '現況', '引渡し日', '小学校', '小学校までの徒歩距離', '中学校', '中学校までの徒歩距離', '設備条件', '取引態様', '物件紹介コメント', 'セールスコメント', '作成日', '更新日',
        ];
