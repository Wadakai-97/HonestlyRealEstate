...
class InformationController extends Controller
{
    ...
    public function keywordSearch(Request $request) {
        ...
        $lands = Land::select('id', 'apartment_name', 'pref', 'municipalities', 'price', 'occupation_area', 'number_of_rooms', 'type_of_room', 'floor', 'story', 'year', 'station', 'access_method', 'distance_station')
                            ->whereKeyword($request)
                            ->paginate(15);
        $new_detached_houses = NewDetachedHouse::select('id', 'name', 'pref', 'municipalities', 'price', 'land_area','building_area', 'number_of_rooms', 'type_of_room', 'station', 'access_method', 'distance_station',  'land_right', 'updated_at')
                            ->whereKeyword($request)
                            ->paginate(15);
        $new_detached_house_groups = NewDetachedHouseGroup::select('id', 'name', 'pref', 'municipalities', 'lowest_price', 'highest_price', 'lowest_land_area', 'highest_land_area', DB::raw(" '' AS building_area"), 'lowest_building_area', 'highest_building_area', DB::raw(" '' AS number_of_rooms"), 'lowest_number_of_rooms', 'highest_number_of_rooms', DB::raw(" '' AS type_of_room"), 'lowest_type_of_room', 'highest_type_of_room', 'station', 'access_method', 'distance_station',  'land_right', 'updated_at')
                            ->whereKeyword($request)
                            ->paginate(15);
