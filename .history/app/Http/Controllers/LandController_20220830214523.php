...
class LandController extends Controller
{
    ...
    public function csvDownload() {
        ...
        $item_name = [
            'ID', '土地名', '販売価格', '税金', '都道府県', '市区町村', '番町番地', '建築条件', '土地面積', '建ぺい率', '容積率', '最寄り駅', '最寄り駅までのアクセス方法', '最寄り駅までのアクセス時間', '土地権利', 'その他の費用', '都市計画', '用途地域', '法令上の制限', '国土法届出', '地目', '地勢', '接道', '接道幅', '私道', 'セットバック', 'セットバック幅', '上水道', '下水道', 'ガス', '現況', '引き渡し日' '取引態様', '物件紹介コメント', 'セールスコメント', '作成日', '更新日',
        ];
