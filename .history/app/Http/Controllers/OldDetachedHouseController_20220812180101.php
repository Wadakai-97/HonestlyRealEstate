...
class OldDetachedHouseController extends Controller
{
    ...
    public function list() {
        $old_detached_houses = OldDetachedHouse::select('id', 'pref', 'municipalities', 'block', 'number_of_rooms', 'type_of_room', 'price', 'land_right', 'year', 'land_area', 'building_area', 'station')
                                            ->paginate(10);
