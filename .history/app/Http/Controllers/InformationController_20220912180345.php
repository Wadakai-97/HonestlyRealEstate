...
class InformationController extends Controller
{
    ...
    public function guestFavoriteList(Request $request) {
        ...
        if(Auth::check()) {
            ...
            $lands = >whereNotNull('land_id')->get();
            $mansions = >whereNotNull('mansion_id')->get();
            $new_detached_houses = >whereNotNull('new_detached_house_id')->get();
            $new_detached_house_groups = >whereNotNull('new_detached_house_group_id')->get();
            $old_detached_houses = >whereNotNull('old_detached_house_id')->get();
