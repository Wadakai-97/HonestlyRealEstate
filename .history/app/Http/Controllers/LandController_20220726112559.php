...
class LandController extends Controller
{
    ...
    public function search(Request $request) {
        ...
        $lands = Land::select('id', 'land_name', 'pref', 'municipalities', 'price', 'occupation_area', 'number_of_rooms', 'type_of_room', 'floor', 'story', 'year', 'station', 'walking_distance_station', 'updated_at')
                            ->wherePref($pref)
