...
class NewDetachedHouseController extends Controller
{
    ...
    public function groupList() {
        $new_detached_house_groups = NewDetachedHouseGroup::select('id', 'name', 'lowest_number_of_rooms', 'highest_number_of_rooms', 'lowest_type_of_room', 'price', 'land_area', 'building_area', 'pref', 'municipalities', 'block')
                                            ->paginate(10);
