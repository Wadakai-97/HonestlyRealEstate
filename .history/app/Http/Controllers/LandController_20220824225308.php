...
class LandController extends Controller
{
    ...
    public function sort(request $request) {
        ...
        $lands = Land::select('id', 'name', 'pref', 'municipalities', 'block', 'price', 'land_area', 'building_coverage_ratio', 'floor_area_ratio', 'land_right', 'construction_conditions', 'station', 'acce', 'distance_station', 'updated_at')
                    ->wherePref($request)
                    ->whereAddress($request)
                    ->whereLowestPrice($request)
                    ->whereHighestPrice($request)
    ...
    public function list() {
        $lands = Land::select('id', 'land_area', 'land_right', 'price', 'pref', 'municipalities', 'block', 'construction_conditions', 'station', 'walking_distance_station')
                    ->paginate(15);
