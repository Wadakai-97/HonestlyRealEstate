...
class InformationController extends Controller
{
    ...
    public function recommendList() {
        ...
        if(!empty($recommends->new_detached_house_group_id)) {
            $new_detached_house_group = NewDetachedHouse::find($recommend->new_detached_house_group_id);
        }
        if(!empty($recommends->old_detached_house_id)) {
            $old_detached_house = old_detached_house::find($recommend->old_detached_house_id);
        }
