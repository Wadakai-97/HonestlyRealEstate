...
class MansionController extends Controller
{
    ...
    public function kanagawa() {
        ...
        $minamiashigara = Mansion::where('municipalities', 'LIKE', '相模原市南区%')->count();
        $s = Mansion::where('municipalities', 'LIKE', '相模原市南区%')->count();
        $s = Mansion::where('municipalities', 'LIKE', '相模原市南区%')->count();
        $s = Mansion::where('municipalities', 'LIKE', '相模原市南区%')->count();
        $s = Mansion::where('municipalities', 'LIKE', '相模原市南区%')->count();
        $s = Mansion::where('municipalities', 'LIKE', '相模原市南区%')->count();
        ...
        $s = Mansion::where('municipalities', 'LIKE', '相模原市南区%')->count();
        $s = Mansion::where('municipalities', 'LIKE', '相模原市南区%')->count();
        return view('user.mansion.kanagawa.top', compact('yoko01', 'yoko02','yoko03','yoko04','yoko05','yoko06','yoko07','yoko08','yoko09','yoko10','yoko11','yoko12','yoko13','yoko14','yoko15','yoko16','yoko17', 'yoko18', 'kawa01','kawa02','kawa03','kawa04','kawa05','kawa06','kawa07','saga01','saga02','saga03'));
    }
