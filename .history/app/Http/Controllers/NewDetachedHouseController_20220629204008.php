...
class NewDetachedHouseController extends Controller
{
    ...
    public function groupSave($id, Request $request) {
        DB::transaction(function() use($id, $request) {
            $ex_new_detached_house_group = NewDetachedHouse::find($id);
            $ex_new_detached_house_group->name = $request->name;
            $ex_new_detached_house_group->price = $request->price;
            ...
            $ex_new_detached_house_group->land_area = $request->land_area;
            $ex_new_detached_house_group->building_area = $request->building_area;
            $ex_new_detached_house_group->balcony_area = $request->balcony_area;
            $ex_new_detached_house_group->number_of_rooms = $request->number_of_rooms;
            $ex_new_detached_house_group->type_of_room = $request->type_of_room;
            $ex_new_detached_house_group->building_coverage_ratio = $request->building_coverage_ratio;
            $ex_new_detached_house_group->floor_area_ratio = $request->floor_area_ratio;
            $ex_new_detached_house_group->parking_lot = $request->parking_lot;
