...
class NewDetachedHouseController extends Controller
{
    ...
    public function search() {
        ...
        $new_detached_houses = NewDetachedHouseGroup::select('pref', 'lowest_price', 'highest_price', 'land_area', 'building_area', 'number_of_rooms', 'walking_distance_station', 'land_right')
                                                    ->wherePref()
                                                    ->whereLowestPrice()
                                                    ->whereHighestPrice()
                                                    ->whereLowestLandArea()
