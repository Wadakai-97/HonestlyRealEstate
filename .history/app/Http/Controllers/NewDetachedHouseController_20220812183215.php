...
class NewDetachedHouseController extends Controller
{
    ...
    public function groupList() {
        $new_detached_house_groups = NewDetachedHouseGroup::select('id', 'pref', 'municipalities', 'block', 'lowest_number_of_rooms', 'lowest_type_of_room', 'highest_number_of_rooms',  'highest_type_of_room', 'lowest_price', 'highest_price', 'lowest_land_area', 'highest_land_area', 'lowest_building_area', 'highest_building_area', 'station', 'walking_dist')
                                                        ->paginate(10);
    ...
    public function adminGroupSearch(Request $request) {
        $new_detached_house = NewDetachedHouseGroup::select('id', 'name', 'pref', 'municipalities', 'lowest_price', 'highest_price', 'lowest_land_area', 'highest_land_area', 'lowest_building_area', 'highest_building_area', 'lowest_number_of_rooms', 'highest_number_of_rooms', 'lowest_type_of_room', 'highest_type_of_room', 'station', 'walking_distance_station', 'land_right')
                                                ->whereLowestNumberOfRooms($request)
                                                ->whereHighestNumberOfRooms($request)
                                                ->wherePref($request)
                                                ->whereMunicipalities($request)
                                                ->whereLowestPrice($request)
                                                ->whereHighestPrice($request)
