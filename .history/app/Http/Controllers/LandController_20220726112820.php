...
class LandController extends Controller
{
    ...
    public function search(Request $request) {
        ...
        $lands = Land::select('id', 'land_name', 'pref', 'municipalities', 'price', 'land_area', 'building_coverage_ratio', 'floor_area_ration', '', 'station', 'walking_distance_station', 'updated_at')
                            ->wherePref($pref)
