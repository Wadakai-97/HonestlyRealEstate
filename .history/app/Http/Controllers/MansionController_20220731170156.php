...
class MansionController extends Controller
{
    ...
    public function imageEdit($id) {
        ...
        return redirect()->route('admin.mansionImage.edit', compact('mansion', 'mansion_images',))->with('message', '変更内容を登録しました。');
        return view('admin.mansion.edit_image', compact('mansion', 'mansion_images', 'image_counter'))->with('message', '変更内容を登録しました。');
    }
    ...
    public function imageUpdate($id, Request $request) {
        ...
        return redirect()->route('admin.mansionImage.edit', compact('mansion', 'mansion_images', 'image_counter'))->with('message', '変更内容を登録しました。');
    }
    // For CSV Download
