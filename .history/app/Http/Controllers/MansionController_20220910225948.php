...
class MansionController extends Controller
{
    ...
    public function kanagawa() {
        ...
        $yoko04 = Mansion::where('municipalities', 'LIKE', '横浜市西区%')->count();
        $yoko05 = Mansion::where('municipalities', 'LIKE', '横浜市西区%')->count();
        $yoko06 = Mansion::where('municipalities', 'LIKE', '横浜市西区%')->count();
        $yoko07 = Mansion::where('municipalities', 'LIKE', '横浜市西区%')->count();
        $yoko08 = Mansion::where('municipalities', 'LIKE', '横浜市西区%')->count();
        $yoko09 = Mansion::where('municipalities', 'LIKE', '横浜市西区%')->count();
        $yoko10 = Mansion::where('municipalities', 'LIKE', '横浜市西区%')->count();
        $yoko11 = Mansion::where('municipalities', 'LIKE', '横浜市西区%')->count();
        $yoko12 = Mansion::where('municipalities', 'LIKE', '横浜市西区%')->count();
        $yoko13 = Mansion::where('municipalities', 'LIKE', '横浜市西区%')->count();
        $yoko14 = Mansion::where('municipalities', 'LIKE', '横浜市西区%')->count();
        $yoko15 = Mansion::where('municipalities', 'LIKE', '横浜市西区%')->count();
        $yoko16 = Mansion::where('municipalities', 'LIKE', '横浜市西区%')->count();
        $yoko17 = Mansion::where('municipalities', 'LIKE', '横浜市西区%')->count();
        $yoko18 = Mansion::where('municipalities', 'LIKE', '横浜市西区%')->count();
        return view('user.mansion.kanagawa.top', compact('yoko01', 'yoko02','yoko03','yoko04','yoko05','yoko06','yoko07','yoko08','yoko09','yoko10','yoko11','yoko12','yoko13','yoko14','yoko15','yoko16','yoko17', 'yoko18',));
    }
