...
class BlogController extends Controller
{
    ...
    public function list() {
        $blogs = Blog::select('id', 'title', 'staff_id', 'content')
                    ->paginate(15);
    ...
    public function search(Request $request) {
        $blogs = Blog::select('id', 'title', 'content', 'staff_id', 'created_at')
                            ->whereTitle($request)
        ...
        return view('admin.blogs.result', compact('blogs', 'staffs', 'request'));
    }
