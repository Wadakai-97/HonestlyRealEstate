...
class MansionController extends Controller
{
    ...
    public function adminSearch(Request $request) {
        ...
        $mansions = Mansion::select('id', 'pref', 'municipaliteis',  'apartment_name', 'price', 'number_of_rooms', 'type_of_room', 'year', 'station', 'walking_distance_station' 'occupation_area')
                            ->wherePref($pref)
                            ->whereMunicipalities($municipalities)
