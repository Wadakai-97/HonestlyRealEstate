...
class MansionController extends Controller
{
    ...
    public function list() {
        $mansions = Mansion::select('id', 'apartment_name', 'room', 'number_of_rooms', 'type_of_room', 'occupation_area', 'price', 'pref', 'municipalities', 'station', 'walking_distance_station')
                            ->paginate(10);
