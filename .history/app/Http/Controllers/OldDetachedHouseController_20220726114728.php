...
class OldDetachedHouseController extends Controller
{
    ...
    public function search() {
        ...
        $old_detached_houses = OldDetachedHouse::select('id', 'name', 'price', 'pref', 'land_area', 'building_area', 'municipalities', 'floor_area_ratio', 'land_right', 'construction_conditions', 'station', 'walking_distance_station', 'updated_at')
                            ->wherePref($pref)
