...
class MansionController extends Controller
{
    ...
    public function imageEdit($id) {
        $mansion = Mansion::find($id);
        $mansion_images = MansionImage::where('mansion_id', '=', $id)->get();
            $image_counter = 1;        return view('admin.mansion.edit_image', compact('mansion', 'mansion_images', 'image_counter'));
    }
    ...
    public function imageUpdate($id, Request $request) {
        ...
        // }
        $request->session()->regenerateToken();
        return view('admin.mansionImage.edit', compact('mansion', 'mansion_images','id'));
    }
    // For Recommend
