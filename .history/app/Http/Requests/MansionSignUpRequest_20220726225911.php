...
class MansionSignUpRequest extends FormRequest
{
    ...
    public function rules() {
        return [
            ...
            'image1' => ['nullable', 'file', 'mimes:jpg,jpeg', 'dimensions:width=480,height=480', 'max:10240'],
    ...
    public function messages() {
        return [
            ...
            'image1.dimensions:width=480,height=240' => '画像サイズは横480px・高さ240px以内に調整してください。',
            'image1.max:1040' => '画像は10MB未満まで登録可能です。',
