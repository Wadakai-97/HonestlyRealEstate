...
class NewDetachedHouseGroupSignUpRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'lowest_building_coverage_ratio' => 'required',
    ...
    public function messages() {
        return [
            ...
            'highest_building_coverage_ratio.numeric' => '建ぺい率(最小)は数字と小数点のみ入力可能です。',
            'highest_building_coverage_ratio.regex:/^[!-~]+$/' => '建ぺい率(最小)は半角数字で入力してください。',
