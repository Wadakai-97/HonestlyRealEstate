...
class NewDetachedHouseSignUpRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'land_area' => ['required', 'numeric', 'regex:/^[!-~]+$/', 'between:0.01,99999.99'],
            'building_area' => ['required', 'numeric', 'regex:/^[!-~]+$/', 'between:0.01,99999.99'],
            ...
            'setback' => 'required',
            'setback_length' => ['nullable', 'required_if:setback,あり', 'between:0.01,4.00'],
    ...
    public function messages() {
        return [
            ...
            'parking_lot.integer' => '駐車台数は整数のみ入力可能です。',
            'parking_lot.between' => '駐車台数は:min〜:max以内の数値を入力してください。',
            ...
            'distance_station.integer' => '最寄り駅までの距離は入力必須です。',
            'distance_station.between' => '最寄り駅までの距離は入力必須です。',
