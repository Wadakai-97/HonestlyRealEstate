...
class LandSignUpRequest extends FormRequest
{
    ...
    public function messages() {
        return [
            ...
            'elementary_school_district.digits_between' => '小学校までの距離は整数のみ入力可能です。,
            'junior_high_school_district.numeric' => '小学校までの距離は整数のみ入力可能です。',
            'junior_high_school_district.digits_between' => '小学校までの距離は整数のみ入力可能です。',
