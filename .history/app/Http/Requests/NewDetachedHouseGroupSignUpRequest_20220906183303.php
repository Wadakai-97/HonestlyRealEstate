...
class NewDetachedHouseGroupSignUpRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'setback' => 'required',
            'setback_length' => ['nullable', 'required_if:setback,あり'],
    ...
    public function messages() {
        return [
            ...
            'lowest_setback_length.required_if' => 'セットバックがある場合にはセットバック幅を入力してください。',
            'highest_setback_length.required_if' => 'セットバックがある場合にはセットバック幅を入力してください。',
