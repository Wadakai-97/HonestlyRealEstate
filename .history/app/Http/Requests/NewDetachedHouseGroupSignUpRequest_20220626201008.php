...
class NewDetachedHouseGroupSignUpRequest extends FormRequest
{
    ...
    public function messages() {
        return [
            ...
            'highest_balcony_area.required' => 'バルコニー面積(最小)は入力必須です。',
            'highest_balcony_area.numeric' => 'バルコニー面積(最小)は数字と小数点のみ入力してください。',
            'highest_balcony_area.regex:/^[!-~]+$/' => 'バルコニー面積(最小)は半角数字で入力してください。',
