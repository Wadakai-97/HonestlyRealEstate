...
class MansionSignUpRequest extends FormRequest
{
    ...
    public function rules() {
        return [
            ...
            'land_area' => ['nullable', 'numeric', 'regex:/^[!-~]+$/', 'between:0.00,99999.99'],
            'building_area' => ['nullable', 'numeric', 'regex:/^[!-~]+$/', 'between:0.00,99999.99'],
            'number_of_rooms' => ['required', 'integer', 'regex:/^[!-~]+$/'],
            'type_of_room' => 'required',
            'measuring_method' => 'required',
            'occupation_area' => ['required', 'numeric', 'regex:/^[!-~]+$/', 'between:0.00,999.99'],
    ...
    public function messages() {
        return [
            ...
            'occupation_area.between' => '専有面積は数字と小数点のみ入力してください。。',
