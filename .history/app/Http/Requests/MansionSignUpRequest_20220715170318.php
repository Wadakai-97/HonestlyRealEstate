...
class MansionSignUpRequest extends FormRequest
{
    ...
    public function rules() {
        return [
            ...
            'price' => 'required',
            'tax' => 'required',
            'images' => ['nullable', 'file', 'mimes:jpg,jpeg,png,pdf', 'dimensions:width=480,height=240', 'max:1040'],
            'pref' => 'required',
    ...
    public function messages() {
        return [
            ...
            'images.dimensions:width=480,height=240' => '画像は横幅480ピクセル、縦240ピクセル以内にしてください、。',
            'images.max:1040' => '画像容量は最大10MB以内に抑えてください'
