...
class NewDetachedHouseGroupSignUpRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'setback' => 'required',
            'lowest_setback_length' => ['nullable', 'required_if:setback,あり', 'digits_between:1,3'],
            'highest_setback_length' => ['nullable', 'required_if:setback,あり', 'digits_between:1,3'],
    ...
    public function messages() {
        return [
            ...
            'lowest_building_area.digits_between' => '建物面積(最低)は正しい桁数で入力してください。',
            ...
            'highest_building_area.digits_between' => '建物面積(最高)は正しい桁数で入力してください。',
            ...
            'lowest_building_coverage_ratio.digits_between' => '建ぺい率(最低)は正しい桁数で入力してください。',
            ...
            'highest_building_coverage_ratio.digits_between' => '建ぺい率(最高)は正しい桁数で入力してください。',
            ...
            'lowest_setback_length.digits_between' => '最低セットバック幅は３桁以内で入力してください。',
            'highest_setback_length.required_if' => '最高セットバック幅を入力してください。',
            'highest_setback_length.digits_between' => '最高セットバック幅は３桁以内で入力してください。',
