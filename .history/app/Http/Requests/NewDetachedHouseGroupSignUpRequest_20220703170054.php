...
class NewDetachedHouseGroupSignUpRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'block' => 'nullable',
            'lowest_land_area' => ['required', 'numeric', 'regex:/^[!-~]+$/', 'max:highest_land_area'],
            'highest_land_area' => ['required', 'numeric', 'regex:/^[!-~]+$/', 'min:lowest_land_area'],
    ...
    public function messages() {
        return [
            ...
            'lowest_land_area.regex:max:highest_land_area' => '土地面積(最低)は土地面積(最高)より小さい面積を入力してください。',
            ...
            'highest_land_area.regex:max:highest_land_area' => '土地面積(最低)は土地面積(最高)より小さい面積を入力してください。',
