...
class NewDetachedHouseGroupSignUpRequest extends FormRequest
{
    ...
    public function messages() {
        return [
            ...
            'lowest_building_coverage_ratio.between' => '建ぺい率(最低)は:min〜80以内の数値を入力してください。',
            ...
            'highest_building_coverage_ratio.between' => '建ぺい率(最高)は30〜80以内の数値を入力してください。',
            ...
            'lowest_floor_area_ratio.between' => '容積率(最低)は50〜1300以内の数値を入力してください。',
            ...
            'highest_floor_area_ratio.between' => '容積率(最高)は50〜1300以内の数値を入力してください。',
