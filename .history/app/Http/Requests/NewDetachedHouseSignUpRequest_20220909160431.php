...
class NewDetachedHouseSignUpRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'price' => ['required', 'numeric', 'regex:/^[!-~]+$/', 'between:0.001,99999.99'],
            'tax' => 'required',
            'pref' => ['required', 'max:4'],
            'municipalities' => ['required', 'max:70'],
            'block' => ['nullable', 'max:30'],
            'land_area' => ['required', 'numeric', 'regex:/^[!-~]+$/', 'between:0.00,99999.99'],
            'building_area' => ['required', 'numeric', 'regex:/^[!-~]+$/', 'between:0.00,99999.99'],
