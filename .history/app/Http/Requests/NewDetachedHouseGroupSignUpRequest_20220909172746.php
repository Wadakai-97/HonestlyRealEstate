...
class NewDetachedHouseGroupSignUpRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'lowest_price' => ['required', 'numeric', 'regex:/^[!-~]+$/', 'between:0.1,99999.9'],
            'highest_price' => ['required', 'numeric', 'regex:/^[!-~]+$/', 'between:0.1,99999.9',
            ...
            'block' => 'nullable',
            'lowest_land_area' => ['required', 'numeric', 'regex:/^[!-~]+$/', 'between:0.01,99999.99'],
            'highest_land_area' => ['required', 'numeric', 'regex:/^[!-~]+$/', 'between:0.01,99999.99',
                function($attribute, $value, $fail) {
                    $request = $this->all();
            ...
            'lowest_building_area' => ['required', 'numeric', 'regex:/^[!-~]+$/', 'between:0.01,99999.99'],
            'highest_building_area' => ['required', 'numeric', 'regex:/^[!-~]+$/', 'between:0.01,99999.99',
                function($attribute, $value, $fail) {
                    $request = $this->all();
            ...
            'lowest_balcony_area' => ['nullable', 'numeric', 'regex:/^[!-~]+$/', 'required_if:balcony,あり', 'between:0.01,999.99'],
            'highest_balcony_area' => ['nullable', 'numeric', 'regex:/^[!-~]+$/', 'required_if:balcony,あり', 'between:0.01,999.99',
                function($attribute, $value, $fail) {
                    $request = $this->all();
            ...
            'parking' => 'required',
            'lowest_parking_lot' => ['nullable', 'integer', 'regex:/^[!-~]+$/', 'required_if:parking_lot,あり', 'between:1,10'],
            'highest_parking_lot' => ['nullable', 'integer', 'regex:/^[!-~]+$/', 'required_if:parking_lot,あり', 'between:1,10',
                function($attribute, $value, $fail) {
                    $request = $this->all();
    ...
    public function messages() {
        return [
            ...
            'lowest_land_area.between' => '土地面積(最低)は:min〜:max以内の数値を入力してください。',
            ...
            'highest_land_area.between' => '土地面積(最高)は:min〜:max以内の数値を入力してください。',
            ...
            'lowest_balcony_area.between' => 'バルコニー面積(最低)は:min〜:max以内の数値を入力してください。',
            ...
            'highest_balcony_area.between' => 'バルコニー面積(最高)は:min〜:max以内の数値を入力してください。',
            ...
            'lowest_parking_lot.between' => '最低駐車場数は:min〜:max以内の数値を入力してください。',
            ...
            'highest_parking_lot.between' => '最高駐車場数は:min〜:max以内の数値を入力してください。',
