...
class NewDetachedHouseGroupSignUpRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'block' => 'nullable',
            'lowest_land_area' => ['required', 'numeric', 'regex:/^[!-~]+$/', 'between:0.00,99999.99'],
            'highest_land_area' => ['required', 'numeric', 'regex:/^[!-~]+$/', 'between:0.00,99999.99',
                function($attribute, $value, $fail) {
                    $request = $this->all();
            ...
            'lowest_building_area' => ['required', 'numeric', 'regex:/^[!-~]+$/', 'between:0.00,99999.99'],
