...
class NewDetachedHouseGroupSignUpRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            'name' => 'required',
            'lowest_price' => ['required', 'integer', 'regex:/^[!-~]+$/'],
            'highest_price' => ['required', 'integer', 'regex:/^[!-~]+$/'],
            'tax' => 'required',
            ...
            'lowest_building_coverage_ratio' => ['required', 'integer', 'regex:/^[!-~]+$/'],
            'highest_building_coverage_ratio' => ['required', 'integer', 'regex:/^[!-~]+$/'],
            'lowest_floor_area_ratio' => ['required', 'integer', 'regex:/^[!-~]+$/'],
            'highest_floor_area_ratio' => ['required', 'integer', 'regex:/^[!-~]+$/'],
            'lowest_balcony_area' => ['required', 'numeric', 'regex:/^[!-~]+$/'],
            'highest_balcony_area' => ['required', 'numeric', 'regex:/^[!-~]+$/'],
    ...
    public function messages() {
        return [
            ...
            'lowest_price.integer' => '最低価格は整数のみ入力可能です。',
            'lowest_price.regex:/^[!-~]+$/' => '最低価格は半角数字で入力してください。',
            'highest_price.required' => '最高価格は入力必須です。',
            'highest_price.integer' => '最高価格は整数のみ入力可能です。',
            ...
            'municipalities.required' => '市 区町村は入力必須です。',
            'lowest_land_area.required' => '土地面積(最小)は入力必須です。',
            'lowest_land_area.numeric' => '土地面積(最小)は数字と小数点のみ入力可能です。',
            'lowest_land_area.regex:/^[!-~]+$/' => '土地面積(最小)は半角数字で入力してください。',
            ...
            'lowest_building_area.required' => '建物面積(最小)は入力必須です。',
            'lowest_building_area.numeric' => '建物面積(最小)は数字と小数点のみ入力可能です。',
            'lowest_building_area.regex:/^[!-~]+$/' => '建物面積(最小)は半角数字で入力してください。',
            ...
            'lowest_building_coverage_ratio.required' => '建ぺい率(最小)は入力必須です。',
            'lowest_building_coverage_ratio.numeric' => '建ぺい率(最小)は数字と小数点のみ入力可能です。',
            'lowest_building_coverage_ratio.regex:/^[!-~]+$/' => '建ぺい率(最小)は半角数字で入力してください。',
            'highest_building_coverage_ratio.required' => '建ぺい率(最大)は入力必須です。',
            'highest_building_coverage_ratio.numeric' => '建ぺい率(最大)は数字と小数点のみ入力可能です。',
            'highest_building_coverage_ratio.regex:/^[!-~]+$/' => '建ぺい率(最大)は半角数字で入力してください。',
            'lowest_floor_area_ratio.required' => '容積率(最小)は入力必須です。',
            'lowest_floor_area_ratio.numeric' => '容積率(最小)は数字と小数点のみ入力可能です。',
            'lowest_floor_area_ratio.regex:/^[!-~]+$/' => '容積率(最小)は半角数字で入力してください。',
            'highest_floor_area_ratio.required' => '容積率(最大)は入力必須です。',
            'highest_floor_area_ratio.numeric' => '容積率(最大)は数字と小数点のみ入力可能です。',
            'highest_floor_area_ratio.regex:/^[!-~]+$/' => '容積率(最大)は半角数字で入力してください。',
            'lowest_balcony_area.required' => 'バルコニー面積(最小)は入力必須です。',
            'lowest_balcony_area.numeric' => 'バルコニー面積(最小)は数字と小数点のみ入力してください。',
            'lowest_balcony_area.regex:/^[!-~]+$/' => 'バルコニー面積(最小)は半角数字で入力してください。',
            'highest_balcony_area.required' => 'バルコニー面積(最大)は入力必須です。',
            'highest_balcony_area.numeric' => 'バルコニー面積(最大)は数字と小数点のみ入力してください。',
            'highest_balcony_area.regex:/^[!-~]+$/' => 'バルコニー面積(最大)は半角数字で入力してください。',
            'lowest_number_of_rooms.required' => '部屋数(最小)は入力必須です。',
            'lowest_number_of_rooms.integer' => '部屋数(最小)は整数のみ入力可能です。',
            'lowest_number_of_rooms.regex:/^[!-~]+$/' => '部屋数(最小)は半角数字で入力してください。',
