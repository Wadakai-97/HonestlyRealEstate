...
**■開発方法**
食品メーカー：アジャイル
⇒（スプリント）２週間〜１ヶ月くらいのを繰り返し行っていた。
不動産業者：ウォーターフォール
⇒４ヶ月〜５ヶ月

**■開発環境**
エディター：VScode、
プロジェクト管理：Slack、Backlog、スプレッドシート
本番サーバー（インフラ）：オンプレ(食品)レンタル(不動産業者)
バージョン管理：Git/Github
...
　⇒開発メンバー５名（１チーム）
不動産業者
　⇒PM１、PL２名、開発メンバー５名（SE２/フロント１/バック２）

**■Unitテストのコーディング経験**
　⇒はい、あります。（メソッドや関数が期待通りに動くかアサーションメソッドを使用して作成しました。）
