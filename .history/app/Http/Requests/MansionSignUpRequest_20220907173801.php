...
class MansionSignUpRequest extends FormRequest
{
    ...
    public function rules() {
        return [
            ...
            'room' => ['required', 'integer', 'regex:/^[!-~]+$/', 'digits_between:1.4'],
            'price' => ['required', 'numeric', 'regex:/^[!-~]+$/'],
            'tax' => 'required',
            'pref' => ['required', 'max:4'],
            'municipalities' => ['required', 'max:70'],
            'block' => ['nullable', 'max:30'],
            'land_area' => ['nullable', 'numeric', 'regex:/^[!-~]+$/'],
            'building_area' => ['nullable', 'numeric', 'regex:/^[!-~]+$/'],
            ...
            'total_number_of_households' => ['required', 'integer', 'regex:/^[!-~]+$/', 'digits_between:1.4'],
            'land_right' => 'required',
    ...
    public function messages() {
        return [
            ...
            'room.digits_between' => '号室は4桁以内に入力してください。',
            ...
            'building_area.numeric' => '建物面積には数値を入力してください。',
            ...
            'total_number_of_households.digits_between' => '総戸数は４桁以内のみ入力可能です。',
