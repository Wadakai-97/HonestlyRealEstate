...
class PropertyInformationConsts
{
    ...
    public const LAND_IMAGES_CATEGORY_06 = '洗面所';
    public const LAND_IMAGES_CATEGORY_07 = '浴室';
    public const LAND_IMAGES_CATEGORY_08 = 'バルコニー';
    public const LAND_IMAGES_CATEGORY_09 = 'その他設備';
    public const LAND_IMAGES_CATEGORY_10 = '建物外観';
    public const LAND_IMAGES_CATEGORY_11 = '前面道路';
    public const LAND_IMAGES_CATEGORY_12 = 'エントランス';
    public const LAND_IMAGES_CATEGORY_13 = '共有部分';
    public const LAND_IMAGES_CATEGORY_14 = '駐車場';
    public const LAND_IMAGES_CATEGORY_15 = '駐輪場/バイク置き場';
    public const LAND_IMAGES_CATEGORY_16 = 'その他共有部分';
    public const LAND_IMAGES_CATEGORY_LIST = [
        ...
        '洗面所' => self::LAND_IMAGES_CATEGORY_06,
        '浴室' => self::LAND_IMAGES_CATEGORY_07,
        'バルコニー' => self::LAND_IMAGES_CATEGORY_08,
        'その他設備' => self::LAND_IMAGES_CATEGORY_09,
        '建物外観' => self::LAND_IMAGES_CATEGORY_10,
        '前面道路' => self::LAND_IMAGES_CATEGORY_11,
        'エントランス' => self::LAND_IMAGES_CATEGORY_12,
        '共有部分' => self::LAND_IMAGES_CATEGORY_13,
        '駐車場' => self::LAND_IMAGES_CATEGORY_14,
        '駐輪場/バイク置き場' => self::LAND_IMAGES_CATEGORY_15,
        'その他共有部分' => self::LAND_IMAGES_CATEGORY_16,
    ];
}
