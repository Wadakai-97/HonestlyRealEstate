...
class PropertyInformationConsts
{
    ...
    public const HOUSE_STATUS_01 = '更地';
    public const HOUSE_STATUS_01 = '建築中';
    public const HOUSE_STATUS_01 = '完成済み';
    public const HOUSE_STATUS_01 = '';
    public const HOUSE_STATUS_LIST = [
