...
class PropertyInformationConsts
{
    ...
    public const DETACHED_HOUSE_IMAGES_CATEGORY_09 = 'その他設備';
    public const DETACHED_HOUSE_IMAGES_CATEGORY_10 = '建物外観';
    public const DETACHED_HOUSE_IMAGES_CATEGORY_11 = '前面道路';
    public const DETACHED_HOUSE_IMAGES_CATEGORY_12 = 'エントランス';
    public const DETACHED_HOUSE_IMAGES_CATEGORY_13 = '共有部分';
    public const DETACHED_HOUSE_IMAGES_CATEGORY_14 = '駐車場';
    public const DETACHED_HOUSE_IMAGES_CATEGORY_15 = '駐輪場/バイク置き場';
    public const DETACHED_HOUSE_IMAGES_CATEGORY_16 = 'その他共有部分';
    public const DETACHED_HOUSE_IMAGES_CATEGORY_LIST = [
        ...
        'その他設備' => self::DETACHED_HOUSE_IMAGES_CATEGORY_09,
        '建物外観' => self::DETACHED_HOUSE_IMAGES_CATEGORY_10,
        '前面道路' => self::DETACHED_HOUSE_IMAGES_CATEGORY_11,
        'エントランス' => self::DETACHED_HOUSE_IMAGES_CATEGORY_12,
        '共有部分' => self::DETACHED_HOUSE_IMAGES_CATEGORY_13,
        '駐車場' => self::DETACHED_HOUSE_IMAGES_CATEGORY_14,
        '駐輪場/バイク置き場' => self::DETACHED_HOUSE_IMAGES_CATEGORY_15,
        'その他共有部分' => self::DETACHED_HOUSE_IMAGES_CATEGORY_16,
    ];
