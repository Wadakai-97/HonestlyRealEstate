...
class TerminologyConsts
{
    ...
    public const NATIONAL_LAND_UTILIZATION_LAW_LIST = [
        '不明' => self::NATIONAL_LAND_UTILIZATION_LAW'',
        '不要' => self::NATIONAL_LAND_UTILIZATION_LAW'',
        '必要（事前届出）' => self::NATIONAL_LAND_UTILIZATION_LAW'',
        '必要（事後届出）' => self::NATIONAL_LAND_UTILIZATION_LAW'',
    ];
}
