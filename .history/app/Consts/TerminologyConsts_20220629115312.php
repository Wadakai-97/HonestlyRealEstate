...
class TerminologyConsts
{
    ...
    public const NATIONAL_LAND_UTILIZATION_LAW_LIST = [
        '不明' => self::NATIONAL_LAND_UTILIZATION_LAW_01 = '不明',
        '不要' => self::NATIONAL_LAND_UTILIZATION_LAW_02 = '不要',
        '必要（事前届出）' => self::NATIONAL_LAND_UTILIZATION_LAW_03 = '',
        '必要（事後届出）' => self::NATIONAL_LAND_UTILIZATION_LAW_04 = '',
    ];
}
