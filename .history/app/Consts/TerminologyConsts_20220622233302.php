...
class TerminologyConsts
{
    ...
    public const CONDITIONS_OF_TRANSACTIONS_LIST = [
        '売主' => self:CONDITIONS_OF_TRANSACTIONS
        '代理' => self:CONDITIONS_OF_TRANSACTIONS
        '一般媒介' => self:CONDITIONS_OF_TRANSACTIONS
        '専任媒介' => self:CONDITIONS_OF_TRANSACTIONS
        '専属専任媒介' => self:CONDITIONS_OF_TRANSACTIONS
    ];
}
