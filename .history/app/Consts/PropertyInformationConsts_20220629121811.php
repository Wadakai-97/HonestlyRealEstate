...
class PropertyInformationConsts
{
    ...
    public const TYPE_OF_ROOM_LIST = [
        'K' => self::TYOE_OF_ROOM_01,
        'DK' => self::TYOE_OF_ROOM_02,
        'LDK' => self::TYOE_OF_ROOM_03,
    ];
    ...
    public const DETACHED_HOUSE_STATUS_01 = '更地';
    public const DETACHED_HOUSE_STATUS_02 = '建築中';
    public const DETACHED_HOUSE_STATUS_03 = '完成済み';
    public const DETACHED_HOUSE_STATUS_LIST = [
        '更地' => self::HOUSE_STATUS_01,
        '建築中';
        '完成済み';
    ];
}
