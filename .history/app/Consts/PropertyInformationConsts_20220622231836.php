...
class PropertyInformationConsts
{
    ...
    public const BUILDING_CONSTRUCTION_LIST = [
        ...
        '鉄骨鉄筋コンクリート造(SRC造)' => self::BUILDING_CONSTRUCTION_01,
        '軽量鉄骨造(S造)' => self::BUILDING_CONSTRUCTION_01,
        '重量鉄骨造(S造)' => self::BUILDING_CONSTRUCTION_01,
        '木造(W造)' => self::BUILDING_CONSTRUCTION_01,
        'アルミ造(AL造)' => self::BUILDING_CONSTRUCTION_01,
        'コンクリートブロック造(CB造)' => self::BUILDING_CONSTRUCTION_01,
        'コンクリート充填鋼管構造(CFT造)' => self::BUILDING_CONSTRUCTION_01,
    ];
}
