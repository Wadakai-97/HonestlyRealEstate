...
class PropertyInformationConsts
{
    ...
    public const DIRECTION_01 = '日がhし';
    public const DIRECTION_02 = '内法';
    public const DIRECTION_03 = '不明';
    public const DIRECTION_04 = '不明';
    public const DIRECTION_LIST = [
        '壁芯' => self::DIRECTION_01,
        '内法' => self::DIRECTION_02,
        '不明' => self::DIRECTION_03,
        '不明' => self::DIRECTION_04,
    ];
    ...
    public const MANSION_IMAGES_CATEGORY_LIST = [
        ...
        'リビング' => self::MANSION_IMAGES_CATEGORY_03,
        'キッチン' => self::MANSION_IMAGES_CATEGORY_04,
        '居室' => self::MANSION_IMAGES_CATEGORY_05,
        '洗面所' => self::MANSION_IMAGES_CATEGORY_06,
        '浴室' => self::MANSION_IMAGES_CATEGORY_07,
        'バルコニー' => self::MANSION_IMAGES_CATEGORY_08,
        'その他設備' => self::MANSION_IMAGES_CATEGORY_09,
        '建物外観' => self::MANSION_IMAGES_CATEGORY_10,
        '前面道路' => self::MANSION_IMAGES_CATEGORY_11,
        'エントランス' => self::MANSION_IMAGES_CATEGORY_12,
        '共有部分' => self::MANSION_IMAGES_CATEGORY_13,
        '駐車場' => self::MANSION_IMAGES_CATEGORY_14,
        '駐輪場/バイク置き場' => self::MANSION_IMAGES_CATEGORY_15,
        'その他共有部分' => self::MANSION_IMAGES_CATEGORY_16,
    ];

    public const LAND_IMAGES_CATEGORY_01 = '前面道路';
    public const LAND_IMAGES_CATEGORY_02 = '現地写真';
    public const LAND_IMAGES_CATEGORY_03 = '区画図';
    public const LAND_IMAGES_CATEGORY_04 = 'イメージパース';
    public const LAND_IMAGES_CATEGORY_05 = 'その他';
    public const LAND_IMAGES_CATEGORY_LIST = [
        '前面道路' => self::LAND_IMAGES_CATEGORY_01,
        '現地写真' => self::LAND_IMAGES_CATEGORY_02,
        '区画図' => self::LAND_IMAGES_CATEGORY_03,
        'イメージパース' => self::LAND_IMAGES_CATEGORY_04,
        'その他' => self::LAND_IMAGES_CATEGORY_05,
    ];


    public const DETACHED_HOUSE_IMAGES_CATEGORY_01 = '玄関';
    public const DETACHED_HOUSE_IMAGES_CATEGORY_02 = '収納';
    public const DETACHED_HOUSE_IMAGES_CATEGORY_03 = 'リビング';
    public const DETACHED_HOUSE_IMAGES_CATEGORY_04 = 'キッチン';
    public const DETACHED_HOUSE_IMAGES_CATEGORY_05 = '居室';
    public const DETACHED_HOUSE_IMAGES_CATEGORY_06 = '洗面所';
    public const DETACHED_HOUSE_IMAGES_CATEGORY_07 = '浴室';
    public const DETACHED_HOUSE_IMAGES_CATEGORY_08 = 'バルコニー';
    public const DETACHED_HOUSE_IMAGES_CATEGORY_09 = '庭';
    public const DETACHED_HOUSE_IMAGES_CATEGORY_10 = 'その他設備';
    public const DETACHED_HOUSE_IMAGES_CATEGORY_11 = '建物外観';
    public const DETACHED_HOUSE_IMAGES_CATEGORY_12 = '前面道路';
    public const DETACHED_HOUSE_IMAGES_CATEGORY_13 = '駐車場';
    public const DETACHED_HOUSE_IMAGES_CATEGORY_14 = 'その他';
    public const DETACHED_HOUSE_IMAGES_CATEGORY_LIST = [
        '玄関' => self::DETACHED_HOUSE_IMAGES_CATEGORY_01,
        '収納' => self::DETACHED_HOUSE_IMAGES_CATEGORY_02,
        'リビング' => self::DETACHED_HOUSE_IMAGES_CATEGORY_03,
        'キッチン' => self::DETACHED_HOUSE_IMAGES_CATEGORY_04,
        '居室' => self::DETACHED_HOUSE_IMAGES_CATEGORY_05,
        '洗面所' => self::DETACHED_HOUSE_IMAGES_CATEGORY_06,
        '浴室' => self::DETACHED_HOUSE_IMAGES_CATEGORY_07,
        'バルコニー' => self::DETACHED_HOUSE_IMAGES_CATEGORY_08,
        '庭' => self::DETACHED_HOUSE_IMAGES_CATEGORY_09,
        'その他設備' => self::DETACHED_HOUSE_IMAGES_CATEGORY_10,
        '建物外観' => self::DETACHED_HOUSE_IMAGES_CATEGORY_11,
        '前面道路' => self::DETACHED_HOUSE_IMAGES_CATEGORY_12,
        '駐車場' => self::DETACHED_HOUSE_IMAGES_CATEGORY_13,
        'その他' => self::DETACHED_HOUSE_IMAGES_CATEGORY_14,
    ];

    public const ACCESS_METHOD_01 = '徒歩';
    public const ACCESS_METHOD_02 = 'バス';
    public const ACCESS_METHOD_03 = '車';
    public const ACCESS_METHOD_LIST = [
        '徒歩' => self::ACCESS_METHOD_01,
        'バス' => self::ACCESS_METHOD_02,
        '車' => self::ACCESS_METHOD_03,
    ];
