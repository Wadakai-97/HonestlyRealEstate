...
class PropertyInformationConsts
{
    ...
    public const ACCESS_METHOD_01 = '前面道路';
    public const ACCESS_METHOD_02 = '現地写真';
    public const ACCESS_METHOD_03 = '区画図';
    public const ACCESS_METHOD_04 = 'イメージパース';
    public const ACCESS_METHOD_05 = 'その他';
    public const ACCESS_METHOD_LIST = [
        '前面道路' => self::ACCESS_METHOD_01,
        '現地写真' => self::ACCESS_METHOD_02,
        '区画図' => self::ACCESS_METHOD_03,
        'イメージパース' => self::ACCESS_METHOD_04,
        'その他' => self::ACCESS_METHOD_05,
    ];
