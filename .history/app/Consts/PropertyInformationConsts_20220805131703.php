...
class PropertyInformationConsts
{
    ...
    public const LAND_IMAGES_CATEGORY_02 = '現地外観写真';
    public const LAND_IMAGES_CATEGORY_03 = 'リビング';
    public const LAND_IMAGES_CATEGORY_04 = 'キッチン';
    public const LAND_IMAGES_CATEGORY_05 = '居室';
    ...
    public const LAND_IMAGES_CATEGORY_LIST = [
        ...
        '現地外観写真' => self::LAND_IMAGES_CATEGORY_02,
        'リビング' => self::LAND_IMAGES_CATEGORY_03,
        'キッチン' => self::LAND_IMAGES_CATEGORY_04,
        '居室' => self::LAND_IMAGES_CATEGORY_05,
