...
class PropertyInformationConsts
{
    ...
    public const _IMAGES_CATEGORY_01 = '玄関';
    public const _IMAGES_CATEGORY_02 = '収納';
    public const _IMAGES_CATEGORY_03 = 'リビング';
    public const _IMAGES_CATEGORY_04 = 'キッチン';
    public const _IMAGES_CATEGORY_05 = '居室';
    public const _IMAGES_CATEGORY_06 = '洗面所';
    public const _IMAGES_CATEGORY_07 = '浴室';
    public const _IMAGES_CATEGORY_08 = 'バルコニー';
    public const _IMAGES_CATEGORY_09 = 'その他設備';
    public const _IMAGES_CATEGORY_10 = '建物外観';
    public const _IMAGES_CATEGORY_11 = '前面道路';
    public const _IMAGES_CATEGORY_12 = 'エントランス';
    public const _IMAGES_CATEGORY_13 = '共有部分';
    public const _IMAGES_CATEGORY_14 = '駐車場';
    public const _IMAGES_CATEGORY_15 = '駐輪場/バイク置き場';
    public const _IMAGES_CATEGORY_16 = 'その他共有部分';
    public const _IMAGES_CATEGORY_LIST = [
        '玄関' => self::_IMAGES_CATEGORY_01,
        '収納' => self::_IMAGES_CATEGORY_02,
        'リビング' => self::_IMAGES_CATEGORY_03,
        'キッチン' => self::_IMAGES_CATEGORY_04,
        '居室' => self::_IMAGES_CATEGORY_05,
        '洗面所' => self::_IMAGES_CATEGORY_06,
        '浴室' => self::_IMAGES_CATEGORY_07,
        'バルコニー' => self::_IMAGES_CATEGORY_08,
        'その他設備' => self::_IMAGES_CATEGORY_09,
        '建物外観' => self::_IMAGES_CATEGORY_10,
        '前面道路' => self::_IMAGES_CATEGORY_11,
        'エントランス' => self::_IMAGES_CATEGORY_12,
        '共有部分' => self::_IMAGES_CATEGORY_13,
        '駐車場' => self::_IMAGES_CATEGORY_14,
        '駐輪場/バイク置き場' => self::_IMAGES_CATEGORY_15,
        'その他共有部分' => self::_IMAGES_CATEGORY_16,
    ];
}
