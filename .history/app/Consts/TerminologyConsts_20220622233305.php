...
class TerminologyConsts
{
    ...
    public const CONDITIONS_OF_TRANSACTIONS_LIST = [
        ...
        '代理' => self:CONDITIONS_OF_TRANSACTIONS_01
        '一般媒介' => self:CONDITIONS_OF_TRANSACTIONS_01
        '専任媒介' => self:CONDITIONS_OF_TRANSACTIONS_01
        '専属専任媒介' => self:CONDITIONS_OF_TRANSACTIONS_01
    ];
}
