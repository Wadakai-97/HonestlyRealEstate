...
class KirameigerConsts
{
    ...
    public const POSITION_LIST = [
        ...
        '係長' => self::POSITION_KAKARICHO,
        '課長代理' => self::POSITION_KACHO_DAIRI,
        '課長' => self::POSITION_KACHO,
        '部長代理' => self::POSITION_BUCHO_DAIRI,
        '部長' => self::POSITION_BUCHO,
        '事業部長' => self::POSITION_SHIKKOYAKUIN,
        '執行役員' => self::POSITION_SHUNIN,
        '専務' => self::POSITION_SHUNIN,
    ];
}
