...
class PropertyInformationConsts
{
    ...
    public const URBAN_PLANNING_01 = '市街化調整区域';
    public const URBAN_PLANNING_01 = '非線引き区域';
    public const URBAN_PLANNING_LIST = [
        '市街化区域' => self::URBAN_PLANNING
        '市街化調整区域' => self::URBAN_PLANNING
        '非線引き区域' => self::URBAN_PLANNING
    ];
