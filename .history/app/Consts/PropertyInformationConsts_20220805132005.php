...
class PropertyInformationConsts
{
    ...
    public const DETACHED_HOUSE_IMAGES_CATEGORY_01 = '前面道路';
    public const DETACHED_HOUSE_IMAGES_CATEGORY_02 = '現地写真';
    public const DETACHED_HOUSE_IMAGES_CATEGORY_03 = '区画図';
    public const DETACHED_HOUSE_IMAGES_CATEGORY_04 = 'イメージパース';
    public const DETACHED_HOUSE_IMAGES_CATEGORY_05 = 'その他';
    public const DETACHED_HOUSE_IMAGES_CATEGORY_LIST = [
        '前面道路' => self::DETACHED_HOUSE_IMAGES_CATEGORY_01,
        '現地写真' => self::DETACHED_HOUSE_IMAGES_CATEGORY_02,
        '区画図' => self::DETACHED_HOUSE_IMAGES_CATEGORY_03,
        'イメージパース' => self::DETACHED_HOUSE_IMAGES_CATEGORY_04,
        'その他' => self::DETACHED_HOUSE_IMAGES_CATEGORY_05,
    ];
}
