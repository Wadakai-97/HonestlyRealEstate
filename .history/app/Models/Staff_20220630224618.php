    ...
    public function signUp($request) {
        DB::transaction(function() use($request) {
            ...
            if(!empty($request->head_shot)) {
                ...
                $request->head_shot = $file_name;
                $request->only(['staff_name','position', 'number_of_contracts', 'birthplace', 'headshot', 'hobby', 'comment',]);
            } else {
                $request->only(['staff_name','position', 'number_of_contracts', 'birthplace', 'hobby', 'comment',]);
            }
        });
        return;
    }
