...
class Mansion extends Model
{
    ...
    public function column($request) {
        ...
        if($request->sort = "専有面積が狭い順") {
            $column = "occupation_area";
        }
        if($request->sort = "専有面積が広い順") {
            $column = "occupation_area";
        }
        ...
        if($request->sort = "築年数が狭い順") {
            $column = "year";
        }
        if($request->sort = "築年数が新しい順") {
            $column = "year";
        }
    }
    public function type($request) {
        ...
        if($request->sort = "価格が安い順" || $request->sort = "専有面積が狭い順" || $request->sort = "間取りが狭い順" || $request->sort = "築年数が狭い順" || $request->sort = "築年数が新しい順") {
            $type = "desc";
        }
    }
