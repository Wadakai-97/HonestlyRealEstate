...
class NewDetachedHouse extends Model
{
    ...
    public function search($request) {
        ...
        if(!empty($station)) {
            $new_detached_house = $new_detached_house->where('station', '<', $station);
        }
        if(!empty($walking_distance_station)) {
            $new_detached_house = $new_detached_house->where('walking_distance_station', '<', $walking_distance_station);
        }
    }
