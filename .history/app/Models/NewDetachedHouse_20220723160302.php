...
class NewDetachedHouse extends Model
{
    ...
    public function scopeWhereLowestBuildingArea($query, $request) {
        $lowest_buil = $request->lowest_buil;
        if(!empty($lowest_buil)) {
            $query->where('lowest_buil', '=', $lowest_buil);
        }
    }
    public function scopeWhereHighestBuildingArea($query, $request) {
        $highest_buil = $request->highest_buil;
        if(!empty($highest_buil)) {
            $query->where('highest_buil', '=', $highest_buil);
        }
    }
