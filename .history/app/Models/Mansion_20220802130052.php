...
class Mansion extends Model
{
    ...
    public function mansionAccesses() {
        return $this->hasMany(MansionAccess::class, 'mansion_id', 'id');
    }
    public function similarMansions() {
        return $this->hasMany(SimilarManison::class, 'mansion_id', 'id');
    }
}
